# Adjust your code and adapt your project
  * [ Copy page link ](modules/upgrade-overview/adjust-your-code-and-adapt#) | [Get HelpService ID](modules/upgrade-overview/adjust-your-code-and-adapt#)
Core MVC 5


[✖](modules/upgrade-overview/adjust-your-code-and-adapt# "Close page link panel") [Copy to clipboard](modules/upgrade-overview/adjust-your-code-and-adapt#)
...
This guide will provide more details about the points from the later top-level sections of the [upgrade overview](modules/upgrade-overview/upgrade-from-kx13-overview).
## Adjust your code
...
Most custom modules revolve around performing basic operations on custom objects, so in many cases, the [previous heading’s](modules/upgrade-overview/adjust-your-code-and-adapt#rehome-custom-tables) guidance about the types of pages you’ll need still applies.
...
In the previous guide we talked about the data migration as [an opportunity to re-think and adjust your content model](modules/upgrade-overview/prep-for-upgrade-and-transfer-data#adapt-your-content-model) in order to best utilize new content modeling features of the XbyK solution.
...
The migration tool’s configuration and customization options allow you to create [reusable field schemas](documentation/developers-and-admins/development/content-types/reusable-field-schemas) out of your existing content types. If you choose to avoid this conversion during data migration, similarly to the [above approach](modules/upgrade-overview/adjust-your-code-and-adapt#adapt-your-content-model-post-data-migration) for reusable content items, you can create one-off scripts later on to help convert common fields that exist in several content types into [reusable field schemas](documentation/developers-and-admins/development/content-types/reusable-field-schemas).
...
[ Previous page ](modules/upgrade-overview/prep-for-upgrade-and-transfer-data)
5 of 6
[ Mark complete and continue ](modules/upgrade-overview/upgrade-overview-conclusion)
...
USE ONLY NECESSARY 
![](https://docs.kentico.com/modules/upgrade-overview/adjust-your-code-and-adapt)
[](https://docs.kentico.com/modules/upgrade-overview/adjust-your-code-and-adapt)[](https://docs.kentico.com/modules/upgrade-overview/adjust-your-code-and-adapt)