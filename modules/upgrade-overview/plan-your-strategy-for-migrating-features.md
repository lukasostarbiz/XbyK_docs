# Plan your strategy for migrating features
  * [ Copy page link ](modules/upgrade-overview/plan-your-strategy-for-migrating-features#) | [Get HelpService ID](modules/upgrade-overview/plan-your-strategy-for-migrating-features#)
Core MVC 5


[✖](modules/upgrade-overview/plan-your-strategy-for-migrating-features# "Close page link panel") [Copy to clipboard](modules/upgrade-overview/plan-your-strategy-for-migrating-features#)
...
HIGH At the moment, these features are not available in XbyK. For deterministic segmentation you can utilize [contact groups](modules/upgrade-overview/plan-your-strategy-for-migrating-features#contact-groups). If there is a requirement for advanced segmentation or personas and lead scoring as you knew them from KX13, your developer team needs to build a custom implementation. If this is not an immediate need, we recommend to wait and follow our [XbyK roadmap](https://roadmap.kentico.com/tabs/4-planned).
### Social Marketing
**XbyK feature:** Roadmap
...
[ Previous page ](modules/upgrade-overview/upgrade-from-kx13-overview)
3 of 6
[ Mark complete and continue ](modules/upgrade-overview/prep-for-upgrade-and-transfer-data)
...
USE ONLY NECESSARY 
![](https://docs.kentico.com/modules/upgrade-overview/plan-your-strategy-for-migrating-features)
[](https://docs.kentico.com/modules/upgrade-overview/plan-your-strategy-for-migrating-features)[](https://docs.kentico.com/modules/upgrade-overview/plan-your-strategy-for-migrating-features)