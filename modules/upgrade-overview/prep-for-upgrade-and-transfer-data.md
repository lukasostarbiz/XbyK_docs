# Prep for the upgrade and transfer data
  * [ Copy page link ](modules/upgrade-overview/prep-for-upgrade-and-transfer-data#) | [Get HelpService ID](modules/upgrade-overview/prep-for-upgrade-and-transfer-data#)
Core MVC 5


[✖](modules/upgrade-overview/prep-for-upgrade-and-transfer-data# "Close page link panel") [Copy to clipboard](modules/upgrade-overview/prep-for-upgrade-and-transfer-data#)
...
This guide will provide more details about the points from the first two top-level sections of the [upgrade overview](modules/upgrade-overview/upgrade-from-kx13-overview).
...
[ Previous page ](modules/upgrade-overview/plan-your-strategy-for-migrating-features)
4 of 6
[ Mark complete and continue ](modules/upgrade-overview/adjust-your-code-and-adapt)
...
USE ONLY NECESSARY 
![](https://docs.kentico.com/modules/upgrade-overview/prep-for-upgrade-and-transfer-data)
[](https://docs.kentico.com/modules/upgrade-overview/prep-for-upgrade-and-transfer-data)[](https://docs.kentico.com/modules/upgrade-overview/prep-for-upgrade-and-transfer-data)