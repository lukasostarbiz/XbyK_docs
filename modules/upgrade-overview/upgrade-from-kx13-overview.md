# Upgrade overview
  * [ Copy page link ](modules/upgrade-overview/upgrade-from-kx13-overview#) | [Get HelpService ID](modules/upgrade-overview/upgrade-from-kx13-overview#)
Core MVC 5


[✖](modules/upgrade-overview/upgrade-from-kx13-overview# "Close page link panel") [Copy to clipboard](modules/upgrade-overview/upgrade-from-kx13-overview#)
...
Let’s take a look at the process together. There are four main parts to consider:
  1. [Set up your environment](modules/upgrade-overview/upgrade-from-kx13-overview#set-up-your-environment) and configure the migration tool
  2. [Migrate your data](modules/upgrade-overview/upgrade-from-kx13-overview#migrate-your-data) and binary files using the migration tool
  3. [Adjust your code](modules/upgrade-overview/upgrade-from-kx13-overview#adjust-your-code) and any custom artifacts not covered by the migration tool
  4. [Think about the future](modules/upgrade-overview/upgrade-from-kx13-overview#think-about-the-future) and explore the full potential of Xperience by Kentico
...
However, we do offer pathways to help your team handle these potential challenges. Learn more in our [Plan your strategy for migrating features](modules/upgrade-overview/plan-your-strategy-for-migrating-features) guide.
...
[ Previous page ](modules/upgrade-overview)
2 of 6
[ Mark complete and continue ](modules/upgrade-overview/plan-your-strategy-for-migrating-features)
...
USE ONLY NECESSARY 
![](https://docs.kentico.com/modules/upgrade-overview/upgrade-from-kx13-overview)
[](https://docs.kentico.com/modules/upgrade-overview/upgrade-from-kx13-overview)[](https://docs.kentico.com/modules/upgrade-overview/upgrade-from-kx13-overview)