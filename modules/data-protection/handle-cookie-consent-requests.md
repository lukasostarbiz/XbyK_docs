# Handle cookie consent requests
  * [ Copy page link ](modules/data-protection/handle-cookie-consent-requests#) | [Get HelpService ID](modules/data-protection/handle-cookie-consent-requests#)
Core MVC 5


[✖](modules/data-protection/handle-cookie-consent-requests# "Close page link panel") [Copy to clipboard](modules/data-protection/handle-cookie-consent-requests#)
...
USE ONLY NECESSARY 
![](https://docs.kentico.com/modules/data-protection/handle-cookie-consent-requests)
[](https://docs.kentico.com/modules/data-protection/handle-cookie-consent-requests)[](https://docs.kentico.com/modules/data-protection/handle-cookie-consent-requests)