# Hide builder content from visitors who have not consented to tracking
  * [ Copy page link ](modules/data-protection/hide-builder-content-from-visitors-who-have-not-consented-to-tracking#) | [Get HelpService ID](modules/data-protection/hide-builder-content-from-visitors-who-have-not-consented-to-tracking#)
Core MVC 5


[✖](modules/data-protection/hide-builder-content-from-visitors-who-have-not-consented-to-tracking# "Close page link panel") [Copy to clipboard](modules/data-protection/hide-builder-content-from-visitors-who-have-not-consented-to-tracking#)
...
[ Previous page ](modules/data-protection/handle-tracking-consent-banner-data)
8 of 13
[ Mark complete and continue ](modules/data-protection/identity-collectors-gather-contacts-associated-with-a-visitor)
...
USE ONLY NECESSARY 
![](https://docs.kentico.com/modules/data-protection/hide-builder-content-from-visitors-who-have-not-consented-to-tracking)
[](https://docs.kentico.com/modules/data-protection/hide-builder-content-from-visitors-who-have-not-consented-to-tracking)[](https://docs.kentico.com/modules/data-protection/hide-builder-content-from-visitors-who-have-not-consented-to-tracking)