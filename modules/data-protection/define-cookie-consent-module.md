# Define a module that maps cookie levels to consent
  * [ Copy page link ](modules/data-protection/define-cookie-consent-module#) | [Get HelpService ID](modules/data-protection/define-cookie-consent-module#)
Core MVC 5


[✖](modules/data-protection/define-cookie-consent-module# "Close page link panel") [Copy to clipboard](modules/data-protection/define-cookie-consent-module#)
...
[![Screenshot of UI form creation page](docsassets/guides/map-consents-to-cookie-levels/CookieLevelConsentMappingUIFormCreation.png)](https://docs.kentico.com/docsassets/guides/map-consents-to-cookie-levels/CookieLevelConsentMappingUIFormCreation.png)
  ...
  3. Create a field for each [previously specified consent columns](modules/data-protection/define-cookie-consent-module#create-the-class) with the following properties: 
...
USE ONLY NECESSARY 
![](https://docs.kentico.com/modules/data-protection/define-cookie-consent-module)
[](https://docs.kentico.com/modules/data-protection/define-cookie-consent-module)[](https://docs.kentico.com/modules/data-protection/define-cookie-consent-module)