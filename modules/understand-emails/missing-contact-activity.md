# Missing contact activities
  * [ Copy page link ](modules/understand-emails/missing-contact-activity#) | [Get HelpService ID](modules/understand-emails/missing-contact-activity#)
Core MVC 5


[✖](modules/understand-emails/missing-contact-activity# "Close page link panel") [Copy to clipboard](modules/understand-emails/missing-contact-activity#)
