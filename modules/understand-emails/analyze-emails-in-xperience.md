# Introduction to email statistics
  * [ Copy page link ](modules/understand-emails/analyze-emails-in-xperience#) | [Get HelpService ID](modules/understand-emails/analyze-emails-in-xperience#)
Core MVC 5


[✖](modules/understand-emails/analyze-emails-in-xperience# "Close page link panel") [Copy to clipboard](modules/understand-emails/analyze-emails-in-xperience#)
...
USE ONLY NECESSARY 
![](https://docs.kentico.com/modules/understand-emails/analyze-emails-in-xperience)
[](https://docs.kentico.com/modules/understand-emails/analyze-emails-in-xperience)[](https://docs.kentico.com/modules/understand-emails/analyze-emails-in-xperience)