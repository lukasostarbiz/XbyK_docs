# Understand the key email metrics
  * [ Copy page link ](modules/understand-emails/understand-key-email-metrics#) | [Get HelpService ID](modules/understand-emails/understand-key-email-metrics#)
Core MVC 5


[✖](modules/understand-emails/understand-key-email-metrics# "Close page link panel") [Copy to clipboard](modules/understand-emails/understand-key-email-metrics#)
...
USE ONLY NECESSARY 
![](https://docs.kentico.com/modules/understand-emails/understand-key-email-metrics)
[](https://docs.kentico.com/modules/understand-emails/understand-key-email-metrics)[](https://docs.kentico.com/modules/understand-emails/understand-key-email-metrics)