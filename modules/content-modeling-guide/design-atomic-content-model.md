# Design atomic content models
  * [ Copy page link ](modules/content-modeling-guide/design-atomic-content-model#) | [Get HelpService ID](modules/content-modeling-guide/design-atomic-content-model#)
Core MVC 5


[✖](modules/content-modeling-guide/design-atomic-content-model# "Close page link panel") [Copy to clipboard](modules/content-modeling-guide/design-atomic-content-model#)
...
[![Product content model diagram](docsassets/guides/design-atomic-content-model/cm-guide-product-content-model-diagram.png)](https://docs.kentico.com/docsassets/guides/design-atomic-content-model/cm-guide-product-content-model-diagram.png)
...
[![Xperience warns editor that a linked content item isn’t localized into a target language](docsassets/guides/design-atomic-content-model/cm-translation-warning-not-translated.png)](https://docs.kentico.com/docsassets/guides/design-atomic-content-model/cm-translation-warning-not-translated.png)
...
[![Page wrapper with linked item and channel specific information](docsassets/guides/design-atomic-content-model/cm-page-wrapper-with-linked-item-and-channel-specific-info.png)](https://docs.kentico.com/docsassets/guides/design-atomic-content-model/cm-page-wrapper-with-linked-item-and-channel-specific-info.png)
...
[![SEO and OpenGraph data on a product page wrapper in Kbank demo site](docsassets/guides/design-atomic-content-model/cm-example-seo-and-og-data-in-resuable-field-schema.png)](https://docs.kentico.com/docsassets/guides/design-atomic-content-model/cm-example-seo-and-og-data-in-resuable-field-schema.png)
...
[![Example of a headless article in Kbank demo site](docsassets/guides/design-atomic-content-model/cm-example-headless-content-type.png)](https://docs.kentico.com/docsassets/guides/design-atomic-content-model/cm-example-headless-content-type.png)
...
USE ONLY NECESSARY 
![](https://docs.kentico.com/modules/content-modeling-guide/design-atomic-content-model)
[](https://docs.kentico.com/modules/content-modeling-guide/design-atomic-content-model)[](https://docs.kentico.com/modules/content-modeling-guide/design-atomic-content-model)