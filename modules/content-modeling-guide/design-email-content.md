---
source: https://docs.kentico.com/modules/content-modeling-guide/design-email-content
...
#### Email Builder
Similar to [page builder](/modules/content-modeling-guide/design-website-content), editors create emails visually in a user-friendly interface from components that developers prepared. They arrange email widgets inside email sections on top of the email template.
...
[![Email Builder in Kbank demo site](/docsassets/guides/design-email-content/email_builder_in_kbank.png)](/docsassets/guides/design-email-content/email_builder_in_kbank.png)
...
[![Linked content items in Kbank’s demo newsletter](/docsassets/guides/design-email-content/featured_content_in_structured_email.png)](/docsassets/guides/design-email-content/featured_content_in_structured_email.png)
#### Hybrid emails
...
[![Email template containing individual email fields](/docsassets/guides/design-email-content/Email_Structure.png)](/docsassets/guides/design-email-content/Email_Structure.png)
### Reusable content in emails
Editors can speed up how they compose emails by reusing existing content. They can build their emails from any structured content stored as pages in a [any website channel](/modules/content-modeling-guide/design-page-based-content-model#identify-reusable-data), or as reusable items in the _Content hub_.
We recommend storing content in a [structured way](/modules/content-modeling-guide/store-all-content-in-xperience) to support content reusability and improve [governance](/guides/digital-marketing/content-governance-in-xbyk).
...
[![Linked content items in emails](/docsassets/guides/design-email-content/email_linked_content_item.png)](/docsassets/guides/design-email-content/email_linked_content_item.png)
...
[ Previous page ](/modules/content-modeling-guide/design-atomic-content-model)
21 of 28
[ Mark complete and continue ](/modules/content-modeling-guide/design-headless-content)
![]()
[]()[]()
