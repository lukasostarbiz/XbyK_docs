# Content modeling process
  * [ Copy page link ](modules/content-modeling-guide/content-modeling-process#) | [Get HelpService ID](modules/content-modeling-guide/content-modeling-process#)
Core MVC 5


[✖](modules/content-modeling-guide/content-modeling-process# "Close page link panel") [Copy to clipboard](modules/content-modeling-guide/content-modeling-process#)
...
During a content modeling process, your team defines:
  ...
  * The different [content types](modules/content-modeling-guide/what-is-a-content-type) required to meet the organization’s marketing objectives.
...
[ Previous page ](modules/content-modeling-guide/content-modeling-business-requirements)
5 of 28
[ Mark complete and continue ](modules/content-modeling-guide/model-taxonomies)
...
USE ONLY NECESSARY 
![](https://docs.kentico.com/modules/content-modeling-guide/content-modeling-process)
[](https://docs.kentico.com/modules/content-modeling-guide/content-modeling-process)[](https://docs.kentico.com/modules/content-modeling-guide/content-modeling-process)