# Design headless content
  * [ Copy page link ](modules/content-modeling-guide/design-headless-content#) | [Get HelpService ID](modules/content-modeling-guide/design-headless-content#)
Core MVC 5


[✖](modules/content-modeling-guide/design-headless-content# "Close page link panel") [Copy to clipboard](modules/content-modeling-guide/design-headless-content#)
...
The following example shows the terminology used for headless items in the [Kbank](modules/content-modeling-guide/what-is-a-content-type#best-practices-in-kbank-demo-site) application.
[![Naming used in the Kbank headless application](docsassets/guides/design-headless-content/kbank_app_naming.png)](https://docs.kentico.com/docsassets/guides/design-headless-content/kbank_app_naming.png)
...
[![Kbank home screen](docsassets/guides/design-headless-content/kbank_home_screen.png)](https://docs.kentico.com/docsassets/guides/design-headless-content/kbank_home_screen.png)
...
[![Kbank products listing screen](docsassets/guides/design-headless-content/kbank_products_listing_screen.png)](https://docs.kentico.com/docsassets/guides/design-headless-content/kbank_products_listing_screen.png)
...
[![Kbank product screen](docsassets/guides/design-headless-content/kbank_product_screen.png)](https://docs.kentico.com/docsassets/guides/design-headless-content/kbank_product_screen.png)
...
[![Kbank articles listing screen](docsassets/guides/design-headless-content/kbank_articles_listing_screen.png)](https://docs.kentico.com/docsassets/guides/design-headless-content/kbank_articles_listing_screen.png)
...
[![Possible Kbank diagram](docsassets/guides/design-headless-content/kbank_simplified_diagram.png)](https://docs.kentico.com/docsassets/guides/design-headless-content/kbank_simplified_diagram.png)
...
[![Field value override logic](docsassets/guides/design-headless-content/field_value_overrides.png)](https://docs.kentico.com/docsassets/guides/design-headless-content/field_value_overrides.png)
...
Marketers often want to personalize their content to best suit their consumers. Editors can create personalized content in a headless channel by making headless items for each piece of content that will be part of the app screen. The general recommendations for populating headless channels are:
  ...
  2. Headless items for separate content items with additional [fields](modules/content-modeling-guide/design-headless-content#override-default-field-values) for customizing their content.
...
[![Kbank personalized headless items](docsassets/guides/design-headless-content/kbank_personalized_content.png)](https://docs.kentico.com/docsassets/guides/design-headless-content/kbank_personalized_content.png)
...
[ Previous page ](modules/content-modeling-guide/design-email-content)
22 of 28
[ Mark complete and continue ](modules/content-modeling-guide/content-modeling-digital-marketing-features)
...
USE ONLY NECESSARY 
![](https://docs.kentico.com/modules/content-modeling-guide/design-headless-content)
[](https://docs.kentico.com/modules/content-modeling-guide/design-headless-content)[](https://docs.kentico.com/modules/content-modeling-guide/design-headless-content)