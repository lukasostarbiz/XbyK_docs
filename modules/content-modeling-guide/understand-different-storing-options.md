# Understand how each content type stores and uses data
  * [ Copy page link ](modules/content-modeling-guide/understand-different-storing-options#) | [Get HelpService ID](modules/content-modeling-guide/understand-different-storing-options#)
Core MVC 5


[✖](modules/content-modeling-guide/understand-different-storing-options# "Close page link panel") [Copy to clipboard](modules/content-modeling-guide/understand-different-storing-options#)
...
In a website channel, editors create content using the [Page Builder content](modules/content-modeling-guide/understand-different-storing-options#page-builder-content) that allows flexible editing of the layout and content of pages, as [structured pages](modules/content-modeling-guide/understand-different-storing-options#structured-pages) that store content into fields without including presentation information and support consistent reuse and delivery. They can also display [reusable content](modules/content-modeling-guide/understand-different-storing-options#reusable-content-in-content-hub) from the _Content hub_. Pages in the website channel are displayed in a visual hierarchy called the [content tree](guides/digital-marketing/xperience-essentials/manage-website-content-essentials#content-tree-represents-the-hierarchy-of-website-pages).
...
USE ONLY NECESSARY 
![](https://docs.kentico.com/modules/content-modeling-guide/understand-different-storing-options)
[](https://docs.kentico.com/modules/content-modeling-guide/understand-different-storing-options)[](https://docs.kentico.com/modules/content-modeling-guide/understand-different-storing-options)