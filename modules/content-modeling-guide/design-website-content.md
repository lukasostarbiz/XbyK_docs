# Design website content
  * [ Copy page link ](modules/content-modeling-guide/design-website-content#) | [Get HelpService ID](modules/content-modeling-guide/design-website-content#)
Core MVC 5


[✖](modules/content-modeling-guide/design-website-content# "Close page link panel") [Copy to clipboard](modules/content-modeling-guide/design-website-content#)
...
You can design and present content using the following Xperience features (and their combinations):
  * **Predefined content templates**
    * Displays only structured content (that is stored through the [page](modules/content-modeling-guide/design-page-based-content-model) or [](https://docs.kentico.com/modules/content-modeling-guide/design-atomic-content-model) )
...
USE ONLY NECESSARY 
![](https://docs.kentico.com/modules/content-modeling-guide/design-website-content)
[](https://docs.kentico.com/modules/content-modeling-guide/design-website-content)[](https://docs.kentico.com/modules/content-modeling-guide/design-website-content)