---
source: https://docs.kentico.com/modules/email-builder/email-builder-prerequisites
...
The [**main branch**](https://github.com/Kentico/xperience-by-kentico-training-guides) of the repository provides a **starting point** to code along with this module.
The code samples in this module have only been tested in [.NET 8](https://learn.microsoft.com/en-us/dotnet/core/whats-new/dotnet-9/overview).
...
[ Previous page ](/modules/email-builder)
2 of 13
[ Mark complete and continue ](/modules/email-builder/prepare-your-project-for-the-starter-kit)
![]()
[]()[]()
