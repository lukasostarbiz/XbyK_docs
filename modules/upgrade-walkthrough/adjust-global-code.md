# Adjust global code on the backend
  * [ Copy page link ](modules/upgrade-walkthrough/adjust-global-code#) | [Get HelpService ID](modules/upgrade-walkthrough/adjust-global-code#)
Core MVC 5


[✖](modules/upgrade-walkthrough/adjust-global-code# "Close page link panel") [Copy to clipboard](modules/upgrade-walkthrough/adjust-global-code#)
...
Your browser does not support the video tag. 
[ Previous page ](modules/upgrade-walkthrough/migrate-data-and-binary-files)
4 of 6
[ Mark complete and continue ](modules/upgrade-walkthrough/display-an-upgraded-page)
...
USE ONLY NECESSARY 
![](https://docs.kentico.com/modules/upgrade-walkthrough/adjust-global-code)
[](https://docs.kentico.com/modules/upgrade-walkthrough/adjust-global-code)[](https://docs.kentico.com/modules/upgrade-walkthrough/adjust-global-code)