# Manage website content
  * [ Copy page link ](modules/content-management-essentials/manage-website-content-essentials#) | [Get HelpService ID](modules/content-management-essentials/manage-website-content-essentials#)
Core MVC 5


[✖](modules/content-management-essentials/manage-website-content-essentials# "Close page link panel") [Copy to clipboard](modules/content-management-essentials/manage-website-content-essentials#)
...
Xperience supports two types of page templates:
  * **Default page templates** are created by developers for every Xperience website. You’ve used it in the [previous exercise](modules/content-management-essentials/manage-website-content-essentials#exercise-1---adding-a-new-article) previous exercise to create the article about travel insurance.
...
USE ONLY NECESSARY 
![](https://docs.kentico.com/modules/content-management-essentials/manage-website-content-essentials)
[](https://docs.kentico.com/modules/content-management-essentials/manage-website-content-essentials)[](https://docs.kentico.com/modules/content-management-essentials/manage-website-content-essentials)