# Manage files
  * [ Copy page link ](modules/content-management-essentials/manage-files-essentials#) | [Get HelpService ID](modules/content-management-essentials/manage-files-essentials#)
Core MVC 5


[✖](modules/content-management-essentials/manage-files-essentials# "Close page link panel") [Copy to clipboard](modules/content-management-essentials/manage-files-essentials#)
...
[![Asset content type](docsassets/guides/manage-files-essentials/asset-content-type.png)](https://docs.kentico.com/docsassets/guides/manage-files-essentials/asset-content-type.png)
...
[![Asset content type](docsassets/guides/manage-files-essentials/cm-guide-content-hub-assets-preview.png)](https://docs.kentico.com/docsassets/guides/manage-files-essentials/cm-guide-content-hub-assets-preview.png)
If you need to add multiple files to the _Content hub_ at once, use the **Upload files** button.
[![Upload files in bulk](docsassets/guides/manage-files-essentials/cm-guide-mass-file-upload.png)](https://docs.kentico.com/docsassets/guides/manage-files-essentials/cm-guide-mass-file-upload.png)
You can also upload an image **directly from a widget** while editing a page.
[![Create new item in widget](docsassets/guides/manage-files-essentials/empty-image-widget.png)](https://docs.kentico.com/docsassets/guides/manage-files-essentials/empty-image-widget.png)
...
[![Updating automatic taxonomy tags](docsassets/guides/manage-files-essentials/update_automatic-taxonomy-tags.png)](https://docs.kentico.com/docsassets/guides/manage-files-essentials/update_automatic-taxonomy-tags.png)
...
[![Content items that require the user to sign before viewing their content](docsassets/guides/manage-files-essentials/cm-guide-secured-access.png)](https://docs.kentico.com/docsassets/guides/manage-files-essentials/cm-guide-secured-access.png)
...
[![Choose the correct workspace and create folder structure](docsassets/guides/manage-files-essentials/correct-workspace-and-folders.png)](https://docs.kentico.com/docsassets/guides/manage-files-essentials/correct-workspace-and-folders.png)
Why does it matter? A logical [folder hierarchy](guides/digital-marketing/work-with-reusable-content/organize-assets-in-content-hub) makes browsing and permissions simpler for everyone.
  1. **Start a bulk upload**
    1. Next to the **New content item** button, use the arrow to open dropdown menu and select **Upload files**. [![Upload button](docsassets/guides/manage-files-essentials/upload-button.png)](https://docs.kentico.com/docsassets/guides/manage-files-essentials/upload-button.png)
    ...
    4. Once the files are successfully uploaded, you can **Close** the upload dialog. [![Upload queue](docsassets/guides/manage-files-essentials/selected-files-during-upload.png)](https://docs.kentico.com/docsassets/guides/manage-files-essentials/selected-files-during-upload.png)
...
During the upload, AIRA automatically tags and optimizes the images. You can then start adjusting them manually.
  1. **Check and adjust images**
    1. Open the image with the original filename _AdobeStock_445562436.jpeg_ and adjust: 
       ...
       * Click the **Adjust image** icon to update the image variant. [![Adjust image](docsassets/guides/manage-files-essentials/adjust-image-variants.png)](https://docs.kentico.com/docsassets/guides/manage-files-essentials/adjust-image-variants.png)
       * **Primary Image** changes to make: 
         * **Image format** : Change from _JPEG_ to _JPG_.
         * **Quality** : adjust the quality to _Medium 80%_
    2. **Save** the changes.
    3. Manually adjust the **focal point** of the _Primary image_. [![Manual focal point adjustment](docsassets/guides/manage-files-essentials/move-focal-point.gif)](https://docs.kentico.com/docsassets/guides/manage-files-essentials/move-focal-point.gif)
    4. Check and adjust the crop in **Image variants** if needed. [![Adjust image variant crop](docsassets/guides/manage-files-essentials/adjust-image-variant-crop.jpg)](https://docs.kentico.com/docsassets/guides/manage-files-essentials/adjust-image-variant-crop.jpg)
...
[![AIRA-generated tags](docsassets/guides/manage-files-essentials/AIRA-generated-tags.png)](https://docs.kentico.com/docsassets/guides/manage-files-essentials/AIRA-generated-tags.png)
...
Currently, you can only choose from predefined tags configured by your developer. You cannot create new tags in the _Content hub_ at the moment. However, it is still beneficial to follow a few best practices when it comes to tagging.
  ...
  * Follow team conventions for consistency.
  ...
  1. **Inspect another image to verify results**
    ...
    3. Make minor edits if needed, then **Save**. [![Check images for last updates](docsassets/guides/manage-files-essentials/check-image-for-last-updates.png)](https://docs.kentico.com/docsassets/guides/manage-files-essentials/check-image-for-last-updates.png)
...
[![Filter assets in folder for last checks](docsassets/guides/manage-files-essentials/filter-assets-in-folder.png)](https://docs.kentico.com/docsassets/guides/manage-files-essentials/filter-assets-in-folder.png)
  3. **Publish your assets**
    ...
    2. **Publish** all selected items in bulk. [![Publish selected assets](docsassets/guides/manage-files-essentials/publish-selected-assets.png)](https://docs.kentico.com/docsassets/guides/manage-files-essentials/publish-selected-assets.png)
    3. If unsure about the result, verify that the status of the selected assets has changed from _Draft (Initial)_ to _Published_. [![Published assets status](docsassets/guides/manage-files-essentials/published-assets-status.png)](https://docs.kentico.com/docsassets/guides/manage-files-essentials/published-assets-status.png)
...
To follow along with the exercise, download a [sample image file](https://download.kentico.com/Training/exercise-sample-manage-files-man-holding-credit-card.png) we prepared for you.
  ...
  2. **Select the empty Image widget**
     ...
     * Open the widget properties to insert the sample image you downloaded. [![Image widget properties](docsassets/guides/manage-files-essentials/empty-image-widget-properties.png)](https://docs.kentico.com/docsassets/guides/manage-files-essentials/empty-image-widget-properties.png)
...
[![Image properties dialogue](docsassets/guides/manage-files-essentials/image-properties-with-new-item.png)](https://docs.kentico.com/docsassets/guides/manage-files-essentials/image-properties-with-new-item.png)
...
The page should look something like the following image: [![Premier credit card page with new image](docsassets/guides/manage-files-essentials/premier-credit-card-with-new-product-image.png)](https://docs.kentico.com/docsassets/guides/manage-files-essentials/premier-credit-card-with-new-product-image.png)
...
[![See where your image is used before making any changes](docsassets/guides/manage-files-essentials/content_reuse_locator_use_in_tab_on_image.png)](https://docs.kentico.com/docsassets/guides/manage-files-essentials/content_reuse_locator_use_in_tab_on_image.png)
## Image AI features
...
[![Manually selected focal point](docsassets/guides/manage-files-essentials/primary-image-manually-selected-focal-point.png)](https://docs.kentico.com/docsassets/guides/manage-files-essentials/primary-image-manually-selected-focal-point.png)
...
[![Vertical image variant](docsassets/guides/manage-files-essentials/vertical-image-variant.png)](https://docs.kentico.com/docsassets/guides/manage-files-essentials/vertical-image-variant.png)
...
[![Folder structure in a media library](docsassets/guides/manage-files-essentials/cm-guide-library-files-folder-structure.png)](https://docs.kentico.com/docsassets/guides/manage-files-essentials/cm-guide-library-files-folder-structure.png)
...
[ Previous page ](modules/content-management-essentials/manage-website-content-essentials)
4 of 5
[ Mark complete and continue ](modules/content-management-essentials/manage-content-essentials-next-steps)
...
USE ONLY NECESSARY 
![](https://docs.kentico.com/modules/content-management-essentials/manage-files-essentials)
[](https://docs.kentico.com/modules/content-management-essentials/manage-files-essentials)[](https://docs.kentico.com/modules/content-management-essentials/manage-files-essentials)