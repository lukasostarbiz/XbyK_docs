# Taxonomies deep dive
  * [ Copy page link ](modules/work-with-taxonomies/taxonomy-types#) | [Get HelpService ID](modules/work-with-taxonomies/taxonomy-types#)
Core MVC 5


[✖](modules/work-with-taxonomies/taxonomy-types# "Close page link panel") [Copy to clipboard](modules/work-with-taxonomies/taxonomy-types#)
...
[![Example of a semantic taxonomy on Kbank demo site](docsassets/guides/model-taxonomies/cm-semantic-taxonomy-finance-group.png)](https://docs.kentico.com/docsassets/guides/model-taxonomies/cm-semantic-taxonomy-finance-group.png)
...
[![Example fo a functional taxonomy on Kbank demo site](docsassets/guides/model-taxonomies/cm-guide-functional-taxonomy-regional-availability.png)](https://docs.kentico.com/docsassets/guides/model-taxonomies/cm-guide-functional-taxonomy-regional-availability.png)
...
[![Profile page shows content displayed from linked content items](docsassets/guides/model-taxonomies/cm-guide-custom-taxonomy-types-khealth-demo-site.png)](https://docs.kentico.com/docsassets/guides/model-taxonomies/cm-guide-custom-taxonomy-types-khealth-demo-site.png)
The exact relationships between the data can drive faceted filtering on a search page in the Khealth demo site.
[![Taxonomy defined through custom content types drives filtering on Khealth demo site](docsassets/guides/model-taxonomies/cm-guide-custom-faceted-taxonomy-types-khealth-demo-site.png)](https://docs.kentico.com/docsassets/guides/model-taxonomies/cm-guide-custom-faceted-taxonomy-types-khealth-demo-site.png)
...
USE ONLY NECESSARY 
![](https://docs.kentico.com/modules/work-with-taxonomies/taxonomy-types)
[](https://docs.kentico.com/modules/work-with-taxonomies/taxonomy-types)[](https://docs.kentico.com/modules/work-with-taxonomies/taxonomy-types)