# Update a deployment's Xperience version
  * [ Copy page link ](modules/private-cloud-deployment/update-xperience-version#) | [Get HelpService ID](modules/private-cloud-deployment/update-xperience-version#)
Core MVC 5


[✖](modules/private-cloud-deployment/update-xperience-version# "Close page link panel") [Copy to clipboard](modules/private-cloud-deployment/update-xperience-version#)
...
USE ONLY NECESSARY 
![](https://docs.kentico.com/modules/private-cloud-deployment/update-xperience-version)
[](https://docs.kentico.com/modules/private-cloud-deployment/update-xperience-version)[](https://docs.kentico.com/modules/private-cloud-deployment/update-xperience-version)