# Deploy code and data changes
  * [ Copy page link ](modules/private-cloud-deployment/deploy-code-and-data-changes#) | [Get HelpService ID](modules/private-cloud-deployment/deploy-code-and-data-changes#)
Core MVC 5


[✖](modules/private-cloud-deployment/deploy-code-and-data-changes# "Close page link panel") [Copy to clipboard](modules/private-cloud-deployment/deploy-code-and-data-changes#)
...
USE ONLY NECESSARY 
![](https://docs.kentico.com/modules/private-cloud-deployment/deploy-code-and-data-changes)
[](https://docs.kentico.com/modules/private-cloud-deployment/deploy-code-and-data-changes)[](https://docs.kentico.com/modules/private-cloud-deployment/deploy-code-and-data-changes)