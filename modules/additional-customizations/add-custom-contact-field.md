# Add a custom field to the Contact profile
  * [ Copy page link ](modules/additional-customizations/add-custom-contact-field#) | [Get HelpService ID](modules/additional-customizations/add-custom-contact-field#)
Core MVC 5


[✖](modules/additional-customizations/add-custom-contact-field# "Close page link panel") [Copy to clipboard](modules/additional-customizations/add-custom-contact-field#)
...
[![Custom contact fields shown in a new tab, called Custom fields](docsassets/guides/add-custom-contact-field/custom-fields-new-tab-intro.gif)](https://docs.kentico.com/docsassets/guides/add-custom-contact-field/custom-fields-new-tab-intro.gif)
...
This helps with clarity and the identification of custom fields, both in code and administration. For example, when creating a [new UI form](modules/additional-customizations/add-custom-contact-field#define-your-ui-form), Xperience orders them alphabetically.
In your Xperience administration, your new fields will appear at the bottom of the list: [![Custom database fields on Contact class in Xperience](docsassets/guides/add-custom-contact-field/contact-custom-db-columns.png)](https://docs.kentico.com/docsassets/guides/add-custom-contact-field/contact-custom-db-columns.png)
## Define your UI form
...
[![UI form definition sample](docsassets/guides/add-custom-contact-field/custom-fields-form.png)](https://docs.kentico.com/docsassets/guides/add-custom-contact-field/custom-fields-form.png)
which renders for the editor like this:
[![UI form rendering sample](docsassets/guides/add-custom-contact-field/custom-fields-form-rendering.png)](https://docs.kentico.com/docsassets/guides/add-custom-contact-field/custom-fields-form-rendering.png)
...
[![Contact default forms](docsassets/guides/add-custom-contact-field/contact-default-forms.png)](https://docs.kentico.com/docsassets/guides/add-custom-contact-field/contact-default-forms.png)
...
[![Custom UI page in Contact profile tree](docsassets/guides/add-custom-contact-field/contact-custom-ui-page-tree.png)](https://docs.kentico.com/docsassets/guides/add-custom-contact-field/contact-custom-ui-page-tree.png)
...
Additionally, if you navigate to **System → UI tree** , you should be able to see your page in the UI tree structure: [![Custom fields page in UI tree structure](docsassets/guides/add-custom-contact-field/custom-fields-page-UI-tree.png)](https://docs.kentico.com/docsassets/guides/add-custom-contact-field/custom-fields-page-UI-tree.png)
...
[![UI form with a readonly Yes/No flag](docsassets/guides/add-custom-contact-field/contact-customized-field.png)](https://docs.kentico.com/docsassets/guides/add-custom-contact-field/contact-customized-field.png)
  ...
  3. Add a new field. In the **Database column** select, pick **New field without database column**. [![Creating a field without database column](docsassets/guides/add-custom-contact-field/contact-field-no-db-column.png)](https://docs.kentico.com/docsassets/guides/add-custom-contact-field/contact-field-no-db-column.png)
...
[![Custom fields page in Contact profile](docsassets/guides/add-custom-contact-field/custom-fields-final-form.gif)](https://docs.kentico.com/docsassets/guides/add-custom-contact-field/custom-fields-final-form.gif)
...
[![Custom field added in the ‘Set contact field value automation step’ UI form in Xperience administration](docsassets/guides/add-custom-contact-field/automation-add-custom-field.png)](https://docs.kentico.com/docsassets/guides/add-custom-contact-field/automation-add-custom-field.png)
...
[ Previous page ](modules/additional-customizations/tools-for-integrations)
3 of 6
[ Mark complete and continue ](modules/additional-customizations/import-objects-with-the-api)
...
USE ONLY NECESSARY 
![](https://docs.kentico.com/modules/additional-customizations/add-custom-contact-field)
[](https://docs.kentico.com/modules/additional-customizations/add-custom-contact-field)[](https://docs.kentico.com/modules/additional-customizations/add-custom-contact-field)