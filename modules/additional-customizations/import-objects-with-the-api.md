# Import objects in bulk using the API
  * [ Copy page link ](modules/additional-customizations/import-objects-with-the-api#) | [Get HelpService ID](modules/additional-customizations/import-objects-with-the-api#)
Core MVC 5


[✖](modules/additional-customizations/import-objects-with-the-api# "Close page link panel") [Copy to clipboard](modules/additional-customizations/import-objects-with-the-api#)
...
You can find a more detailed exploration of extending the **Contact** class in our [custom contact field materials](modules/additional-customizations/add-custom-contact-field).
...
[ Previous page ](modules/additional-customizations/add-custom-contact-field)
4 of 6
[ Mark complete and continue ](modules/additional-customizations/add-imported-contacts-groups-recipients)
...
USE ONLY NECESSARY 
![](https://docs.kentico.com/modules/additional-customizations/import-objects-with-the-api)
[](https://docs.kentico.com/modules/additional-customizations/import-objects-with-the-api)[](https://docs.kentico.com/modules/additional-customizations/import-objects-with-the-api)