# Choose the right tools for your integration
  * [ Copy page link ](modules/additional-customizations/tools-for-integrations#) | [Get HelpService ID](modules/additional-customizations/tools-for-integrations#)
Core MVC 5


[✖](modules/additional-customizations/tools-for-integrations# "Close page link panel") [Copy to clipboard](modules/additional-customizations/tools-for-integrations#)
...
[ Previous page ](modules/additional-customizations)
2 of 6
[ Mark complete and continue ](modules/additional-customizations/add-custom-contact-field)
...
USE ONLY NECESSARY 
![](https://docs.kentico.com/modules/additional-customizations/tools-for-integrations)
[](https://docs.kentico.com/modules/additional-customizations/tools-for-integrations)[](https://docs.kentico.com/modules/additional-customizations/tools-for-integrations)