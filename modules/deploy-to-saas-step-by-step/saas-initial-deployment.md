# Deploy your solution to Xperience Portal
  * [ Copy page link ](modules/deploy-to-saas-step-by-step/saas-initial-deployment#) | [Get HelpService ID](modules/deploy-to-saas-step-by-step/saas-initial-deployment#)
Core MVC 5


[✖](modules/deploy-to-saas-step-by-step/saas-initial-deployment# "Close page link panel") [Copy to clipboard](modules/deploy-to-saas-step-by-step/saas-initial-deployment#)
...
USE ONLY NECESSARY 
![](https://docs.kentico.com/modules/deploy-to-saas-step-by-step/saas-initial-deployment)
[](https://docs.kentico.com/modules/deploy-to-saas-step-by-step/saas-initial-deployment)[](https://docs.kentico.com/modules/deploy-to-saas-step-by-step/saas-initial-deployment)