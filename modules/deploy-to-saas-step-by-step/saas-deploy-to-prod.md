# Deploy to production
  * [ Copy page link ](modules/deploy-to-saas-step-by-step/saas-deploy-to-prod#) | [Get HelpService ID](modules/deploy-to-saas-step-by-step/saas-deploy-to-prod#)
Core MVC 5


[✖](modules/deploy-to-saas-step-by-step/saas-deploy-to-prod# "Close page link panel") [Copy to clipboard](modules/deploy-to-saas-step-by-step/saas-deploy-to-prod#)
...
To start, visit your Xperience Portal and ensure you are working [under the correct project](modules/deploy-to-saas-step-by-step/saas-setup#identify-the-active-project).
...
[![Deploying from QA to STG or PROD in Xperience Portal](docsassets/guides/saas-deploy-to-prod/deploy-to-stg-prod.png)](https://docs.kentico.com/docsassets/guides/saas-deploy-to-prod/deploy-to-stg-prod.png)
...
[![Successful PROD deployment in Deployment history](docsassets/guides/saas-deploy-to-prod/prod-deployment-success.png)](https://docs.kentico.com/docsassets/guides/saas-deploy-to-prod/prod-deployment-success.png)
...
Your browser does not support the video tag. 
During the [channels configuration step](modules/deploy-to-saas-step-by-step/saas-configure-channels), we created default channels and domains for all of your environments, so now you should also be able to see your **PROD live site** through your **production website channel default domain** :
Your browser does not support the video tag. 
...
[![System domains for PROD](docsassets/guides/saas-deploy-to-prod/system-domains.png)](https://docs.kentico.com/docsassets/guides/saas-deploy-to-prod/system-domains.png)
### Channel domains
...
[ Previous page ](modules/deploy-to-saas-step-by-step/saas-update-with-xperience-portal-api)
7 of 8
[ Mark complete and continue ](modules/deploy-to-saas-step-by-step/saas-next-steps)
...
USE ONLY NECESSARY 
![](https://docs.kentico.com/modules/deploy-to-saas-step-by-step/saas-deploy-to-prod)
[](https://docs.kentico.com/modules/deploy-to-saas-step-by-step/saas-deploy-to-prod)[](https://docs.kentico.com/modules/deploy-to-saas-step-by-step/saas-deploy-to-prod)