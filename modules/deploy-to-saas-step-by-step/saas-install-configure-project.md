# Install, configure and develop a SaaS-ready project
  * [ Copy page link ](modules/deploy-to-saas-step-by-step/saas-install-configure-project#) | [Get HelpService ID](modules/deploy-to-saas-step-by-step/saas-install-configure-project#)
Core MVC 5


[✖](modules/deploy-to-saas-step-by-step/saas-install-configure-project# "Close page link panel") [Copy to clipboard](modules/deploy-to-saas-step-by-step/saas-install-configure-project#)
...
We are using the [environment identification extension](modules/deploy-to-saas-step-by-step/saas-install-configure-project#identification-of-your-working-environment) methods mentioned above to enable SendGrid only in the SaaS environment, as it will not work locally.
...
[ Previous page ](modules/deploy-to-saas-step-by-step/saas-setup)
3 of 8
[ Mark complete and continue ](modules/deploy-to-saas-step-by-step/saas-initial-deployment)
...
USE ONLY NECESSARY 
![](https://docs.kentico.com/modules/deploy-to-saas-step-by-step/saas-install-configure-project)
[](https://docs.kentico.com/modules/deploy-to-saas-step-by-step/saas-install-configure-project)[](https://docs.kentico.com/modules/deploy-to-saas-step-by-step/saas-install-configure-project)