# Update a QA deployment using Xperience Portal API
  * [ Copy page link ](modules/deploy-to-saas-step-by-step/saas-update-with-xperience-portal-api#) | [Get HelpService ID](modules/deploy-to-saas-step-by-step/saas-update-with-xperience-portal-api#)
Core MVC 5


[✖](modules/deploy-to-saas-step-by-step/saas-update-with-xperience-portal-api# "Close page link panel") [Copy to clipboard](modules/deploy-to-saas-step-by-step/saas-update-with-xperience-portal-api#)
...
USE ONLY NECESSARY 
![](https://docs.kentico.com/modules/deploy-to-saas-step-by-step/saas-update-with-xperience-portal-api)
[](https://docs.kentico.com/modules/deploy-to-saas-step-by-step/saas-update-with-xperience-portal-api)[](https://docs.kentico.com/modules/deploy-to-saas-step-by-step/saas-update-with-xperience-portal-api)