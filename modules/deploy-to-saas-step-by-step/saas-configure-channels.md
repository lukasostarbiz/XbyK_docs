# Configure channels
  * [ Copy page link ](modules/deploy-to-saas-step-by-step/saas-configure-channels#) | [Get HelpService ID](modules/deploy-to-saas-step-by-step/saas-configure-channels#)
Core MVC 5


[✖](modules/deploy-to-saas-step-by-step/saas-configure-channels# "Close page link panel") [Copy to clipboard](modules/deploy-to-saas-step-by-step/saas-configure-channels#)
...
Click **Add channel**.
[![Create a website channel in Xperience Portal](docsassets/guides/saas-configure-channels/add-website-channel-1.png)](https://docs.kentico.com/docsassets/guides/saas-configure-channels/add-website-channel-1.png)
...
[![Filling out channel data](docsassets/guides/saas-configure-channels/add-website-channel-2.png)](https://docs.kentico.com/docsassets/guides/saas-configure-channels/add-website-channel-2.png)
...
[![Channel info about Dancing Goat Pages in the Xperience administration](docsassets/guides/saas-configure-channels/channel-code-name-in-admin.png)](https://docs.kentico.com/docsassets/guides/saas-configure-channels/channel-code-name-in-admin.png)
After you confirm, you should see your channel being created in the **Channels** page in the Xperience Portal.
[![Website channel being created](docsassets/guides/saas-configure-channels/channel-creating.png)](https://docs.kentico.com/docsassets/guides/saas-configure-channels/channel-creating.png)
...
[![Channel pending, user needs to Apply changes](docsassets/guides/saas-configure-channels/apply-changes-1.png)](https://docs.kentico.com/docsassets/guides/saas-configure-channels/apply-changes-1.png)
...
Click **Apply changes**.
[![Channel pending, user needs to Apply changes](docsassets/guides/saas-configure-channels/apply-changes-2.png)](https://docs.kentico.com/docsassets/guides/saas-configure-channels/apply-changes-2.png)
...
[![Finishing up the channel setup](docsassets/guides/saas-configure-channels/apply-changes-3.png)](https://docs.kentico.com/docsassets/guides/saas-configure-channels/apply-changes-3.png)
...
[![Navigating to the channel’s domains](docsassets/guides/saas-configure-channels/channels-domains-1.png)](https://docs.kentico.com/docsassets/guides/saas-configure-channels/channels-domains-1.png)
...
[![‘Dancing Goat Pages’ channel’s domains](docsassets/guides/saas-configure-channels/channels-domains-2.png)](https://docs.kentico.com/docsassets/guides/saas-configure-channels/channels-domains-2.png)
...
[![‘Dancing Goat Pages’ channel’s domains are active and ready](docsassets/guides/saas-configure-channels/channel-domains-active.png)](https://docs.kentico.com/docsassets/guides/saas-configure-channels/channel-domains-active.png)
### Check your progress
...
[![QA default domain name](docsassets/guides/saas-configure-channels/qa-default-domain.png)](https://docs.kentico.com/docsassets/guides/saas-configure-channels/qa-default-domain.png) [![Dancing Goat live site deployed in the QA environment](docsassets/guides/saas-configure-channels/dancing-goat-live-site-in-qa.jpg)](https://docs.kentico.com/docsassets/guides/saas-configure-channels/dancing-goat-live-site-in-qa.jpg)
...
[![Dancing Goat Emails channel before the SaaS configuration](docsassets/guides/saas-configure-channels/email-channel-before-configuration.png)](https://docs.kentico.com/docsassets/guides/saas-configure-channels/email-channel-before-configuration.png)
...
[![Create a website channel in Xperience Portal](docsassets/guides/saas-configure-channels/add-email-channel.png)](https://docs.kentico.com/docsassets/guides/saas-configure-channels/add-email-channel.png)
...
[![Apply changes to the email channel domains in the Xperience Portal](docsassets/guides/saas-configure-channels/email-channel-apply-changes.gif)](https://docs.kentico.com/docsassets/guides/saas-configure-channels/email-channel-apply-changes.gif)
...
[![Email channel domains setup ready](docsassets/guides/saas-configure-channels/email-domains-setup.png)](https://docs.kentico.com/docsassets/guides/saas-configure-channels/email-domains-setup.png)
...
[ Previous page ](modules/deploy-to-saas-step-by-step/saas-initial-deployment)
5 of 8
[ Mark complete and continue ](modules/deploy-to-saas-step-by-step/saas-update-with-xperience-portal-api)
...
USE ONLY NECESSARY 
![](https://docs.kentico.com/modules/deploy-to-saas-step-by-step/saas-configure-channels)
[](https://docs.kentico.com/modules/deploy-to-saas-step-by-step/saas-configure-channels)[](https://docs.kentico.com/modules/deploy-to-saas-step-by-step/saas-configure-channels)