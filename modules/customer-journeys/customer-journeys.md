# Customer journeys - a hands-on tutorial
  * [ Copy page link ](modules/customer-journeys/customer-journeys#) | [Get HelpService ID](modules/customer-journeys/customer-journeys#)
Core MVC 5


[✖](modules/customer-journeys/customer-journeys# "Close page link panel") [Copy to clipboard](modules/customer-journeys/customer-journeys#)
...
Stages represent key steps in the customer journey, such as visiting a specific page or submitting a form. They help you track contact progression, which enables you to analyze contact interactions with your content.
  ...
  3. _(Optional)_ Edit (  
[![Edit customer journey display name](docsassets/documentation/customer-journeys/CJ_Display_name.png)](https://docs.kentico.com/docsassets/documentation/customer-journeys/CJ_Display_name.png)
  4. In the **Journey Builder** view mode, select **New stage** to create a stage: 
    1. Fill in the following properties: 
       ...
       * **Conditions** – determines the conditions that contacts must meet to advance to this stage. See [conditions](modules/customer-journeys/customer-journeys#conditions) to learn more.  
[![Creating a new stage](docsassets/documentation/customer-journeys/CJ_Stage.png)](https://docs.kentico.com/docsassets/documentation/customer-journeys/CJ_Stage.png)
...
When you edit an existing customer journey, it automatically begins [recalculating](modules/customer-journeys/customer-journeys#customer-journey-results) once you save the changes.
### Conditions
...
[![Journey graph and the list of stages](docsassets/documentation/customer-journeys/CJ_Journey.png)](https://docs.kentico.com/docsassets/documentation/customer-journeys/CJ_Journey.png)
Additionally, you can find the following information in the list of stages below the graph:
  ...
  * **Stage KPI** – the number and percentage of the contacts who reached the stage compared to the set [KPI](modules/customer-journeys/customer-journeys#create-a-customer-journey)
...
To gain insights from a journey manually, you can view which [contacts](documentation/business-users/digital-marketing/contact-management) converted or dropped off at each stage by selecting the corresponding numbers in the [journey results](modules/customer-journeys/customer-journeys#customer-journey-results).
To view more information about a specific contact from the converted or dropped off list, open (
[![Number of converted and dropped off contact for a stage](docsassets/documentation/customer-journeys/CJ_Journey_converted_droppedoff.png)](https://docs.kentico.com/docsassets/documentation/customer-journeys/CJ_Journey_converted_droppedoff.png)
[![Contacts converted in stage](docsassets/documentation/customer-journeys/CJ_converted_contacts.png)](https://docs.kentico.com/docsassets/documentation/customer-journeys/CJ_converted_contacts.png)
...
[![Position of the Recalculate button](docsassets/documentation/customer-journeys/CJ_Journey_Recalculate.png)](https://docs.kentico.com/docsassets/documentation/customer-journeys/CJ_Journey_Recalculate.png)
...
All newly [created](modules/customer-journeys/customer-journeys#create-a-customer-journey) journeys will now have the **Scheduled recalculation** property selected by default as long as the _Scheduled customer journey recalculation_ scheduled task is enabled.
...
Upon recalculation, contacts which no longer meet the [conditions](modules/customer-journeys/customer-journeys#conditions) are removed from the corresponding stages. Recalculating the customer journey keeps the data up to date, reflecting only those contacts who currently match the inclusion criteria.
...
[ Previous page ](modules/customer-journeys/use-sales-and-support-team-insights-in-customer-journey)
16 of 17
[ Mark complete and continue ](modules/customer-journeys/customer-journeys-final)
...
USE ONLY NECESSARY 
![](https://docs.kentico.com/modules/customer-journeys/customer-journeys)
[](https://docs.kentico.com/modules/customer-journeys/customer-journeys)[](https://docs.kentico.com/modules/customer-journeys/customer-journeys)