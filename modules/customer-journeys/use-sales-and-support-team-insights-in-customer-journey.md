...
Here are key types of feedback to gather and how they can help:
  * **Surveys and Polls** – _Structured surveys_ (e.g., Net Promoter Score, onboarding questionnaires, or post-purchase feedback) help gauge customer satisfaction, loyalty, and pain points. You’ll see customer sentiment at different journey stages. Quick _polls_ on specific pages, such as _“Was this page helpful?”_ can also provide insight into the usefulness of your content or interface.
  ...
  * **Support tickets and Live chat transcripts** – These sources offer some of the richest [qualitative data](https://en.wikipedia.org/wiki/Qualitative_research). They show what customers are struggling with in real-time. Support conversations often expose recurring questions, broken touchpoints, or confusing content. Live chats can highlight where users get stuck in the journey and what information or reassurance they need to continue.


## Turn assumptions into insights using real feedback
Without direct input, your customer journey risks being shaped by internal opinions or guesswork. Detailed analytics can only go so far—they show users what they do but not what they think or feel.
Using feedback when defining a customer journey allows you to:
