...
Using _Customer journeys_ , Emma maps out the journey **from form submission** to **email engagement** and identifies this key drop-off point. With these insights, she creates a new automation that triggers a **reminder email** after 24 hours, followed by a persuasive message with a **testimonial from a satisfied user**.
