# Create emails in Email Builder
  * [ Copy page link ](modules/work-with-emails/create-emails-in-email-builder#) | [Get HelpService ID](modules/work-with-emails/create-emails-in-email-builder#)
Core MVC 5


[✖](modules/work-with-emails/create-emails-in-email-builder# "Close page link panel") [Copy to clipboard](modules/work-with-emails/create-emails-in-email-builder#)
...
[![Email Builder component structure](docsassets/documentation/create-emails-in-email-builder/EB_component_structure.png)](https://docs.kentico.com/docsassets/documentation/create-emails-in-email-builder/EB_component_structure.png)
  ...
  * **Sections** – sections set a layout for email content, typically with one or more columns. You can add or remove sections, but each editable area in the template must always contain at least one section. Sections contain one or more widget zones. See [Adjust the email layout using sections](modules/work-with-emails/create-emails-in-email-builder#adjust-the-email-layout-using-sections) to learn how to work with sections. 
  ...
  * **Widgets** – reusable components that represent individual pieces of email content, such as text, images, CTA links, etc. See [Add content using widgets](modules/work-with-emails/create-emails-in-email-builder#add-content-using-widgets) to learn how to work with widgets.
...
Widgets allow you to add individual pieces of email content, such as text, images, CTA links, etc. Manage widgets by interacting with the purple UI elements in Email Builder:
  ...
  * **Personalize widgets** – select the [Personalize widgets](modules/work-with-emails/create-emails-in-email-builder#personalize-widgets) to learn more.
...
USE ONLY NECESSARY 
![](https://docs.kentico.com/modules/work-with-emails/create-emails-in-email-builder)
[](https://docs.kentico.com/modules/work-with-emails/create-emails-in-email-builder)[](https://docs.kentico.com/modules/work-with-emails/create-emails-in-email-builder)