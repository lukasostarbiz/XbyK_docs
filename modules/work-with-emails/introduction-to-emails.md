# Introduction to emails
  * [ Copy page link ](modules/work-with-emails/introduction-to-emails#) | [Get HelpService ID](modules/work-with-emails/introduction-to-emails#)
Core MVC 5


[✖](modules/work-with-emails/introduction-to-emails# "Close page link panel") [Copy to clipboard](modules/work-with-emails/introduction-to-emails#)
...
USE ONLY NECESSARY 
![](https://docs.kentico.com/modules/work-with-emails/introduction-to-emails)
[](https://docs.kentico.com/modules/work-with-emails/introduction-to-emails)[](https://docs.kentico.com/modules/work-with-emails/introduction-to-emails)