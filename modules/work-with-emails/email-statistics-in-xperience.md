# Email statistics in Xperience
  * [ Copy page link ](modules/work-with-emails/email-statistics-in-xperience#) | [Get HelpService ID](modules/work-with-emails/email-statistics-in-xperience#)
Core MVC 5


[✖](modules/work-with-emails/email-statistics-in-xperience# "Close page link panel") [Copy to clipboard](modules/work-with-emails/email-statistics-in-xperience#)
...
Xperience by Kentico provides the following types of analytics for emails:
  * [Statistics](modules/work-with-emails/email-statistics-in-xperience#email-statistics) – data such as the number of sent emails, email opens and clicked links. These statistics are anonymous, collected without connecting actions to individual recipients (with the exception of bounced emails).
...
USE ONLY NECESSARY 
![](https://docs.kentico.com/modules/work-with-emails/email-statistics-in-xperience)
[](https://docs.kentico.com/modules/work-with-emails/email-statistics-in-xperience)[](https://docs.kentico.com/modules/work-with-emails/email-statistics-in-xperience)