---
source: https://docs.kentico.com/modules/custom-settings/access-custom-global-configurations
...
Both email notification settings are objects of the `GlobalSettingsKeyInfo` class from [earlier in this series](/modules/custom-settings/define-module-in-xperience-ui#create-data-class).
...
[ Previous page ](/modules/custom-settings/build-module-ui)
4 of 9
[ Mark complete and continue ](/modules/custom-settings/model-channel-specific-settings)
![]()
[]()[]()
