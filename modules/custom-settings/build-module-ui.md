# Build the global settings UI
  * [ Copy page link ](modules/custom-settings/build-module-ui#) | [Get HelpService ID](modules/custom-settings/build-module-ui#)
Core MVC 5


[✖](modules/custom-settings/build-module-ui# "Close page link panel") [Copy to clipboard](modules/custom-settings/build-module-ui#)
...
Let’s create a [listing page](documentation/developers-and-admins/customization/extend-the-administration-interface/ui-pages/reference-ui-page-templates/listing-ui-page-template) and its underlying _edit_ and _create_ pages.
  ...
  3. Implement a UI page using the [Listing UI page template](documentation/developers-and-admins/customization/extend-the-administration-interface/ui-pages/reference-ui-page-templates/listing-ui-page-template). 
     * Register the page as a child of `ProjectSettingsApplication` created in [the previous section](modules/custom-settings/build-module-ui#create-the-application-page).
...
If you copy-pasted the code sample above, note that the `GlobalSettingsListingPage` class references `GlobalSettingsCreatePage` and `GlobalSettingsEditSection` - classes that don’t exist yet. We will create them [in the next section](modules/custom-settings/build-module-ui#define-create-and-edit-pages).
...
USE ONLY NECESSARY 
![](https://docs.kentico.com/modules/custom-settings/build-module-ui)
[](https://docs.kentico.com/modules/custom-settings/build-module-ui)[](https://docs.kentico.com/modules/custom-settings/build-module-ui)