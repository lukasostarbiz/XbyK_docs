# Build a page template
  * [ Copy page link ](modules/developer-kickstart/build-a-page-template#) | [Get HelpService ID](modules/developer-kickstart/build-a-page-template#)
Core MVC 5


[✖](modules/developer-kickstart/build-a-page-template# "Close page link panel") [Copy to clipboard](modules/developer-kickstart/build-a-page-template#)
...
USE ONLY NECESSARY 
![](https://docs.kentico.com/modules/developer-kickstart/build-a-page-template)
[](https://docs.kentico.com/modules/developer-kickstart/build-a-page-template)[](https://docs.kentico.com/modules/developer-kickstart/build-a-page-template)