# Create a reusable content type
  * [ Copy page link ](modules/developer-kickstart/create-a-reusable-content-type#) | [Get HelpService ID](modules/developer-kickstart/create-a-reusable-content-type#)
Core MVC 5


[✖](modules/developer-kickstart/create-a-reusable-content-type# "Close page link panel") [Copy to clipboard](modules/developer-kickstart/create-a-reusable-content-type#)
...
[![Screenshot of the content type creation page for the Slogan type](docsassets/guides/create-a-reusable-content-type/slogan-content-type-create.png)](https://docs.kentico.com/docsassets/guides/create-a-reusable-content-type/slogan-content-type-create.png)
**Reusable content**
...
[![Screenshot of the Content hub application including the slogan type](docsassets/guides/create-a-reusable-content-type/slogan-create-content-item.png)](https://docs.kentico.com/docsassets/guides/create-a-reusable-content-type/slogan-create-content-item.png)
...
[![Screenshot of the Kickstart.Entities project and its folder](docsassets/guides/create-a-reusable-content-type/entities-project-and-folder.png)](https://docs.kentico.com/docsassets/guides/create-a-reusable-content-type/entities-project-and-folder.png)
...
[![Generated Slogan class in the IDE](docsassets/guides/create-a-reusable-content-type/slogan-generated.png)](https://docs.kentico.com/docsassets/guides/create-a-reusable-content-type/slogan-generated.png)
...
[ Previous page ](modules/developer-kickstart/set-up-an-xperience-by-kentico-project)
3 of 13
[ Mark complete and continue ](modules/developer-kickstart/add-a-website-channel)
...
USE ONLY NECESSARY 
![](https://docs.kentico.com/modules/developer-kickstart/create-a-reusable-content-type)
[](https://docs.kentico.com/modules/developer-kickstart/create-a-reusable-content-type)[](https://docs.kentico.com/modules/developer-kickstart/create-a-reusable-content-type)