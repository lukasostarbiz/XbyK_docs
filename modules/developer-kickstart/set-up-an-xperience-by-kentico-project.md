# Set up an Xperience by Kentico project
  * [ Copy page link ](modules/developer-kickstart/set-up-an-xperience-by-kentico-project#) | [Get HelpService ID](modules/developer-kickstart/set-up-an-xperience-by-kentico-project#)
Core MVC 5


[✖](modules/developer-kickstart/set-up-an-xperience-by-kentico-project# "Close page link panel") [Copy to clipboard](modules/developer-kickstart/set-up-an-xperience-by-kentico-project#)
...
[ Previous page ](modules/developer-kickstart)
2 of 13
[ Mark complete and continue ](modules/developer-kickstart/create-a-reusable-content-type)
...
USE ONLY NECESSARY 
![](https://docs.kentico.com/modules/developer-kickstart/set-up-an-xperience-by-kentico-project)
[](https://docs.kentico.com/modules/developer-kickstart/set-up-an-xperience-by-kentico-project)[](https://docs.kentico.com/modules/developer-kickstart/set-up-an-xperience-by-kentico-project)