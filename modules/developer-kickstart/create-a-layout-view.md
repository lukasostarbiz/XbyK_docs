# Create a layout view
  * [ Copy page link ](modules/developer-kickstart/create-a-layout-view#) | [Get HelpService ID](modules/developer-kickstart/create-a-layout-view#)
Core MVC 5


[✖](modules/developer-kickstart/create-a-layout-view# "Close page link panel") [Copy to clipboard](modules/developer-kickstart/create-a-layout-view#)
...
USE ONLY NECESSARY 
![](https://docs.kentico.com/modules/developer-kickstart/create-a-layout-view)
[](https://docs.kentico.com/modules/developer-kickstart/create-a-layout-view)[](https://docs.kentico.com/modules/developer-kickstart/create-a-layout-view)