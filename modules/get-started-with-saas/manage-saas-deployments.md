# Monitor your project
  * [ Copy page link ](modules/get-started-with-saas/manage-saas-deployments#) | [Get HelpService ID](modules/get-started-with-saas/manage-saas-deployments#)
Core MVC 5


[✖](modules/get-started-with-saas/manage-saas-deployments# "Close page link panel") [Copy to clipboard](modules/get-started-with-saas/manage-saas-deployments#)
...
The **Monitoring** set of applications in the Xperience Portal are designed to keep your application running smoothly and provide full visibility into your application’s performance, enabling you to quickly detect and resolve issues, optimize performance, and ensure the best possible user experience.
  * [Uptime monitoring](modules/get-started-with-saas/manage-saas-deployments#uptime-monitoring)
  * [Event log and exceptions](modules/get-started-with-saas/manage-saas-deployments#event-log-and-exceptions)
  * [Performance metrics](modules/get-started-with-saas/manage-saas-deployments#performance-metrics)
  * [Alerts and email notifications](modules/get-started-with-saas/manage-saas-deployments#alerts)
...
Go to [status.xperience-portal.com](https://status.xperience-portal.com/) to see the uptime statistics for Xperience Portal. See [Xperience Portal uptime statistics](modules/get-started-with-saas/manage-saas-deployments#xperience-portal-uptime-statistics).
...
### Alerts
Alerts notify about potential problems with applications deployed to the SaaS environment. Most of the available alerts are based on [performance metrics,](modules/get-started-with-saas/manage-saas-deployments#performance-metrics) such as application responses, server errors or CPU/memory/DTU utilization.
The system currently provides the following types of alerts:
Alert type |  Severity |  Alert conditions  
---|---|---  
Application response |  Critical |  The application was not responding to web requests for over **15 minutes**. “Not responding” means that the value of the _Application response_ [metric](modules/get-started-with-saas/manage-saas-deployments#performance-metrics) is 0%.  
...
Whenever an [alert](modules/get-started-with-saas/manage-saas-deployments#alerts) is fired, the system sends a notification email to all Xperience Portal users assigned to the related project.
...
USE ONLY NECESSARY 
![](https://docs.kentico.com/modules/get-started-with-saas/manage-saas-deployments)
[](https://docs.kentico.com/modules/get-started-with-saas/manage-saas-deployments)[](https://docs.kentico.com/modules/get-started-with-saas/manage-saas-deployments)