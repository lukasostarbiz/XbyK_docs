# Work with roles
  * [ Copy page link ](modules/user-management-essentials/work-with-roles-essentials#) | [Get HelpService ID](modules/user-management-essentials/work-with-roles-essentials#)
Core MVC 5


[✖](modules/user-management-essentials/work-with-roles-essentials# "Close page link panel") [Copy to clipboard](modules/user-management-essentials/work-with-roles-essentials#)
...
A group of users will do the same work in your application. You want to create a role and define which applications these users will have access to - and what actions they can perform. Start by setting up your user roles.
  ...
  4. Go to the **Assigned users** tab and select the existing users you want to add to this role.
    1. To add an entirely new user, you’ll need to switch to the **Users** application. See below how you can [add a new user](modules/user-management-essentials/work-with-users-essentials) to your system.
  5. **Save** the changes.
...
[ Previous page ](modules/user-management-essentials)
2 of 4
[ Mark complete and continue ](modules/user-management-essentials/work-with-users-essentials)
...
USE ONLY NECESSARY 
![](https://docs.kentico.com/modules/user-management-essentials/work-with-roles-essentials)
[](https://docs.kentico.com/modules/user-management-essentials/work-with-roles-essentials)[](https://docs.kentico.com/modules/user-management-essentials/work-with-roles-essentials)