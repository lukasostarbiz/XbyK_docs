# Add a custom field to the Contact profile
  * [ Copy page link ](modules/activities-and-contacts/add-custom-contact-field#) | [Get HelpService ID](modules/activities-and-contacts/add-custom-contact-field#)
Core MVC 5


[✖](modules/activities-and-contacts/add-custom-contact-field# "Close page link panel") [Copy to clipboard](modules/activities-and-contacts/add-custom-contact-field#)
...
This helps with clarity and the identification of custom fields, both in code and administration. For example, when creating a [new UI form](modules/activities-and-contacts/add-custom-contact-field#define-your-ui-form), Xperience orders them alphabetically.
...
[ Previous page ](modules/activities-and-contacts/implement-cross-site-activities)
8 of 9
[ Mark complete and continue ](modules/activities-and-contacts/activities-and-contacts-learn-more)
...
USE ONLY NECESSARY 
![](https://docs.kentico.com/modules/activities-and-contacts/add-custom-contact-field)
[](https://docs.kentico.com/modules/activities-and-contacts/add-custom-contact-field)[](https://docs.kentico.com/modules/activities-and-contacts/add-custom-contact-field)