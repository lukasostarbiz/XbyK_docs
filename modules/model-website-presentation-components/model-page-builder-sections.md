# Model Page Builder sections
  * [ Copy page link ](modules/model-website-presentation-components/model-page-builder-sections#) | [Get HelpService ID](modules/model-website-presentation-components/model-page-builder-sections#)
Core MVC 5


[✖](modules/model-website-presentation-components/model-page-builder-sections# "Close page link panel") [Copy to clipboard](modules/model-website-presentation-components/model-page-builder-sections#)
...
USE ONLY NECESSARY 
![](https://docs.kentico.com/modules/model-website-presentation-components/model-page-builder-sections)
[](https://docs.kentico.com/modules/model-website-presentation-components/model-page-builder-sections)[](https://docs.kentico.com/modules/model-website-presentation-components/model-page-builder-sections)