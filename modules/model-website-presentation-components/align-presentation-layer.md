# Connect content and presentation
  * [ Copy page link ](modules/model-website-presentation-components/align-presentation-layer#) | [Get HelpService ID](modules/model-website-presentation-components/align-presentation-layer#)
Core MVC 5


[✖](modules/model-website-presentation-components/align-presentation-layer# "Close page link panel") [Copy to clipboard](modules/model-website-presentation-components/align-presentation-layer#)
...
[ Previous page ](modules/model-website-presentation-components)
2 of 11
[ Mark complete and continue ](modules/model-website-presentation-components/define-presentation-components-overview)
...
USE ONLY NECESSARY 
![](https://docs.kentico.com/modules/model-website-presentation-components/align-presentation-layer)
[](https://docs.kentico.com/modules/model-website-presentation-components/align-presentation-layer)[](https://docs.kentico.com/modules/model-website-presentation-components/align-presentation-layer)