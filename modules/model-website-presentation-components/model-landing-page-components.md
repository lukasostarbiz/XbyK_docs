# Model landing page components
  * [ Copy page link ](modules/model-website-presentation-components/model-landing-page-components#) | [Get HelpService ID](modules/model-website-presentation-components/model-landing-page-components#)
Core MVC 5


[✖](modules/model-website-presentation-components/model-landing-page-components# "Close page link panel") [Copy to clipboard](modules/model-website-presentation-components/model-landing-page-components#)
...
In this guide, we’re exploring some important widgets for landing page design. This guide doesn’t cover in-depth elements discussed in other guides, such as Hero banners, Product or Article widgets, or widgets that list product benefits which were discussed in the [previous article](modules/model-website-presentation-components/what-are-page-builder-widgets).
You’ll learn about:
...
[![Image widget properties](docsassets/guides/model-landing-page-components/image-widget-properties.jpg)](https://docs.kentico.com/docsassets/guides/model-landing-page-components/image-widget-properties.jpg)
...
[![CTA widget properties](docsassets/guides/model-landing-page-components/cta-widget-properties.jpg)](https://docs.kentico.com/docsassets/guides/model-landing-page-components/cta-widget-properties.jpg)
...
[![Default Xperience Form widget properties](docsassets/guides/model-landing-page-components/default-form-widget-properties.jpg)](https://docs.kentico.com/docsassets/guides/model-landing-page-components/default-form-widget-properties.jpg)
...
[![Example of a content stored in the Rich text](docsassets/guides/model-landing-page-components/cm-guide-rich-text-example.png)](https://docs.kentico.com/docsassets/guides/model-landing-page-components/cm-guide-rich-text-example.png)
[![The same content from the database perspective](docsassets/guides/model-landing-page-components/cm-guide-rich-text-breakdown.png)](https://docs.kentico.com/docsassets/guides/model-landing-page-components/cm-guide-rich-text-breakdown.png)
Rich text widget saves data into one database cell.
[![Featured content widget properties](docsassets/guides/model-landing-page-components/featured-content-widget.jpg)](https://docs.kentico.com/docsassets/guides/model-landing-page-components/featured-content-widget.jpg)
...
[![Properties of FAQ widget](docsassets/guides/model-landing-page-components/faq-widget.jpg)](https://docs.kentico.com/docsassets/guides/model-landing-page-components/faq-widget.jpg)
## Sections
...
[![Kbank demo site’s Form section properties](docsassets/guides/model-landing-page-components/kbank-form-section-limited-properties.jpg)](https://docs.kentico.com/docsassets/guides/model-landing-page-components/kbank-form-section-limited-properties.jpg)
...
Find out more about how you can approach sections in the article about [modeling website sections](modules/model-website-presentation-components/model-page-builder-sections).
## Templates
...
[ Previous page ](modules/model-website-presentation-components/widget-personalization)
10 of 11
[ Mark complete and continue ](modules/model-website-presentation-components/continue-learning)
...
USE ONLY NECESSARY 
![](https://docs.kentico.com/modules/model-website-presentation-components/model-landing-page-components)
[](https://docs.kentico.com/modules/model-website-presentation-components/model-landing-page-components)[](https://docs.kentico.com/modules/model-website-presentation-components/model-landing-page-components)