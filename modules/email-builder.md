# Email Builder overview
  * [ Copy page link ](modules/email-builder#) | [Get HelpService ID](modules/email-builder#)
Core MVC 5


[✖](modules/email-builder# "Close page link panel") [Copy to clipboard](modules/email-builder#)
...
USE ONLY NECESSARY 
![](https://docs.kentico.com/modules/email-builder)
[](https://docs.kentico.com/modules/email-builder)[](https://docs.kentico.com/modules/email-builder)