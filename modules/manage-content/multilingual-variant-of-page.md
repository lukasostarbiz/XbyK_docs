---
source: https://docs.kentico.com/modules/manage-content/multilingual-variant-of-page
...
In the previous article, you’ve read about [setting up multilingual on Kbank](/modules/manage-content/setting-up-multilingual-on-kbank). Now, you can start translating the pages as needed.
...
[![Status of translated pages in the content tree](/docsassets/guides/multilingual-variant-of-page/content-tree-language-variant.png)](/docsassets/guides/multilingual-variant-of-page/content-tree-language-variant.png)
...
[![Adding the SEO fields](/docsassets/guides/multilingual-variant-of-page/seo-language-variant.png)](/docsassets/guides/multilingual-variant-of-page/seo-language-variant.png)
...
[![Open Graph fields](/docsassets/guides/multilingual-variant-of-page/open-graph-fields.png)](/docsassets/guides/multilingual-variant-of-page/open-graph-fields.png)
...
[![Adjusting the URL slug](/docsassets/guides/multilingual-variant-of-page/url-slug-language-variant.png)](/docsassets/guides/multilingual-variant-of-page/url-slug-language-variant.png)
...
[![Validate the translation of different content fields.](/docsassets/guides/multilingual-variant-of-page/seo-fields-translated-using-aira-translation.png)](/docsassets/guides/multilingual-variant-of-page/seo-fields-translated-using-aira-translation.png)
...
[![Not all fields have to be translated](/docsassets/guides/multilingual-variant-of-page/publish-date.png)](/docsassets/guides/multilingual-variant-of-page/publish-date.png)
...
[![Product content item linked to the newly created page](/docsassets/guides/multilingual-variant-of-page/not-translated-content-item.png)](/docsassets/guides/multilingual-variant-of-page/not-translated-content-item.png)
[ Previous page ](/modules/manage-content/setting-up-multilingual-on-kbank)
13 of 19
[ Mark complete and continue ](/modules/manage-content/create-multilingual-variant-of-product)
![]()
[]()[]()
