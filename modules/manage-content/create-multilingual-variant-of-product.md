# Add a multilingual variant of a product
  * [ Copy page link ](modules/manage-content/create-multilingual-variant-of-product#) | [Get HelpService ID](modules/manage-content/create-multilingual-variant-of-product#)
Core MVC 5


[✖](modules/manage-content/create-multilingual-variant-of-product# "Close page link panel") [Copy to clipboard](modules/manage-content/create-multilingual-variant-of-product#)
Once you’ve created a language variant of a page ([you can check how here](modules/manage-content/multilingual-variant-of-page)), it’s time to convert its content items into the target language. By translating the content, you make sure the user experience is flawless and they don’t see a mixture of languages on one page. When you invest to create proper translations of your content items into languages where you have a market presence, you ensure the pages will perform well on the surface level (what the visitor sees) and the backend (for example, SEO and user accessibility).
...
Before you start working on this guide, make you sure you:
  ...
  * Know what multilingual in Xperience by Kentico means and how it works (you can read about it [in this article](modules/manage-content/multilingual-variant-of-content)).
  * Know how to create a language version of a page (check out the [previous article here](modules/manage-content/multilingual-variant-of-page))
...
[![Not translated content item](docsassets/guides/multilingual-variant-of-product/not-translated-product.png)](https://docs.kentico.com/docsassets/guides/multilingual-variant-of-product/not-translated-product.png)
...
[![Opening the translation dialogue window](docsassets/guides/multilingual-variant-of-product/edit-product.png)](https://docs.kentico.com/docsassets/guides/multilingual-variant-of-product/edit-product.png)
The **Content item name** of the new language variant serves for internal purposes, so use your company naming convention.
[![Creating an internal name for a language variant of a content item](docsassets/guides/multilingual-variant-of-product/name-content-language-variant.png)](https://docs.kentico.com/docsassets/guides/multilingual-variant-of-product/name-content-language-variant.png)
Translate or adjust every text field in the content item.
[![Translating the content item](docsassets/guides/multilingual-variant-of-product/create-content-language-variant.png)](https://docs.kentico.com/docsassets/guides/multilingual-variant-of-product/create-content-language-variant.png)
...
[![Other content items linked to a content item](docsassets/guides/multilingual-variant-of-product/list-of-not-translated-content-items.png)](https://docs.kentico.com/docsassets/guides/multilingual-variant-of-product/list-of-not-translated-content-items.png)
...
[![Content item that was translated and published](docsassets/guides/multilingual-variant-of-product/published-content-item.png)](https://docs.kentico.com/docsassets/guides/multilingual-variant-of-product/published-content-item.png)
...
[![Translating unstructured content](docsassets/guides/multilingual-variant-of-product/translate-page-heading.png)](https://docs.kentico.com/docsassets/guides/multilingual-variant-of-product/translate-page-heading.png)
...
[![Final result of translated unstructured and reusable content](docsassets/guides/multilingual-variant-of-product/translated-content-items.png)](https://docs.kentico.com/docsassets/guides/multilingual-variant-of-product/translated-content-items.png)
...
[![Select a region where the content in specific language is accessible](docsassets/guides/multilingual-variant-of-product/content-regional-availability.png)](https://docs.kentico.com/docsassets/guides/multilingual-variant-of-product/content-regional-availability.png)
## To sum up
...
[ Previous page ](modules/manage-content/multilingual-variant-of-page)
14 of 19
[ Mark complete and continue ](modules/manage-content/create-multilingual-variant-of-product-2)
...
USE ONLY NECESSARY 
![](https://docs.kentico.com/modules/manage-content/create-multilingual-variant-of-product)
[](https://docs.kentico.com/modules/manage-content/create-multilingual-variant-of-product)[](https://docs.kentico.com/modules/manage-content/create-multilingual-variant-of-product)