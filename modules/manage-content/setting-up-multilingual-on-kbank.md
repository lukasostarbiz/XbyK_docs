...
[![Example of newly created language in the Languages application](/docsassets/guides/setting-up-multilingual-on-kbank/language-set-up.png)](/docsassets/guides/setting-up-multilingual-on-kbank/language-set-up.png)
...
[![Remove the language using the bin button](/docsassets/guides/setting-up-multilingual-on-kbank/remove-language.png)](/docsassets/guides/setting-up-multilingual-on-kbank/remove-language.png)
...
[![Xperience shows you if the language you want to delete is a default language](/docsassets/guides/setting-up-multilingual-on-kbank/remove-default-language.png)](/docsassets/guides/setting-up-multilingual-on-kbank/remove-default-language.png)
...
[![See language Seting keys in Kbank](/docsassets/guides/setting-up-multilingual-on-kbank/kbank_custom_language_settings.png)](/docsassets/guides/setting-up-multilingual-on-kbank/kbank_custom_language_settings.png)
[![List of languages in Kbank](/docsassets/guides/setting-up-multilingual-on-kbank/kbank_languages.png)](/docsassets/guides/setting-up-multilingual-on-kbank/kbank_languages.png)
...
## Fallback languages
As mentioned in the [previous guide](/modules/manage-content/multilingual-variant-of-content#what-is-a-fallback-language), fallback language serves as a backup for content not published in the targeted multilingual variant.
...
[![Choose a fallback language in the language settings](/docsassets/guides/setting-up-multilingual-on-kbank/choosing-fallback-language.png)](/docsassets/guides/setting-up-multilingual-on-kbank/choosing-fallback-language.png)
...
[![Remove the fallback language](/docsassets/guides/setting-up-multilingual-on-kbank/removing-fallback-language.png)](/docsassets/guides/setting-up-multilingual-on-kbank/removing-fallback-language.png)
...
[ Previous page ](/modules/manage-content/multilingual-variant-of-content)
12 of 19
[ Mark complete and continue ](/modules/manage-content/multilingual-variant-of-page)
![]()
[]()[]()
