# Enable multilingual content on Kbank
  * [ Copy page link ](modules/manage-content/setting-up-multilingual-on-kbank#) | [Get HelpService ID](modules/manage-content/setting-up-multilingual-on-kbank#)
Core MVC 5


[✖](modules/manage-content/setting-up-multilingual-on-kbank# "Close page link panel") [Copy to clipboard](modules/manage-content/setting-up-multilingual-on-kbank#)
...
USE ONLY NECESSARY 
![](https://docs.kentico.com/modules/manage-content/setting-up-multilingual-on-kbank)
[](https://docs.kentico.com/modules/manage-content/setting-up-multilingual-on-kbank)[](https://docs.kentico.com/modules/manage-content/setting-up-multilingual-on-kbank)