# Deploy to a new environment
  * [ Copy page link ](modules/xperience-implementation-handbook/deploy-to-a-new-environment#) | [Get HelpService ID](modules/xperience-implementation-handbook/deploy-to-a-new-environment#)
Core MVC 5


[✖](modules/xperience-implementation-handbook/deploy-to-a-new-environment# "Close page link panel") [Copy to clipboard](modules/xperience-implementation-handbook/deploy-to-a-new-environment#)
## Deploying
...
USE ONLY NECESSARY 
![](https://docs.kentico.com/modules/xperience-implementation-handbook/deploy-to-a-new-environment)
[](https://docs.kentico.com/modules/xperience-implementation-handbook/deploy-to-a-new-environment)[](https://docs.kentico.com/modules/xperience-implementation-handbook/deploy-to-a-new-environment)