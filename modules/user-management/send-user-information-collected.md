# Send customer information about their data (Right to access)
  * [ Copy page link ](modules/user-management/send-user-information-collected#) | [Get HelpService ID](modules/user-management/send-user-information-collected#)
Core MVC 5


[✖](modules/user-management/send-user-information-collected# "Close page link panel") [Copy to clipboard](modules/user-management/send-user-information-collected#)
...
[ Previous page ](modules/user-management/find-data-xperience-collected-about-contact)
18 of 20
[ Mark complete and continue ](modules/user-management/delete-contact-data)
...
USE ONLY NECESSARY 
![](https://docs.kentico.com/modules/user-management/send-user-information-collected)
[](https://docs.kentico.com/modules/user-management/send-user-information-collected)[](https://docs.kentico.com/modules/user-management/send-user-information-collected)