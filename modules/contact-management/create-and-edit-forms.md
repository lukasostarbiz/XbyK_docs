# Create and edit forms
  * [ Copy page link ](modules/contact-management/create-and-edit-forms#) | [Get HelpService ID](modules/contact-management/create-and-edit-forms#)
Core MVC 5


[✖](modules/contact-management/create-and-edit-forms# "Close page link panel") [Copy to clipboard](modules/contact-management/create-and-edit-forms#)
...
Using Form Builder, editors can:
  * [Set form layout](modules/contact-management/create-and-edit-forms#set-form-layout)
  * [Add fields](modules/contact-management/create-and-edit-forms#add-fields)
  * [Move and reorder fields](modules/contact-management/create-and-edit-forms#move-and-reorder-fields)
  * [Delete fields](modules/contact-management/create-and-edit-forms#delete-fields)
  * [Set the submit button text](modules/contact-management/create-and-edit-forms#set-the-submit-button-text)
...
## Set form layout
The layout of a form is composed of sections. Each section contains one or more zones to which you can [add fields](modules/contact-management/create-and-edit-forms#add-fields).
...
Changes made to sections are saved automatically. After creating the required form layout through sections, you can [move fields](modules/contact-management/create-and-edit-forms#move-and-reorder-fields) between the resulting zones.
## Add fields
Select the purple  _plus_ buttons in the form editing area to add new fields. The **Fields** dialog opens, which allows you to add fields from two categories:
  * **Featured** – offers fields frequently included in forms, preconfigured for easy and quick use. Many featured fields automatically map the submitted information to the [contact](modules/contact-management/contact-management) representing the visitor in the system (for visitors who give [consent](documentation/developers-and-admins/data-protection/consent-management)). See the [contact attribute mapping](modules/contact-management/create-and-edit-forms#Createandeditforms-ContactMapping) section for more details.
  * **New field** – allows editors to select a basic field type and configure the field from scratch. Information collected by these fields is not automatically used by the system (unless [configured otherwise](modules/contact-management/create-and-edit-forms#Createandeditforms-ContactMapping)), but can be [accessed in the form’s submissions](modules/contact-management/manage-form-submissions).
...
See [Field properties](modules/contact-management/create-and-edit-forms#field-properties) for details.
...
The system skips the evaluation of validation rules for form fields that are submitted with an unfilled value. If you wish to enforce user input for a particular field, mark it as **Required** in the field’s [properties dialog](modules/contact-management/create-and-edit-forms#field-properties).
...
Mapping links a form field to a specific contact attribute. You control how form fields are mapped via the **Mapped to contact attribute** [field property](modules/contact-management/create-and-edit-forms#field-properties).
...
Certain _featured_ fields are preconfigured to map to the corresponding contact attribute (e.g., First name, Last name, Email). The mapping can be changed. You can view and modify the field’s configuration using the [properties dialog](modules/contact-management/create-and-edit-forms#field-properties).
...
USE ONLY NECESSARY 
![](https://docs.kentico.com/modules/contact-management/create-and-edit-forms)
[](https://docs.kentico.com/modules/contact-management/create-and-edit-forms)[](https://docs.kentico.com/modules/contact-management/create-and-edit-forms)