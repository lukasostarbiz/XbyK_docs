# Contacts in Xperience
  * [ Copy page link ](modules/contact-management/contact-configuration#) | [Get HelpService ID](modules/contact-management/contact-configuration#)
Core MVC 5


[✖](modules/contact-management/contact-configuration# "Close page link panel") [Copy to clipboard](modules/contact-management/contact-configuration#)
[Contacts](modules/contact-management/contact-management) in Xperience by Kentico represent people who view and interact with content through channels, e.g., visitors of a website. Each contact stores the visitor’s personal data and other marketing-related information.
...
The collected [contact data](modules/contact-management/contact-management) allows marketers to analyze client behavior, optimize content, identify potential buyers, and perform other marketing‑related actions.
...
[ Previous page ](modules/contact-management)
2 of 44
[ Mark complete and continue ](modules/contact-management/contact-management)
...
USE ONLY NECESSARY 
![](https://docs.kentico.com/modules/contact-management/contact-configuration)
[](https://docs.kentico.com/modules/contact-management/contact-configuration)[](https://docs.kentico.com/modules/contact-management/contact-configuration)