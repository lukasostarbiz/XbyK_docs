...
[![Set smart fields](/docsassets/documentation/use-smart-fields-in-forms/FormBuilder_SetAsSmart.png)](/docsassets/documentation/use-smart-fields-in-forms/FormBuilder_SetAsSmart.png)
  5. Make sure your fields are organized and ordered in a way that makes sense for a smart form:
     ...
     * Avoid fields that only make sense when viewed together with another field. For this reason, [visibility conditions](/modules/contact-management/create-and-edit-forms#field-visibility) may work inconsistently, since you cannot fully control which smart fields are displayed together.
...
**Notes**
  ...
  * [Visibility conditions](/modules/contact-management/create-and-edit-forms#field-visibility) have limited functionality in forms with smart fields: 
