# Work with Contact management application
  * [ Copy page link ](modules/contact-management/contact-management#) | [Get HelpService ID](modules/contact-management/contact-management#)
Core MVC 5


[✖](modules/contact-management/contact-management# "Close page link panel") [Copy to clipboard](modules/contact-management/contact-management#)
...
If the contact associated with a user already has an email address stored in Xperience, and it doesn’t match the newly submitted email value, all related activities and field updates are performed for a different contact. Either an existing contact that matches the submitted email value is used, or a new contact is created. In these cases, the user’s associated contact remains unchanged, but any subsequent actions, such as [automation processes](modules/contact-management/analyze-and-customize-automation), are performed for the “other” contact that matches the submitted email address.
[ Previous page ](modules/contact-management/contact-configuration)
3 of 44
[ Mark complete and continue ](modules/contact-management/find-a-specific-contact)
...
USE ONLY NECESSARY 
![](https://docs.kentico.com/modules/contact-management/contact-management)
[](https://docs.kentico.com/modules/contact-management/contact-management)[](https://docs.kentico.com/modules/contact-management/contact-management)