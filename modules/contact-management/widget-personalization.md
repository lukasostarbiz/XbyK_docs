# Personalize Page Builder widgets
  * [ Copy page link ](modules/contact-management/widget-personalization#) | [Get HelpService ID](modules/contact-management/widget-personalization#)
Core MVC 5


[✖](modules/contact-management/widget-personalization# "Close page link panel") [Copy to clipboard](modules/contact-management/widget-personalization#)
...
USE ONLY NECESSARY 
![](https://docs.kentico.com/modules/contact-management/widget-personalization)
[](https://docs.kentico.com/modules/contact-management/widget-personalization)[](https://docs.kentico.com/modules/contact-management/widget-personalization)