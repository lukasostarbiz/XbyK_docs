# Understand working with assets in Content hub
  * [ Copy page link ](modules/work-with-assets/understand-working-with-assets#) | [Get HelpService ID](modules/work-with-assets/understand-working-with-assets#)
Core MVC 5


[✖](modules/work-with-assets/understand-working-with-assets# "Close page link panel") [Copy to clipboard](modules/work-with-assets/understand-working-with-assets#)
...
[ Previous page ](modules/work-with-assets)
2 of 21
[ Mark complete and continue ](modules/work-with-assets/work-with-content-folders)
...
USE ONLY NECESSARY 
![](https://docs.kentico.com/modules/work-with-assets/understand-working-with-assets)
[](https://docs.kentico.com/modules/work-with-assets/understand-working-with-assets)[](https://docs.kentico.com/modules/work-with-assets/understand-working-with-assets)