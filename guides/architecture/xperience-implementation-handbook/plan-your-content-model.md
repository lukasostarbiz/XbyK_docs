# Plan your content model
  * Concept| [ Copy page link ](guides/architecture/xperience-implementation-handbook/plan-your-content-model#) | [Get HelpService ID](guides/architecture/xperience-implementation-handbook/plan-your-content-model#) | This page is part of a module: [ Xperience implementation handbook ](modules/xperience-implementation-handbook)
Core MVC 5


[✖](guides/architecture/xperience-implementation-handbook/plan-your-content-model# "Close page link panel") [Copy to clipboard](guides/architecture/xperience-implementation-handbook/plan-your-content-model#)
...
Before extending Xperience by Kentico’s built-in functionality you need to take the following steps:
  1. Make sure that you’ve checked the [resources mentioned earlier](guides/architecture/xperience-implementation-handbook/plan-your-content-model#get-familiar-with-built-in-functionality) for other features that might accomplish what you need to do. This way, you can avoid “reinventing the wheel” and solving an already-solved problem.
...
## What’s next?
Our [next guide](guides/architecture/xperience-implementation-handbook/develop-your-project) outlines common approaches to development in Xperience by Kentico and important topics to think about before setting up your development processes.
If you haven’t already, we highly encourage you to read the whole [Content modeling guide](guides/architecture/content-modeling/content-modeling-guide). After you familiarize yourself with the principles, consider also going through the [related how-to guides](guides/architecture/content-modeling) to get some hands-on experience. It is essential to have a quality content model before your team begins any implementation phase.