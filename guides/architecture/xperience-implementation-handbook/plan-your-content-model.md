---
source: https://docs.kentico.com/guides/architecture/xperience-implementation-handbook/plan-your-content-model
...
Before extending Xperience by Kentico’s built-in functionality you need to take the following steps:
  1. Make sure that you’ve checked the [resources mentioned earlier](#get-familiar-with-built-in-functionality) for other features that might accomplish what you need to do. This way, you can avoid “reinventing the wheel” and solving an already-solved problem.
