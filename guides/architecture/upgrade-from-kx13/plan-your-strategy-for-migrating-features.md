# Plan your strategy for migrating features
  * Concept| [ Copy page link ](guides/architecture/upgrade-from-kx13/plan-your-strategy-for-migrating-features#) | [Get HelpService ID](guides/architecture/upgrade-from-kx13/plan-your-strategy-for-migrating-features#) | This page is part of a module: [ Upgrading to Xperience by Kentico - Overview ](modules/upgrade-overview)
Core MVC 5


[✖](guides/architecture/upgrade-from-kx13/plan-your-strategy-for-migrating-features# "Close page link panel") [Copy to clipboard](guides/architecture/upgrade-from-kx13/plan-your-strategy-for-migrating-features#)
...
HIGH At the moment, these features are not available in XbyK. For deterministic segmentation you can utilize [contact groups](guides/architecture/upgrade-from-kx13/plan-your-strategy-for-migrating-features#contact-groups). If there is a requirement for advanced segmentation or personas and lead scoring as you knew them from KX13, your developer team needs to build a custom implementation. If this is not an immediate need, we recommend to wait and follow our [XbyK roadmap](https://roadmap.kentico.com/tabs/4-planned).
### Social Marketing
**XbyK feature:** Roadmap
