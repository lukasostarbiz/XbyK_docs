# Upgrade overview
  * Concept| [ Copy page link ](guides/architecture/upgrade-from-kx13/upgrade-from-kx13-overview#) | [Get HelpService ID](guides/architecture/upgrade-from-kx13/upgrade-from-kx13-overview#) | This page is part of a module: [ Upgrading to Xperience by Kentico - Overview ](modules/upgrade-overview)
Core MVC 5


[✖](guides/architecture/upgrade-from-kx13/upgrade-from-kx13-overview# "Close page link panel") [Copy to clipboard](guides/architecture/upgrade-from-kx13/upgrade-from-kx13-overview#)
...
Let’s take a look at the process together. There are four main parts to consider:
  1. [Set up your environment](guides/architecture/upgrade-from-kx13/upgrade-from-kx13-overview#set-up-your-environment) and configure the migration tool
  2. [Migrate your data](guides/architecture/upgrade-from-kx13/upgrade-from-kx13-overview#migrate-your-data) and binary files using the migration tool
  3. [Adjust your code](guides/architecture/upgrade-from-kx13/upgrade-from-kx13-overview#adjust-your-code) and any custom artifacts not covered by the migration tool
  4. [Think about the future](guides/architecture/upgrade-from-kx13/upgrade-from-kx13-overview#think-about-the-future) and explore the full potential of Xperience by Kentico


[![Diagram of the upgrade process](docsassets/guides/upgrade-from-kx13-overview/Upgrade-diagram.jpg)](https://docs.kentico.com/docsassets/guides/upgrade-from-kx13-overview/Upgrade-diagram.jpg)
...
If you use Page Builder in your Kentico Xperience 13 instance, consider paying special attention to the section about [Source instance API discovery](https://github.com/Kentico/xperience-by-kentico-kentico-migration-tool/blob/master/Migration.Tool.CLI/README.md#source-instance-api-discovery). By adding a special endpoint to your current live site, you can enable the tool to convert your Page Builder data to a format that uses Xperience by Kentico’s new [UI form components](developers-and-admins/customization/extend-the-administration-interface/ui-form-components/reference-admin-ui-form-components).
## Adjust your code
...
However, we do offer pathways to help your team handle these potential challenges. Learn more in our [Plan your strategy for migrating features](guides/architecture/upgrade-from-kx13/plan-your-strategy-for-migrating-features) guide.
...
## What’s next?
The next guides in this series will dive into a bit more detail about each of the points highlighted in this overview. They will cover [high-level looks at analogous features](guides/architecture/upgrade-from-kx13/plan-your-strategy-for-migrating-features) between platforms, [preparation and data migration](guides/architecture/upgrade-from-kx13/prep-for-upgrade-and-transfer-data), and [code conversion and new features](guides/architecture/upgrade-from-kx13/adjust-your-code-and-adapt).
...
Visit our [FAQ page](guides/architecture/upgrade-from-kx13/upgrade-faq) for answers to frequently asked questions about the upgrade, migration tool or deployment considerations for upgraded projects.