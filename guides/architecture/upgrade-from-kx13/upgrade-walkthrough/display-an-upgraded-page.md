# Display an upgraded page with structured data and Page Builder functionality
  * How-to| [ Copy page link ](guides/architecture/upgrade-from-kx13/upgrade-walkthrough/display-an-upgraded-page#) | [Get HelpService ID](guides/architecture/upgrade-from-kx13/upgrade-walkthrough/display-an-upgraded-page#) | This page is part of a module: [ Upgrading to Xperience by Kentico - Walkthrough ](modules/upgrade-walkthrough)
Core MVC 5


[✖](guides/architecture/upgrade-from-kx13/upgrade-walkthrough/display-an-upgraded-page# "Close page link panel") [Copy to clipboard](guides/architecture/upgrade-from-kx13/upgrade-walkthrough/display-an-upgraded-page#)
...
You’re almost done. See [what else](guides/architecture/upgrade-from-kx13/upgrade-walkthrough/next-steps) can you learn about Xperience by Kentico.