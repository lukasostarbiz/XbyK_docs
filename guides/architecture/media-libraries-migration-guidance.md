# Media library migration
  * [ Copy page link ](guides/architecture/media-libraries-migration-guidance#) | [Get HelpService ID](guides/architecture/media-libraries-migration-guidance#)
Core MVC 5


[✖](guides/architecture/media-libraries-migration-guidance# "Close page link panel") [Copy to clipboard](guides/architecture/media-libraries-migration-guidance#)
...
The full migration involves the following high-level steps:
  1. [Migrate media library files to Content hub](guides/architecture/media-libraries-migration-guidance#migrate-media-library-files-to-content-hub)
  2. [Create a database backup](guides/architecture/media-libraries-migration-guidance#create-a-database-backup)
  3. [Set up your development environment](guides/architecture/media-libraries-migration-guidance#set-up-your-development-environment)
  4. [Migrate fields referencing media files](guides/architecture/media-libraries-migration-guidance#migrate-fields-referencing-media-library-files)
  5. [Migrate codebase](guides/architecture/media-libraries-migration-guidance#migrate-codebase)
  6. [Deploy](guides/architecture/media-libraries-migration-guidance#deploy)
  7. [Delete media libraries](guides/architecture/media-libraries-migration-guidance#delete-media-libraries)


[![Migration overview](docsassets/guides/media-libraries-migration-guidance/migration_overview.png)](https://docs.kentico.com/docsassets/guides/media-libraries-migration-guidance/migration_overview.png)
...
[![Migrate media libraries to Content hub](docsassets/guides/media-libraries-migration-guidance/migrate_media_libraries.png)](https://docs.kentico.com/docsassets/guides/media-libraries-migration-guidance/migrate_media_libraries.png)
...
[![Example migrated media libraries to Content hub](docsassets/guides/media-libraries-migration-guidance/migrated_media_libraries.png)](https://docs.kentico.com/docsassets/guides/media-libraries-migration-guidance/migrated_media_libraries.png)
...
Restore your local (or other development) environment’s database using the [database backup](guides/architecture/media-libraries-migration-guidance#create-a-database-backup) created in the previous step to replicate the target environment’s database in your local environment. You’ll use this local environment to carry out the upcoming migration steps safely before [deploying](guides/architecture/media-libraries-migration-guidance#deploy) your changes back to the target environment.
...
The migration CLI script migrates database definitions of fields, including their data, which reference media files. This means that fields that referenced media files are changed to reference content items on the database level. The [codebase migration](guides/architecture/media-libraries-migration-guidance#migrate-codebase) is done separately.
