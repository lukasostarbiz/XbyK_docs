# Model website navigation
  * How-to| [ Copy page link ](guides/architecture/content-modeling/model-website-content-types/model-website-navigation#) | [Get HelpService ID](guides/architecture/content-modeling/model-website-content-types/model-website-navigation#)
Core MVC 5


[✖](guides/architecture/content-modeling/model-website-content-types/model-website-navigation# "Close page link panel") [Copy to clipboard](guides/architecture/content-modeling/model-website-content-types/model-website-navigation#)
...
During the content audit and project shaping to deliver the [scenario above](guides/architecture/content-modeling/model-website-content-types/model-website-navigation#guideScenario), your team identified the following criteria:
...
[![Simple navigation on the Kbank demo site](docsassets/guides/model-website-navigation/kbank-sample-navigation.png)](https://docs.kentico.com/docsassets/guides/model-website-navigation/kbank-sample-navigation.png)
  * Side menus can nest up to three levels.
  * Some of the parent navigation items will contain a hyperlink.  
[![Conceptual draft of navigation structure with that contains several menu items without a link](docsassets/guides/model-website-navigation/hierarchy-structure-concept-with-links.png)](https://docs.kentico.com/docsassets/guides/model-website-navigation/hierarchy-structure-concept-with-links.png)
...
#### Challenges of defining navigation in the content tree
  ...
  * Overloading the content tree: Adding navigation items to the content tree introduces “visual clutter,” as these items are non-navigable URLs. Editors can feel confused since these items don’t align with the rest of the content tree where each page represents a navigable URL. It also [limits the number of navigable pages](guides/architecture/content-modeling/model-website-content-types/model-website-navigation#microchannelItems) that editors can create in a microchannel.
...
[![Navigation items in the Content hub](docsassets/guides/model-website-navigation/cm-model-navigation-items-in-content-hub.png)](https://docs.kentico.com/docsassets/guides/model-website-navigation/cm-model-navigation-items-in-content-hub.png)
...
[![Draft of a microchannel settings content type](docsassets/guides/model-website-navigation/cm-example-microchannel-settings-draft.png)](https://docs.kentico.com/docsassets/guides/model-website-navigation/cm-example-microchannel-settings-draft.png)
...
[![Example of a Global call to action content type](docsassets/guides/model-website-navigation/cm-global-cta-reusable-item.png)](https://docs.kentico.com/docsassets/guides/model-website-navigation/cm-global-cta-reusable-item.png)
...
Let’s continue with the [scenario](guides/architecture/content-modeling/model-website-content-types/model-website-navigation#guideScenario).
...
[![Simplified diagram of navigation in the content tree](docsassets/guides/model-website-navigation/cm-navigation-content-tree-sketch.png)](https://docs.kentico.com/docsassets/guides/model-website-navigation/cm-navigation-content-tree-sketch.png)
...
[![Simplified diagram of navigation in the channel settings](docsassets/guides/model-website-navigation/cm-microchannel-settings-sketch.png)](https://docs.kentico.com/docsassets/guides/model-website-navigation/cm-microchannel-settings-sketch.png)
...
[![Conceptual graph of a navigation content type](docsassets/guides/model-website-navigation/navigation-simple-sketch.png)](https://docs.kentico.com/docsassets/guides/model-website-navigation/navigation-simple-sketch.png)
...
[![Content model description in Excel with content type’s fields and instructions](docsassets/guides/model-website-navigation/excel_list_of_contenttypefields.png)](https://docs.kentico.com/docsassets/guides/model-website-navigation/excel_list_of_contenttypefields.png)
...
[![Diagrams shows the flow how editors will be creating the website’s navigation menu](docsassets/guides/model-website-navigation/flow-of-creating-navigation.png)](https://docs.kentico.com/docsassets/guides/model-website-navigation/flow-of-creating-navigation.png)
...
[![Navigation menu content types in the Kbank demo website](docsassets/guides/model-website-navigation/nav_item_content_type.png)](https://docs.kentico.com/docsassets/guides/model-website-navigation/nav_item_content_type.png)
...
[![Kbank microchannel navigation settings](docsassets/guides/model-website-navigation/cm-microchannel-navigation-example.png)](https://docs.kentico.com/docsassets/guides/model-website-navigation/cm-microchannel-navigation-example.png)
...
[![Navigation menu structure modeled in the website channel’s content tree](docsassets/guides/model-website-navigation/nav_menu_structure_in_content_tree.png)](https://docs.kentico.com/docsassets/guides/model-website-navigation/nav_menu_structure_in_content_tree.png)
...
[![Content model for navigation menu on a standard channel](docsassets/guides/model-website-navigation/nav-menu-items-content-model.png)](https://docs.kentico.com/docsassets/guides/model-website-navigation/nav-menu-items-content-model.png)
[![Content model for navigation menu on a website microchannel](docsassets/guides/model-website-navigation/cm-microchannel-settings.png)](https://docs.kentico.com/docsassets/guides/model-website-navigation/cm-microchannel-settings.png)
...
[![Content model for website navigation in an Excel spreadsheet](docsassets/guides/model-website-navigation/final-excel-navigation-item-content-types.png)](https://docs.kentico.com/docsassets/guides/model-website-navigation/final-excel-navigation-item-content-types.png)
...
[![Example of a navigation menu structure in the Kbank demo site](docsassets/guides/model-website-navigation/nav-menu-kbank-example.png)](https://docs.kentico.com/docsassets/guides/model-website-navigation/nav-menu-kbank-example.png)