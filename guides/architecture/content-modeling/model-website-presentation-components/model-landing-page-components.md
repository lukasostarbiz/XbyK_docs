# Model landing page components
  * How-to| [ Copy page link ](guides/architecture/content-modeling/model-website-presentation-components/model-landing-page-components#) | [Get HelpService ID](guides/architecture/content-modeling/model-website-presentation-components/model-landing-page-components#) | This page is part of a module: [ Model website presentation components ](modules/model-website-presentation-components)
Core MVC 5


[✖](guides/architecture/content-modeling/model-website-presentation-components/model-landing-page-components# "Close page link panel") [Copy to clipboard](guides/architecture/content-modeling/model-website-presentation-components/model-landing-page-components#)
