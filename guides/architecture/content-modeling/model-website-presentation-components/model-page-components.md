# Model page components
  * How-to| [ Copy page link ](guides/architecture/content-modeling/model-website-presentation-components/model-page-components#) | [Get HelpService ID](guides/architecture/content-modeling/model-website-presentation-components/model-page-components#)
Core MVC 5


[✖](guides/architecture/content-modeling/model-website-presentation-components/model-page-components# "Close page link panel") [Copy to clipboard](guides/architecture/content-modeling/model-website-presentation-components/model-page-components#)
