---
source: https://docs.kentico.com/guides/architecture/content-modeling/model-reusable-content/model-a-reusable-product
...
[![Multichannel Xperience by Kentico](/docsassets/guides/model-a-reusable-product/example-multichannel-xperience.png)](/docsassets/guides/model-a-reusable-product/example-multichannel-xperience.png)
...
[![Context-specific messages that talk about the same product](/docsassets/guides/model-a-reusable-product/cm-reusable-product-content-different-messages.png)](/docsassets/guides/model-a-reusable-product/cm-reusable-product-content-different-messages.png)
...
[![The same content item displayed across different channels](/docsassets/guides/model-a-reusable-product/cm-product-content-in-different-channels.png)](/docsassets/guides/model-a-reusable-product/cm-product-content-in-different-channels.png)
...
[![Simple graph of Product content type](/docsassets/guides/model-a-reusable-product/cm-product-content-type-sketch.png)](/docsassets/guides/model-a-reusable-product/cm-product-content-type-sketch.png)
...
[![Editing product content item in Xperience](/docsassets/guides/model-a-reusable-product/editing-product-content-item-in-xperience.png)](/docsassets/guides/model-a-reusable-product/editing-product-content-item-in-xperience.png)
...
[![Kbank call to action element with reusable image content type](/docsassets/guides/model-a-reusable-product/kbank-call-to-action-button-with-image.png)](/docsassets/guides/model-a-reusable-product/kbank-call-to-action-button-with-image.png)
**Hero banner of a landing page**
[![Kbank banner with reusable image content type](/docsassets/guides/model-a-reusable-product/kbank-banner-widget-with-the-same-image.png)](/docsassets/guides/model-a-reusable-product/kbank-banner-widget-with-the-same-image.png)
**Promotional email**
[![Promotional email with reusable image](/docsassets/guides/model-a-reusable-product/kbank-email-card-with-the-same-image.png)](/docsassets/guides/model-a-reusable-product/kbank-email-card-with-the-same-image.png)
...
[![Product content type with reusable Asset content type](/docsassets/guides/model-a-reusable-product/graph-product-fields-with-reusable-asset-content-type.png)](/docsassets/guides/model-a-reusable-product/graph-product-fields-with-reusable-asset-content-type.png)
...
[![Product content type graph showing financial product fields](/docsassets/guides/model-a-reusable-product/graph-product-fields-with-financial-fields.png)](/docsassets/guides/model-a-reusable-product/graph-product-fields-with-financial-fields.png)
...
[![Financial fields built with reusable field schema in Kbank’s product content types](/docsassets/guides/model-a-reusable-product/reusable-field-schemas-financial-fields.png)](/docsassets/guides/model-a-reusable-product/reusable-field-schemas-financial-fields.png)
...
[![Specific fields in different reusable product content types](/docsassets/guides/model-a-reusable-product/cm-product-content-type-specific-fields.png)](/docsassets/guides/model-a-reusable-product/cm-product-content-type-specific-fields.png)
...
[![Product benefits displayed in hero banner widget](/docsassets/guides/model-a-reusable-product/kbank-product-benefits-in-banner-widget.png)](/docsassets/guides/model-a-reusable-product/kbank-product-benefits-in-banner-widget.png)
...
[![Company benefits displayed in a banner widget](/docsassets/guides/model-a-reusable-product/kbank-company-benefits-in-banner-widget.png)](/docsassets/guides/model-a-reusable-product/kbank-company-benefits-in-banner-widget.png)
You can create a Benefit content type to help you communicate product or company benefits.
[![Product content type with linked Benefits content type](/docsassets/guides/model-a-reusable-product/graph-benefits-content-type-as-part-of-product.png)](/docsassets/guides/model-a-reusable-product/graph-benefits-content-type-as-part-of-product.png)
...
[![Product benefits displayed in a mobile app](/docsassets/guides/model-a-reusable-product/kbank-benefits-in-app.png)](/docsassets/guides/model-a-reusable-product/kbank-benefits-in-app.png)
...
[![Product with linked product features in a separate content type](/docsassets/guides/model-a-reusable-product/product-with-linked-features.png)](/docsassets/guides/model-a-reusable-product/product-with-linked-features.png)
...
[![Product features displayed in a table](/docsassets/guides/model-a-reusable-product/product-features-in-tabular-data.png)](/docsassets/guides/model-a-reusable-product/product-features-in-tabular-data.png)
...
[![Product features in product comparator widget](/docsassets/guides/model-a-reusable-product/features-in-product-comparator.png)](/docsassets/guides/model-a-reusable-product/features-in-product-comparator.png)
## Taxonomy
...
[![Taxonomy created with a dedicated content type item](/docsassets/guides/model-a-reusable-product/taxonomy-as-content-type-category-item.png)](/docsassets/guides/model-a-reusable-product/taxonomy-as-content-type-category-item.png)
[![Product with linked content item](/docsassets/guides/model-a-reusable-product/product-with-linked-content-item-as-taxonomy.png)](/docsassets/guides/model-a-reusable-product/product-with-linked-content-item-as-taxonomy.png)
...
[![Product content type in simple graph](/docsassets/guides/model-a-reusable-product/graph-product-content-type-complete.png)](/docsassets/guides/model-a-reusable-product/graph-product-content-type-complete.png)
