# Model a reusable Article
  * How-to| [ Copy page link ](guides/architecture/content-modeling/model-reusable-content/model-a-reusable-article#) | [Get HelpService ID](guides/architecture/content-modeling/model-reusable-content/model-a-reusable-article#)
Core MVC 5


[✖](guides/architecture/content-modeling/model-reusable-content/model-a-reusable-article# "Close page link panel") [Copy to clipboard](guides/architecture/content-modeling/model-reusable-content/model-a-reusable-article#)
...
[![Example of reusing content](docsassets/guides/model-a-reusable-article/cm-examples-reusing-content.png)](https://docs.kentico.com/docsassets/guides/model-a-reusable-article/cm-examples-reusing-content.png)
...
The [list above](guides/architecture/content-modeling/model-reusable-content/model-a-reusable-article#ContentTypeDefinition) shows what properties your editor team expects to work with. That’s the _human part_ of the business working with the _Article_ content type.
...
[![Shows basic reusable article content type with its properties](docsassets/guides/model-a-reusable-article/cm-simplified-data-model-article.png)](https://docs.kentico.com/docsassets/guides/model-a-reusable-article/cm-simplified-data-model-article.png)
### Author
...
[![Simplified Asset content type](docsassets/guides/model-a-reusable-article/cm-simplified-asset-content-type.png)](https://docs.kentico.com/docsassets/guides/model-a-reusable-article/cm-simplified-asset-content-type.png)
...
[![A graphic design for the article on the Kbank demo project.](docsassets/guides/model-a-reusable-article/cm-article-graphic-design.png)](https://docs.kentico.com/docsassets/guides/model-a-reusable-article/cm-article-graphic-design.png)
...
[![A reusable Article from Kbank, with information about data type and UI component for each field.](docsassets/guides/model-a-reusable-article/cm-article-model-properties.png)](https://docs.kentico.com/docsassets/guides/model-a-reusable-article/cm-article-model-properties.png)
...
[![Model of reusable article](docsassets/guides/model-a-reusable-article/cm-article-final-content-type.png)](https://docs.kentico.com/docsassets/guides/model-a-reusable-article/cm-article-final-content-type.png)
...
[![An example of content types in the Content types application](docsassets/guides/model-a-reusable-article/cm-list-of-content-types.png)](https://docs.kentico.com/docsassets/guides/model-a-reusable-article/cm-list-of-content-types.png)
...
[![Definition of content types in Excel, including detailed guidance to help less experienced editors](docsassets/guides/model-a-reusable-article/cm-article-content-type-excel.png)](https://docs.kentico.com/docsassets/guides/model-a-reusable-article/cm-article-content-type-excel.png)
...
[![Revised Article model definition](docsassets/guides/model-a-reusable-article/cm-revised-article-content-type-definition.png)](https://docs.kentico.com/docsassets/guides/model-a-reusable-article/cm-revised-article-content-type-definition.png)
