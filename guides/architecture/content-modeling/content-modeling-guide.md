...
## What is content?
_Content_ is any digital information, blog post, quote, testimonial, case study, interview, product information, or digital asset, such as an image, video recording, or podcast. It can also include interactive elements like quizzes or tools and structured data like product descriptions or metadata. Content is the building block for websites, applications, and digital platforms.
...
Before you dive into a detailed description of content modeling in Xperience, watch a short video in which Mike Wills, [Kentico MVP](https://www.kentico.com/partners/mvp-program) and Technical VP at [Bluemodus](https://bluemodus.com/articles-by-mike-wills), explains what is content modeling and its importance.
...
That’s why it is essential that you think about the following:
  ...
  * Define taxonomies that will help you categorize the content or create personalized variants of content. See how you can [target a segment of your website audience](https://www.youtube.com/watch?v=LiFASTGoaZc&ab_channel=Kentico) with personalized content on your website.
