# Display your website content in multiple languages
  * How-to| [ Copy page link ](guides/development/multilingual/display-your-website-content-in-multiple-languages#) | [Get HelpService ID](guides/development/multilingual/display-your-website-content-in-multiple-languages#)
Core MVC 5


[✖](guides/development/multilingual/display-your-website-content-in-multiple-languages# "Close page link panel") [Copy to clipboard](guides/development/multilingual/display-your-website-content-in-multiple-languages#)
...
[![screen recording gif that demonstrates language switching by URL](docsassets/guides/display-your-website-content-in-multiple-languages/Switch-language-manual.gif)](https://docs.kentico.com/docsassets/guides/display-your-website-content-in-multiple-languages/Switch-language-manual.gif)
...
[![screenshot of cookie consent page](docsassets/guides/display-your-website-content-in-multiple-languages/cookies-consents.png)](https://docs.kentico.com/docsassets/guides/display-your-website-content-in-multiple-languages/cookies-consents.png)
...
[![Default language in Xperience by Kentico](docsassets/guides/display-your-website-content-in-multiple-languages/default-language.png)](https://docs.kentico.com/docsassets/guides/display-your-website-content-in-multiple-languages/default-language.png)
...
By passing in the [preferred language](guides/development/multilingual/display-your-website-content-in-multiple-languages#retrieve-preferred-language), you will get your content item(s) in a language variant consistent with your current context.
...
Localizing consent texts looks very similar to [localizing content items](guides/development/multilingual/display-your-website-content-in-multiple-languages#retrieve-localized-content-items) - you utilize the `IPreferredLanguageRetriever`. Simply pass the **preferred language** to the `GetConsentTextAsync` method as a parameter:
C#
Copy
```
...
If you are showing the _ConsentDisplayName_ to the visitor (e.g., as a consent header), be advised, that _ConsentDisplayName_ does **not** support multiple language versions at this time. We recommend utilizing stringLocalizer and Shared resources in your .Net project to handle this, as you will see in [the next section](guides/development/multilingual/display-your-website-content-in-multiple-languages#translate-other-application-texts).
