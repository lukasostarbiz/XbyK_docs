# Create a reusable content type
  * [ Copy page link ](guides/development/developer-kickstart/create-a-reusable-content-type#) | [Get HelpService ID](guides/development/developer-kickstart/create-a-reusable-content-type#) | This page is part of a module: [ Xperience by Kentico Developer kickstart ](modules/developer-kickstart)
Core MVC 5


[✖](guides/development/developer-kickstart/create-a-reusable-content-type# "Close page link panel") [Copy to clipboard](guides/development/developer-kickstart/create-a-reusable-content-type#)
