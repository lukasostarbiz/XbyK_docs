# Apply a page template
  * [ Copy page link ](guides/development/developer-kickstart/apply-a-page-template#) | [Get HelpService ID](guides/development/developer-kickstart/apply-a-page-template#) | This page is part of a module: [ Xperience by Kentico Developer kickstart ](modules/developer-kickstart)
Core MVC 5


[✖](guides/development/developer-kickstart/apply-a-page-template# "Close page link panel") [Copy to clipboard](guides/development/developer-kickstart/apply-a-page-template#)
...
[![Screenshot of the new page dialog for the home page](docsassets/guides/apply-a-page-template/home-page-create-1.png)](https://docs.kentico.com/docsassets/guides/apply-a-page-template/home-page-create-1.png)
...
[![Root of the website showing the homepage in the browser.](docsassets/guides/apply-a-page-template/home-page-display-1.png)](https://docs.kentico.com/docsassets/guides/apply-a-page-template/home-page-display-1.png)
...
[![Home page in Page Builder mode in Kickstart pages channel](docsassets/guides/apply-a-page-template/home-page-display-2.png)](https://docs.kentico.com/docsassets/guides/apply-a-page-template/home-page-display-2.png)
...
## Continue learning
When you’re ready, move on to the next page: [Create a layout view](guides/development/developer-kickstart/create-a-layout-view)