# Add a custom field to the Contact profile
  * How-to| [ Copy page link ](guides/development/customizations-and-integrations/add-custom-contact-field#) | [Get HelpService ID](guides/development/customizations-and-integrations/add-custom-contact-field#) | This page is part of a module: [ Activities and contacts ](modules/activities-and-contacts)
Core MVC 5


[✖](guides/development/customizations-and-integrations/add-custom-contact-field# "Close page link panel") [Copy to clipboard](guides/development/customizations-and-integrations/add-custom-contact-field#)
...
This helps with clarity and the identification of custom fields, both in code and administration. For example, when creating a [new UI form](guides/development/customizations-and-integrations/add-custom-contact-field#define-your-ui-form), Xperience orders them alphabetically.
