---
source: https://docs.kentico.com/guides/development/customizations-and-integrations/create-basic-module
...
Now if you check the **CMS_Class** table of the database, you’ll see a row representing your new class. [![Select from a CMS_Class table showing the new TrainingGuides.GlobalSettingsKey class](/docsassets/guides/create-basic-module/global-settings-class-in-db.png)](/docsassets/guides/create-basic-module/global-settings-class-in-db.png)
  2. [Specify **Database columns**](/documentation/developers-and-admins/customization/object-types#define-and-model-the-data-class) for the class. Add columns with the following properties:
    ...
    4. A note field, which tells editors how to use the setting and provides additional context 
       ...
       * **Size** : 2000
       * **Required** : True (Enabled)
[![](/docsassets/guides/create-basic-module/global-settings-db-columns.png)](/docsassets/guides/create-basic-module/global-settings-db-columns.png)
...
These settings are important for [code generation](/documentation/developers-and-admins/api/generate-code-files-for-system-objects), which we will discuss [later on](#generate-code-files).
Switch to the **Code** tab to see that your new fields have been automatically mapped:
[![Database columns ‘GlobalSettingsKeyDisplayName’ and ‘GlobalSettingsKeyName’ automatically mapped to ‘Display name column’ and ‘Code name column’ fields in the Code tab](/docsassets/guides/create-basic-module/global-settings-colum-designation.png)](/docsassets/guides/create-basic-module/global-settings-colum-designation.png)
...
[![Global settings key edit form fields](/docsassets/guides/create-basic-module/global-settings-edit-form.png)](/docsassets/guides/create-basic-module/global-settings-edit-form.png)
...
[![Generated Global settings key class](/docsassets/guides/create-basic-module/global-settings-key-generated.png)](/docsassets/guides/create-basic-module/global-settings-key-generated.png)
...
Both create and edit pages for `GlobalSettingsKeyInfo` objects will utilize the `GlobalSettingsKeyEdit` UI form you created [earlier](#add-a-ui-form-for-the-class).
#### Edit page
