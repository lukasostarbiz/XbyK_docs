---
source: https://docs.kentico.com/guides/development/page-builder/meet-requirements-with-page-builder
...
[![Mockup of a promotional page with two products](/docsassets/guides/meet-requirements-with-page-builder/WidgetMockups1.png)](/docsassets/guides/meet-requirements-with-page-builder/WidgetMockups1.png) [![Alternate mockup of a promotional page with two products](/docsassets/guides/meet-requirements-with-page-builder/WidgetMockups2.png)](/docsassets/guides/meet-requirements-with-page-builder/WidgetMockups2.png)
...
[![annotated mockup pointing out relevant components](/docsassets/guides/meet-requirements-with-page-builder/WidgetMockups2annotation1.png)](/docsassets/guides/meet-requirements-with-page-builder/WidgetMockups2annotation1.png)
...
[![annotated mockup pointing out relevant components](/docsassets/guides/meet-requirements-with-page-builder/WidgetMockups1annotation2.png)](/docsassets/guides/meet-requirements-with-page-builder/WidgetMockups1annotation2.png) [![annotated mockup pointing out relevant components](/docsassets/guides/meet-requirements-with-page-builder/WidgetMockups2annotation2.png)](/docsassets/guides/meet-requirements-with-page-builder/WidgetMockups2annotation2.png)
...
[![annotated mockup pointing out relevant components](/docsassets/guides/meet-requirements-with-page-builder/WidgetMockups1annotation3.png)](/docsassets/guides/meet-requirements-with-page-builder/WidgetMockups1annotation3.png) [![annotated mockup pointing out relevant components](/docsassets/guides/meet-requirements-with-page-builder/WidgetMockups2annotation3.png)](/docsassets/guides/meet-requirements-with-page-builder/WidgetMockups2annotation3.png)
...
[![annotated mockup pointing out relevant components](/docsassets/guides/meet-requirements-with-page-builder/WidgetMockups1annotation4.png)](/docsassets/guides/meet-requirements-with-page-builder/WidgetMockups1annotation4.png) [![annotated mockup pointing out relevant components](/docsassets/guides/meet-requirements-with-page-builder/WidgetMockups2annotation4.png)](/docsassets/guides/meet-requirements-with-page-builder/WidgetMockups2annotation4.png)
...
[![Mockup of a product detail page](/docsassets/guides/meet-requirements-with-page-builder/WidgetMockups3.png)](/docsassets/guides/meet-requirements-with-page-builder/WidgetMockups3.png)
...
## What’s next
In your next Xperience project, make sure to consider the factors discussed in this article when leveraging Page Builder for your clients.
The next parts in this series cover the implementation of the templates, sections, and widgets discussed here. We will work towards achieving the look and feel of the mockup designs above, breaking the task into the following building blocks:
  * [Creating a custom dropdown option provider](/guides/development/page-builder/map-enum-to-dropdown)
  * [Building page templates](/guides/development/page-builder/create-versatile-templates-part-1)
  * [Creating Page Builder sections](/guides/development/page-builder/implement-flexible-sections)
  * [Implementing simple Call to action widget](/guides/development/page-builder/build-simple-cta-widget)
  * [Building advanced Product widget](/guides/development/page-builder/define-advanced-widget)
