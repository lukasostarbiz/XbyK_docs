# Implement cross-site activities
  * [ Copy page link ](guides/development/activities-and-marketing/implement-cross-site-activities#) | [Get HelpService ID](guides/development/activities-and-marketing/implement-cross-site-activities#) | This page is part of a module: [ Activities and contacts ](modules/activities-and-contacts)
Core MVC 5


[✖](guides/development/activities-and-marketing/implement-cross-site-activities# "Close page link panel") [Copy to clipboard](guides/development/activities-and-marketing/implement-cross-site-activities#)
...
Xperience tracking scripts that rely on consent need to know the codename of the consent associated with tracking. You need to create a function that retrieves the codename from the controller action defined [earlier](guides/development/activities-and-marketing/implement-cross-site-activities#add-a-controller-to-indicate-the-right-consent). Create a javascript file with a function to retrieve this value to the existing script block.
