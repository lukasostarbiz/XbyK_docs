---
source: https://docs.kentico.com/guides/digital-marketing/work-with-websites/Create-a-new-product-page
...
[![Product with linked reusable content](/docsassets/guides/Create-a-new-product-page/product-benefits-features.png)](/docsassets/guides/Create-a-new-product-page/product-benefits-features.png)
  1. First, create a new page as a subpage to the _Loans page_.


[![Adding a new page to the content tree](/docsassets/guides/Create-a-new-product-page/creating-new-page.png)](/docsassets/guides/Create-a-new-product-page/creating-new-page.png)
...
[![Selecting the Product page type](/docsassets/guides/Create-a-new-product-page/page-type.png)](/docsassets/guides/Create-a-new-product-page/page-type.png)
...
[![Selecting pre-configured page preset](/docsassets/guides/Create-a-new-product-page/page-templates.png)](/docsassets/guides/Create-a-new-product-page/page-templates.png)
...
[![Selecting a reusable product from the Content hub](/docsassets/guides/Create-a-new-product-page/selecting-product.png)](/docsassets/guides/Create-a-new-product-page/selecting-product.png)
...
[![Configuring the widget’s to display data from the linked product](/docsassets/guides/Create-a-new-product-page/hero-banner-properties.png)](/docsassets/guides/Create-a-new-product-page/hero-banner-properties.png)
...
[![Adjusting visual design of the Hero banner widget](/docsassets/guides/Create-a-new-product-page/product-properties.png)](/docsassets/guides/Create-a-new-product-page/product-properties.png)
[![Product widget](/docsassets/guides/Create-a-new-product-page/product-widget.png)](/docsassets/guides/Create-a-new-product-page/product-widget.png)
  1. Finally, fill in the _Page heading_ widget and choose the _Form_.


[![Section that contains Page heading and Form widgets](/docsassets/guides/Create-a-new-product-page/page-heading-and-form.png)](/docsassets/guides/Create-a-new-product-page/page-heading-and-form.png)
...
[![Selecting data from another page in the Hero banner properties](/docsassets/guides/Create-a-new-product-page/hero-banner-properties-add-page.png)](/docsassets/guides/Create-a-new-product-page/hero-banner-properties-add-page.png)
  1. Once you confirm this choice, the _Hero banner_ displays the Personal loan product.


[![Configured Hero banner widget](/docsassets/guides/Create-a-new-product-page/herro-banner-personal-loan.png)](/docsassets/guides/Create-a-new-product-page/herro-banner-personal-loan.png)
## In conclusion
...
### Next step
Learn how to create [a new campaign page](/guides/digital-marketing/work-with-websites/create-a-new-campaign-page).
![]()
[]()[]()
