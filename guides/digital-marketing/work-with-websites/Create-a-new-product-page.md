# Create a new product page
  * Tutorial| [ Copy page link ](guides/digital-marketing/work-with-websites/Create-a-new-product-page#) | [Get HelpService ID](guides/digital-marketing/work-with-websites/Create-a-new-product-page#) | This page is part of a module: [ Work with website content ](modules/work-with-website-content)
Core MVC 5


[✖](guides/digital-marketing/work-with-websites/Create-a-new-product-page# "Close page link panel") [Copy to clipboard](guides/digital-marketing/work-with-websites/Create-a-new-product-page#)
