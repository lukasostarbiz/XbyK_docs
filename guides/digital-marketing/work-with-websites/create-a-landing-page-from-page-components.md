---
source: https://docs.kentico.com/guides/digital-marketing/work-with-websites/create-a-landing-page-from-page-components
...
[![Adding a new page in the content tree](/docsassets/guides/create-a-landing-page-from-page-components/content-tree.png)](/docsassets/guides/create-a-landing-page-from-page-components/content-tree.png)
...
[![Creating new Content page](/docsassets/guides/create-a-landing-page-from-page-components/new-page-content-type.png)](/docsassets/guides/create-a-landing-page-from-page-components/new-page-content-type.png)
...
[![Adjusting the SEO settings to remove the page from indexing](/docsassets/guides/create-a-landing-page-from-page-components/seo-properties.png)](/docsassets/guides/create-a-landing-page-from-page-components/seo-properties.png)
Similarly, for the same reason, select the **Exclude content of this page from Rich results on Google** option.
[![Excluding the page from Google search](/docsassets/guides/create-a-landing-page-from-page-components/exclude-on-google-option.png)](/docsassets/guides/create-a-landing-page-from-page-components/exclude-on-google-option.png)
...
[![Adding the hero banner widget to a page](/docsassets/guides/create-a-landing-page-from-page-components/add-hero-widget.png)](/docsassets/guides/create-a-landing-page-from-page-components/add-hero-widget.png)
...
[![Adding the product to hero banner](/docsassets/guides/create-a-landing-page-from-page-components/hero-banner-properties.png)](/docsassets/guides/create-a-landing-page-from-page-components/hero-banner-properties.png)
...
[![Selecting a product page for a Hero banner](/docsassets/guides/create-a-landing-page-from-page-components/select-page-from-content-tree.png)](/docsassets/guides/create-a-landing-page-from-page-components/select-page-from-content-tree.png)
...
[![Changing a Hero banner design](/docsassets/guides/create-a-landing-page-from-page-components/change-hero-banner-design.png)](/docsassets/guides/create-a-landing-page-from-page-components/change-hero-banner-design.png)
...
[![Creating a new benefit content item](/docsassets/guides/create-a-landing-page-from-page-components/create-new-content-item.png)](/docsassets/guides/create-a-landing-page-from-page-components/create-new-content-item.png)
...
[![Publishing new benefit content item](/docsassets/guides/create-a-landing-page-from-page-components/publish-new-benefit.png)](/docsassets/guides/create-a-landing-page-from-page-components/publish-new-benefit.png)
...
[![Adding a Page heading widget](/docsassets/guides/create-a-landing-page-from-page-components/add-widget.png)](/docsassets/guides/create-a-landing-page-from-page-components/add-widget.png)
...
[![Adjusting the Page heading widget properties](/docsassets/guides/create-a-landing-page-from-page-components/page-heading-properties.png)](/docsassets/guides/create-a-landing-page-from-page-components/page-heading-properties.png)
...
[![Adding specific benefits to Benefit widget](/docsassets/guides/create-a-landing-page-from-page-components/benefit-properties.png)](/docsassets/guides/create-a-landing-page-from-page-components/benefit-properties.png)
Now, find the special benefit you prepared.
[![Selecting special benefit content item](/docsassets/guides/create-a-landing-page-from-page-components/select-content-item.png)](/docsassets/guides/create-a-landing-page-from-page-components/select-content-item.png)
...
[![Adding text to Rich text widget](/docsassets/guides/create-a-landing-page-from-page-components/rich-text-widget.png)](/docsassets/guides/create-a-landing-page-from-page-components/rich-text-widget.png)
...
[![Adding an asset from Content hub to Image widget](/docsassets/guides/create-a-landing-page-from-page-components/image-properties.png)](/docsassets/guides/create-a-landing-page-from-page-components/image-properties.png)
...
[![Publishing the page](/docsassets/guides/create-a-landing-page-from-page-components/publish-landing-page.png)](/docsassets/guides/create-a-landing-page-from-page-components/publish-landing-page.png)
If you have followed this exercise, your landing page will look like this:
[![Landing page final look](/docsassets/guides/create-a-landing-page-from-page-components/landing-page-final.png)](/docsassets/guides/create-a-landing-page-from-page-components/landing-page-final.png)
### Next step
In the next guide, you’ll learn about [creating a reusable landing page template](/guides/digital-marketing/work-with-websites/create-a-reusable-landing-page-template).
![]()
[]()[]()
