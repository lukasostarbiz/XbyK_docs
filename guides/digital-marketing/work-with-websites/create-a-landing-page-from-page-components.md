# Create a landing page from page components
  * How-to| [ Copy page link ](guides/digital-marketing/work-with-websites/create-a-landing-page-from-page-components#) | [Get HelpService ID](guides/digital-marketing/work-with-websites/create-a-landing-page-from-page-components#) | This page is part of a module: [ Work with website content ](modules/work-with-website-content)
Core MVC 5


[✖](guides/digital-marketing/work-with-websites/create-a-landing-page-from-page-components# "Close page link panel") [Copy to clipboard](guides/digital-marketing/work-with-websites/create-a-landing-page-from-page-components#)
