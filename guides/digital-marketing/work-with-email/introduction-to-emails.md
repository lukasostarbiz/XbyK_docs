# Introduction to emails in Xperience
  * Concept| [ Copy page link ](guides/digital-marketing/work-with-email/introduction-to-emails#) | [Get HelpService ID](guides/digital-marketing/work-with-email/introduction-to-emails#)
Core MVC 5


[✖](guides/digital-marketing/work-with-email/introduction-to-emails# "Close page link panel") [Copy to clipboard](guides/digital-marketing/work-with-email/introduction-to-emails#)
...
[![Email delivery report in Xperience by Kentico](docsassets/guides/introduction-to-emails/5_newsletters_stats.png)](https://docs.kentico.com/docsassets/guides/introduction-to-emails/5_newsletters_stats.png)
## Marketing emails
...
[![Sample newsletter email in Kbank demo site](docsassets/guides/introduction-to-emails/1_newsletters_newsletter_email.png)](https://docs.kentico.com/docsassets/guides/introduction-to-emails/1_newsletters_newsletter_email.png)
...
[![Overview of a recipient list in Xperience by Kentico](docsassets/guides/introduction-to-emails/4_newsletters_recipient_list.png)](https://docs.kentico.com/docsassets/guides/introduction-to-emails/4_newsletters_recipient_list.png)
...
[![Sample autoresponder email on the Kbank demo site](docsassets/guides/introduction-to-emails/2_newletters_form_autoresponder.png)](https://docs.kentico.com/docsassets/guides/introduction-to-emails/2_newletters_form_autoresponder.png)
...
[![Sample automation flow triggered by membership registration that sends an email to members who are not subscribed to Kbank demo newsletter.](docsassets/guides/introduction-to-emails/9_newsletters_automation_flow.png)](https://docs.kentico.com/docsassets/guides/introduction-to-emails/9_newsletters_automation_flow.png)
...
[![Sample subscription confirmation email in Kbank demo site](docsassets/guides/introduction-to-emails/3_newsletters_confirmation_email.png)](https://docs.kentico.com/docsassets/guides/introduction-to-emails/3_newsletters_confirmation_email.png)
...
[![Sample notification send to editor team in Kbank demo site](docsassets/guides/introduction-to-emails/6_newsletters_notification.png)](https://docs.kentico.com/docsassets/guides/introduction-to-emails/6_newsletters_notification.png)
...
[![Marketing emails channel settings in Kbank demo site](docsassets/guides/introduction-to-emails/11_newsletters_channel_settings.png)](https://docs.kentico.com/docsassets/guides/introduction-to-emails/11_newsletters_channel_settings.png)
...
[![Different email content types in Kbank demo site](docsassets/guides/introduction-to-emails/7_newsletters_email_content_types.png)](https://docs.kentico.com/docsassets/guides/introduction-to-emails/7_newsletters_email_content_types.png)
...
[![Structured email fields used in macro-based email templates](docsassets/guides/introduction-to-emails/8_newsletters_email_macro_template.png)](https://docs.kentico.com/docsassets/guides/introduction-to-emails/8_newsletters_email_macro_template.png)
...
[![Newsletter email with Email builder in the Dancing Goat demo site](docsassets/guides/introduction-to-emails/10_newsletters_dancing_goat_email_builder.png)](https://docs.kentico.com/docsassets/guides/introduction-to-emails/10_newsletters_dancing_goat_email_builder.png)
