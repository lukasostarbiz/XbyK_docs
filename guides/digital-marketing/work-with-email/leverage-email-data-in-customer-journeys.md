...
With Xperience’s _Customer journeys_ , you can define these rules and let the platform handle the logic.
...
Here are a few examples of how to set up stage transitions in _Customer journeys_ using email activity:
