# Work with taxonomies in Kbank
  * How-to| [ Copy page link ](guides/digital-marketing/work-with-taxonomies/work-with-taxonomies-in-kbank#) | [Get HelpService ID](guides/digital-marketing/work-with-taxonomies/work-with-taxonomies-in-kbank#)
Core MVC 5


[✖](guides/digital-marketing/work-with-taxonomies/work-with-taxonomies-in-kbank# "Close page link panel") [Copy to clipboard](guides/digital-marketing/work-with-taxonomies/work-with-taxonomies-in-kbank#)
...
Prerequisites:
  ...
  * Have a Kbank demo site running, if you want to tag along the examples. You can [request the demo website here](guides/digital-marketing/work-with-taxonomies/www.kentico.com/services/training/training-website-requests).
