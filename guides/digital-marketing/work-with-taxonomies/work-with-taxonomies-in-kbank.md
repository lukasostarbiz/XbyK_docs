---
source: https://docs.kentico.com/guides/digital-marketing/work-with-taxonomies/work-with-taxonomies-in-kbank
scrape_date: 2026-01-22
---

  * [Home](/guides)
  * [Digital marketing](/guides/digital-marketing)
  * [Work with taxonomies](/guides/digital-marketing/work-with-taxonomies)
  * Work with taxonomies in Kbank 


# Work with taxonomies in Kbank
In the previous guide, we explored [taxonomies in Xperience](/guides/digital-marketing/work-with-taxonomies/taxonomies). This guide will show you practical examples of how to work with Taxonomies.
Prerequisites:
  * Know what [taxonomies](/guides/digital-marketing/work-with-taxonomies/taxonomies) mean.
  * Have a Kbank demo site running, if you want to tag along the examples. You can [request the demo website here](www.kentico.com/services/training/training-website-requests).
...
[![New tag with name and description.](/docsassets/guides/work-with-taxonomies-in-kbank/creating-new-taxonomy.png)](/docsassets/guides/work-with-taxonomies-in-kbank/creating-new-taxonomy.png)
...
[![Delete a tag in the tag tree.](/docsassets/guides/work-with-taxonomies-in-kbank/deleting-tag.png)](/docsassets/guides/work-with-taxonomies-in-kbank/deleting-tag.png)
...
[![Save and create another tag to automatically create a new tag on the same hierarchy level.](/docsassets/guides/work-with-taxonomies-in-kbank/creating-new-tag.png)](/docsassets/guides/work-with-taxonomies-in-kbank/creating-new-tag.png)
...
[![Moving a tag in a hierarchy tree.](/docsassets/guides/work-with-taxonomies-in-kbank/grab-tag.png)](/docsassets/guides/work-with-taxonomies-in-kbank/grab-tag.png)
...
[![Moving a tag to a different level of the hierarchy.](/docsassets/guides/work-with-taxonomies-in-kbank/moving-tag-in-hierarchy.png)](/docsassets/guides/work-with-taxonomies-in-kbank/moving-tag-in-hierarchy.png)
[![New hierarchy after the tag was moved.](/docsassets/guides/work-with-taxonomies-in-kbank/new-tag-article-type.png)](/docsassets/guides/work-with-taxonomies-in-kbank/new-tag-article-type.png)
...
[![Translating the tags directly.](/docsassets/guides/work-with-taxonomies-in-kbank/tag-translations.png)](/docsassets/guides/work-with-taxonomies-in-kbank/tag-translations.png)
...
[![Tag translated to Czech added to Czech language variant of an article.](/docsassets/guides/work-with-taxonomies-in-kbank/article-tag-translated.png)](/docsassets/guides/work-with-taxonomies-in-kbank/article-tag-translated.png)
[![Czech language variant of an article with a tag that was not translated.](/docsassets/guides/work-with-taxonomies-in-kbank/article-tag-not-translated.png)](/docsassets/guides/work-with-taxonomies-in-kbank/article-tag-not-translated.png)
...
[![Choosing tags to filter displayed articles.](/docsassets/guides/work-with-taxonomies-in-kbank/tags-in-article-list.png)](/docsassets/guides/work-with-taxonomies-in-kbank/tags-in-article-list.png)
