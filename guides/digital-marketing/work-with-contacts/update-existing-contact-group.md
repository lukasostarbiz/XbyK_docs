...
The following how-to show you steps to fix your contact group definition.
  ...
  3. Select **Edit** in the _Conditions_ field. 
    1. **Add condition group**.
    2. Find the _Contact has agreed with consent_ condition rule.
    ...
    4. **Save** your changes.
  4. After you edit the conditions, you must _Recalculate the group_. During recalculation, Xperience checks all the contacts in the database and the group and keeps only those contacts in the group that fulfill the updated requirements. 
