# Workflows
  * How-to| [ Copy page link ](guides/digital-marketing/work-with-workflows/workflows#) | [Get HelpService ID](guides/digital-marketing/work-with-workflows/workflows#)
Core MVC 5


[✖](guides/digital-marketing/work-with-workflows/workflows# "Close page link panel") [Copy to clipboard](guides/digital-marketing/work-with-workflows/workflows#)
...
[![Create and name new workflow](docsassets/guides/workflows/workflow-naming-new-workflow.png)](https://docs.kentico.com/docsassets/guides/workflows/workflow-naming-new-workflow.png)
...
[![Choose the content types in the Scope tab](docsassets/guides/workflows/workflow-select-content-types.png)](https://docs.kentico.com/docsassets/guides/workflows/workflow-select-content-types.png)
...
[![Channels are represented as a respective content types](docsassets/guides/workflows/workflow-content-types.png)](https://docs.kentico.com/docsassets/guides/workflows/workflow-content-types.png)
...
[![Adding and assigning steps to a new workflow](docsassets/guides/workflows/workflow-new-step.png)](https://docs.kentico.com/docsassets/guides/workflows/workflow-new-step.png)
We’ll create two steps - an _Information check_ for a Product manager and a _Schedule publishing_ for the Marketing team.
[![Overview of all new steps between Draft and Published](docsassets/guides/workflows/workflow-steps.png)](https://docs.kentico.com/docsassets/guides/workflows/workflow-steps.png)
...
[![Setting up notifications in custom workflow step](docsassets/guides/workflows/workflow-setting-notifications.png)](https://docs.kentico.com/docsassets/guides/workflows/workflow-setting-notifications.png)
