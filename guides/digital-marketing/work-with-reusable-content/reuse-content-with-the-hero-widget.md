# Reuse content with the Hero widget
  * How-to| [ Copy page link ](guides/digital-marketing/work-with-reusable-content/reuse-content-with-the-hero-widget#) | [Get HelpService ID](guides/digital-marketing/work-with-reusable-content/reuse-content-with-the-hero-widget#) | This page is part of a module: [ Manage content ](modules/manage-content)
Core MVC 5


[✖](guides/digital-marketing/work-with-reusable-content/reuse-content-with-the-hero-widget# "Close page link panel") [Copy to clipboard](guides/digital-marketing/work-with-reusable-content/reuse-content-with-the-hero-widget#)
