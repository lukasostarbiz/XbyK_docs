# 404 best practices
  * Concept| [ Copy page link ](guides/digital-marketing/work-with-error-page/404-best-practices#) | [Get HelpService ID](guides/digital-marketing/work-with-error-page/404-best-practices#)
Core MVC 5


[✖](guides/digital-marketing/work-with-error-page/404-best-practices# "Close page link panel") [Copy to clipboard](guides/digital-marketing/work-with-error-page/404-best-practices#)
...
The examples in this article are from the _404_ page for the Kbank demo site.
[![Kbank 404 page](docsassets/guides/404-best-practices/kbank-404-page.png)](https://docs.kentico.com/docsassets/guides/404-best-practices/kbank-404-page.png)
## 404 best practices
...
[![404 page explanation](docsassets/guides/404-best-practices/error-page-404-part.png)](https://docs.kentico.com/docsassets/guides/404-best-practices/error-page-404-part.png)
### Use your branding
...
[![404 in Kbank style](docsassets/guides/404-best-practices/error-page-404.png)](https://docs.kentico.com/docsassets/guides/404-best-practices/error-page-404.png)
### Personalize
If you are [tracking your visitors](documentation/business-users/digital-marketing/contact-groups) on your website and collect information about their customer journey, you can redirect them to pages most relevant to them. Xperience does this with personalization.
For example, you can offer more specific _Page heading_ to visitors interested in insurance, followed up by relevant articles.
[![Page heading personalization](docsassets/guides/404-best-practices/page-heading-widget.png)](https://docs.kentico.com/docsassets/guides/404-best-practices/page-heading-widget.png)
### Provide search bar
...
[![Kbank search bar](docsassets/guides/404-best-practices/search-bar.png)](https://docs.kentico.com/docsassets/guides/404-best-practices/search-bar.png)
### Redirect to an existing page
Another way to keep the visitor on the website is to provide links to relevant pages. It could be a _Home page_ , specific product, or an info page that can answer the most common questions or help the visitor decide where to go next. In our example, the _404_ page shows the latest articles.
[![Articles list](docsassets/guides/404-best-practices/error-page-recent-articles.png)](https://docs.kentico.com/docsassets/guides/404-best-practices/error-page-recent-articles.png)
### Be approachable
...
[![Kbank contact form](docsassets/guides/404-best-practices/error-page-form.png)](https://docs.kentico.com/docsassets/guides/404-best-practices/error-page-form.png)
...
Since Xperience doesn’t have any analytics built in, you can use 3rd party tools to analyze incoming traffic, for example [Google Analytics](https://marketingplatform.google.com/about/analytics/) or a [Google search console](https://search.google.com/search-console/about).
...
### Next step
See how you can [model a demo 404 page](guides/digital-marketing/work-with-error-page/How-to-model-an-error-page).