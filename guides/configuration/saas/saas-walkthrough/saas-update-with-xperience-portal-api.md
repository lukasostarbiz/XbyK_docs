# Update a QA deployment using Xperience Portal API
  * [ Copy page link ](guides/configuration/saas/saas-walkthrough/saas-update-with-xperience-portal-api#) | [Get HelpService ID](guides/configuration/saas/saas-walkthrough/saas-update-with-xperience-portal-api#) | This page is part of a module: [ Deploy to SaaS step-by-step ](modules/deploy-to-saas-step-by-step)
Core MVC 5


[✖](guides/configuration/saas/saas-walkthrough/saas-update-with-xperience-portal-api# "Close page link panel") [Copy to clipboard](guides/configuration/saas/saas-walkthrough/saas-update-with-xperience-portal-api#)
...
You generate a new deployment package and upload it either via the Xperience Portal, as we did in [one of the previous steps](guides/configuration/saas/saas-walkthrough/saas-initial-deployment), or using the Xperience Portal API.
...
Then, run the _Export-DeploymentPackage.ps1_ script that’s present in your project, thanks to the `--cloud` parameter we used during [installation](guides/configuration/saas/saas-walkthrough/saas-install-configure-project#install-saas-ready-project):
...
Next, use `Invoke-RestMethod` to call the Xperience Portal’s `upload` REST endpoint:
  * Set the _Authorization_ header to use the _Bearer_ token. The value of the token needs to be your **Personal Access Token (PAT)** that you created and saved in an [earlier step of this walk-through](guides/configuration/saas/saas-walkthrough/saas-setup#create-your-personal-access-token). We’ll pass in the PAT as a script parameter.
...
[![Changed title in the Contacts page to ‘Roastery contact’](docsassets/guides/saas-update-with-xperience-portal-api/updated-code-localhost.jpg)](https://docs.kentico.com/docsassets/guides/saas-update-with-xperience-portal-api/updated-code-localhost.jpg)
...
Prepare your [Personal Access Token value from earlier](guides/configuration/saas/saas-walkthrough/saas-setup#create-your-personal-access-token).
Copy your project GUID from the Xperience Portal dashboard:
[![Project GUID value in the Xperience Portal](docsassets/guides/saas-update-with-xperience-portal-api/project-guid.png)](https://docs.kentico.com/docsassets/guides/saas-update-with-xperience-portal-api/project-guid.png)
...
[![Deployment in progress in Xperience Portal](docsassets/guides/saas-update-with-xperience-portal-api/deployment-in-progress.png)](https://docs.kentico.com/docsassets/guides/saas-update-with-xperience-portal-api/deployment-in-progress.png)
## Check your progress
...
[![Deployment info in Xperience Portal dashboard](docsassets/guides/saas-update-with-xperience-portal-api/new-deployment-info.png)](https://docs.kentico.com/docsassets/guides/saas-update-with-xperience-portal-api/new-deployment-info.png)
...
[![Updated view in cloud](docsassets/guides/saas-update-with-xperience-portal-api/updated-code-cloud.jpg)](https://docs.kentico.com/docsassets/guides/saas-update-with-xperience-portal-api/updated-code-cloud.jpg) [![Updated asset in cloud](docsassets/guides/saas-update-with-xperience-portal-api/updated-asset-cloud.png)](https://docs.kentico.com/docsassets/guides/saas-update-with-xperience-portal-api/updated-asset-cloud.png)
...
## Continue learning
When you’re ready, move on to the next page: [Deploy to production](guides/configuration/saas/saas-walkthrough/saas-deploy-to-prod)