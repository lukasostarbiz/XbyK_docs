# Deploy your solution to Xperience Portal
  * [ Copy page link ](guides/configuration/saas/saas-walkthrough/saas-initial-deployment#) | [Get HelpService ID](guides/configuration/saas/saas-walkthrough/saas-initial-deployment#) | This page is part of a module: [ Deploy to SaaS step-by-step ](modules/deploy-to-saas-step-by-step)
Core MVC 5


[✖](guides/configuration/saas/saas-walkthrough/saas-initial-deployment# "Close page link panel") [Copy to clipboard](guides/configuration/saas/saas-walkthrough/saas-initial-deployment#)
...
[![Showing newly generated folders that contain the serialized CD data](docsassets/guides/saas-initial-deployment/CD-serialized-data.png)](https://docs.kentico.com/docsassets/guides/saas-initial-deployment/CD-serialized-data.png)
...
The package export typically takes from a few seconds to a few minutes depending on the size of your project. The script will show progress while running. [![Exporting the deployment package in PowerShell](docsassets/guides/saas-initial-deployment/creating-deployment-package.png)](https://docs.kentico.com/docsassets/guides/saas-initial-deployment/creating-deployment-package.png)
[![Exporting the deployment package succeeded](docsassets/guides/saas-initial-deployment/creating-deployment-package-done.png)](https://docs.kentico.com/docsassets/guides/saas-initial-deployment/creating-deployment-package-done.png)
...
[![JPG image file inside the deployment package](docsassets/guides/saas-initial-deployment/image-in-CDRepository.png)](https://docs.kentico.com/docsassets/guides/saas-initial-deployment/image-in-CDRepository.png)
...
Double-check that you are [operating under the correct project](guides/configuration/saas/saas-walkthrough/saas-setup#identify-the-active-project).
...
[![The Xperience Portal Deployments screen before the initial package upload](docsassets/guides/saas-initial-deployment/initial-upload.png)](https://docs.kentico.com/docsassets/guides/saas-initial-deployment/initial-upload.png)
Specify the path to your _DeploymentPackage_1.zip_ file.
Click **Upload**.
[![Uploading a deployment package via the Xperience Portal](docsassets/guides/saas-initial-deployment/uploading-deployment-package.png)](https://docs.kentico.com/docsassets/guides/saas-initial-deployment/uploading-deployment-package.png)
...
[![Deployment in progress](docsassets/guides/saas-initial-deployment/deployment-in-progress.png)](https://docs.kentico.com/docsassets/guides/saas-initial-deployment/deployment-in-progress.png)
...
[![Deployment history in Xperience Portal](docsassets/guides/saas-initial-deployment/deployment-history.png)](https://docs.kentico.com/docsassets/guides/saas-initial-deployment/deployment-history.png)
...
## Continue learning
When you’re ready, move on to the next page: [Configure channels](guides/configuration/saas/saas-walkthrough/saas-configure-channels)