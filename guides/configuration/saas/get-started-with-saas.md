# Get started with SaaS
  * [ Copy page link ](guides/configuration/saas/get-started-with-saas#) | [Get HelpService ID](guides/configuration/saas/get-started-with-saas#) | This page is part of a module: [ Get started with SaaS ](modules/get-started-with-saas)
Core MVC 5


[✖](guides/configuration/saas/get-started-with-saas# "Close page link panel") [Copy to clipboard](guides/configuration/saas/get-started-with-saas#)
...
You now have access to Xperience Portal. The next step is to [invite](guides/configuration/saas/get-started-with-saas#invite-your-technical-team) the members of your technical team into the project.
