---
source: https://docs.kentico.com/guides/upgrade-to-xbyk/upgrade-deep-dives/remodel-page-types-as-reusable-field-schemas
...
## Set up the project
If you haven’t, we recommend following along with the [upgrade walkthrough](/guides/upgrade-to-xbyk/upgrade-walkthrough) to see the process of getting a migrated page working in Xperience by Kentico.
...
As discussed in the [migration strategy planning guide](/guides/upgrade-to-xbyk/upgrade-from-kx13/plan-your-strategy-for-migrating-features#structured-content-page-types), **page types** in KX13 map to **content types** in XbyK.
