---
source: https://docs.kentico.com/guides/upgrade-to-xbyk/upgrade-from-kx13/prep-for-upgrade-and-transfer-data
...
This guide will provide more details about the points from the first two top-level sections of the [upgrade overview](/guides/upgrade-to-xbyk/upgrade-from-kx13/upgrade-from-kx13-overview).
...
## What’s next?
The next guide in this series will explore later sections of the overview, covering [how to convert your existing code](/guides/upgrade-to-xbyk/upgrade-from-kx13/adjust-your-code-and-adapt) to work in the new platform, and how to embrace new features.
![]()
[]()[]()
