---
source: https://docs.kentico.com/guides/upgrade-to-xbyk/upgrade-from-kx13/plan-your-strategy-for-migrating-features
...
## What’s next?
If you want a deeper technical understanding of how these features fit into the upgrade process from beginning to end—as outlined in the [Overview](/guides/upgrade-to-xbyk/upgrade-from-kx13/upgrade-from-kx13-overview)—check out the next two guides: [Prep for the upgrade and transfer data](/guides/upgrade-to-xbyk/upgrade-from-kx13/prep-for-upgrade-and-transfer-data) and [Adjust your code and adapt your project](/guides/upgrade-to-xbyk/upgrade-from-kx13/adjust-your-code-and-adapt).
