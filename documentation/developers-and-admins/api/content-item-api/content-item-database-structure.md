# Content item database structure
  * [ Copy page link ](documentation/developers-and-admins/api/content-item-api/content-item-database-structure#) | [Get HelpService ID](documentation/developers-and-admins/api/content-item-api/content-item-database-structure#)
Core MVC 5


[✖](documentation/developers-and-admins/api/content-item-api/content-item-database-structure# "Close page link panel") [Copy to clipboard](documentation/developers-and-admins/api/content-item-api/content-item-database-structure#)
...
CMS_ContentItem |  Stores system information about the content item.
  ...
  * The **ContentItemIsReusable** flag determines whether the item can be linked across multiple channels (i.e., is a reusable content item managed via the _Content Hub_ application) or is tied to a specific channel (i.e., a [page](documentation/developers-and-admins/api/content-item-api/content-item-database-structure#pages) or an [email](documentation/developers-and-admins/api/content-item-api/content-item-database-structure#emails)).
...
[![Content item database composition](docsassets/documentation/content-item-database-structure/CiStructure.png)](https://docs.kentico.com/docsassets/documentation/content-item-database-structure/CiStructure.png)
## Pages
Pages, managed via website channel applications and the `IWebPageManager` [API](api/), extend the [content item structure](documentation/developers-and-admins/api/content-item-api/content-item-database-structure#content-items) with additional entities that provide web-specific, contextual data and metadata.
Database table |  Description  
---|---  
...
[![Page database entity composition](docsassets/documentation/content-item-database-structure/PageStructure.png)](https://docs.kentico.com/docsassets/documentation/content-item-database-structure/PageStructure.png)
## Emails
Emails, managed via email channel applications, extend the [content item structure](documentation/developers-and-admins/api/content-item-api/content-item-database-structure#content-items) with additional entities that provide email-specific, contextual data and metadata.
Database table |  Description  
---|---  
...
[![Email content item database entity composition](docsassets/documentation/content-item-database-structure/EmailStructure.png)](https://docs.kentico.com/docsassets/documentation/content-item-database-structure/EmailStructure.png)
## Headless items
Headless items, managed via headless channel applications, extend the [content item structure](documentation/developers-and-admins/api/content-item-api/content-item-database-structure#content-items) with additional entities that provide headless-specific, contextual data and metadata.
Database table |  Description  
---|---  
...
[![Headless content item database entity composition](docsassets/documentation/content-item-database-structure/HeadlessStructure.png)](https://docs.kentico.com/docsassets/documentation/content-item-database-structure/HeadlessStructure.png)