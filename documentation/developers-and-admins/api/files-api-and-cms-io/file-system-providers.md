# File system providers
  * [ Copy page link ](documentation/developers-and-admins/api/files-api-and-cms-io/file-system-providers#) | [Get HelpService ID](documentation/developers-and-admins/api/files-api-and-cms-io/file-system-providers#)
Core MVC 5


[✖](documentation/developers-and-admins/api/files-api-and-cms-io/file-system-providers# "Close page link panel") [Copy to clipboard](documentation/developers-and-admins/api/files-api-and-cms-io/file-system-providers#)
...
Use the `CMS.IO` API and the following general process:
  ...
  3. Override the module’s `OnInit` method and perform the required `StorageProvider` modifications. See the following use cases:
    1. [Change content file paths to a shared storage](documentation/developers-and-admins/api/files-api-and-cms-io/file-system-providers#change-content-file-paths-to-a-shared-storage)
    2. [Change content file paths to a different disk drive](documentation/developers-and-admins/api/files-api-and-cms-io/file-system-providers#change-content-file-paths-to-a-different-disk-drive)


## Change content file paths to a shared storage
The system allows you to change default file paths to a shared storage directory on a specific server. This is important when using [web farms](documentation/developers-and-admins/configuration/auto-scaling-support). For example, shared storage is a requirement for all [scaled](documentation/developers-and-admins/configuration/auto-scaling-support) Xperience deployments.
...
Using this configuration, [auto-scaling](documentation/developers-and-admins/configuration/auto-scaling-support) will not attempt to synchronize physical files and will instead access the shared storage (the default location for media libraries is **~/assets/media/ <MediaLibraryName>**, for content item assets **~/assets/contentitems**).
