# Deploy to private cloud
  * [ Copy page link ](documentation/developers-and-admins/deployment/deploy-to-private-cloud#) | [Get HelpService ID](documentation/developers-and-admins/deployment/deploy-to-private-cloud#) | This page is part of a module: [ Private cloud deployment ](modules/private-cloud-deployment)
Core MVC 5


[✖](documentation/developers-and-admins/deployment/deploy-to-private-cloud# "Close page link panel") [Copy to clipboard](documentation/developers-and-admins/deployment/deploy-to-private-cloud#)
