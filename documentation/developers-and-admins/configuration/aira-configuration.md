# AIRA configuration
  * [ Copy page link ](documentation/developers-and-admins/configuration/aira-configuration#) | [Get HelpService ID](documentation/developers-and-admins/configuration/aira-configuration#)
Core MVC 5


[✖](documentation/developers-and-admins/configuration/aira-configuration# "Close page link panel") [Copy to clipboard](documentation/developers-and-admins/configuration/aira-configuration#)
...
[![Feature settings of the AIRA application](docsassets/documentation/aira-configuration/aira-app-feature-settings.png)](https://docs.kentico.com/docsassets/documentation/aira-configuration/aira-app-feature-settings.png)
...
[![Configure AIRA translations](docsassets/documentation/aira-configuration/configure-aira-translations.png)](https://docs.kentico.com/docsassets/documentation/aira-configuration/configure-aira-translations.png)
...
All content type fields of the data types allowed for translations are automatically enabled for translation. To specify which content type fields you want to translate:
  ...
  5. Select or clear the **Include field in translation** checkbox. 
     * The checkbox is only available if the [data type](documentation/developers-and-admins/customization/field-editor/data-type-management) of the field is [allowed to be translated](documentation/developers-and-admins/configuration/aira-configuration#configure-aira-translations).
  6. **Save** your changes.
...
[![AIRA feature added to a content type field](docsassets/documentation/aira-configuration/Field_editor_AIRA_features.png)](https://docs.kentico.com/docsassets/documentation/aira-configuration/Field_editor_AIRA_features.png)
