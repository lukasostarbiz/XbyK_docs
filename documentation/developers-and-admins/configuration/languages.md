---
source: https://docs.kentico.com/documentation/developers-and-admins/configuration/languages
...
[![New language](/docsassets/documentation/languages/new_language_button.png)](/docsassets/documentation/languages/new_language_button.png)
...
The default language is not the one in which the live website appears by default. That is determined by the primary language set for each website channel. For more info on the primary language see [Website channel management](/documentation/developers-and-admins/configuration/website-channel-management).
     * **Fallback language** – existing language the new language will fallback into. More on fallbacks in [Language fallbacks](#language-fallbacks). You can set it up now or later.
...
**Untranslated reference** [![Admininterface with untranslated items](/docsassets/documentation/languages/admin-not_translated.png)](/docsassets/documentation/languages/admin-not_translated.png) [![Untranslatedreference](/docsassets/documentation/languages/ref-en-marked.png)](/docsassets/documentation/languages/ref-en-marked.png) |  **Translated reference** [![Admin interface with translated items](/docsassets/documentation/languages/admin-translated.png)](/docsassets/documentation/languages/admin-translated.png) [![Translated reference](/docsassets/documentation/languages/ref-es-marked.png)](/docsassets/documentation/languages/ref-es-marked.png)  
---|---  
### Fallback chaining
...
[![Content language fallback mechanism](/docsassets/documentation/languages/fallback_chaining.png)](/docsassets/documentation/languages/fallback_chaining.png)
## Remove a language
