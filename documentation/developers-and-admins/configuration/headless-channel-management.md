# Headless channel management
  * [ Copy page link ](documentation/developers-and-admins/configuration/headless-channel-management#) | [Get HelpService ID](documentation/developers-and-admins/configuration/headless-channel-management#)
Core MVC 5


[✖](documentation/developers-and-admins/configuration/headless-channel-management# "Close page link panel") [Copy to clipboard](documentation/developers-and-admins/configuration/headless-channel-management#)
...
Every headless channel has its own [GraphQL API endpoint](https://graphql.org/learn/serving-over-http/), which is secured by one or more [API keys](documentation/developers-and-admins/configuration/headless-channel-management#manage-api-keys). Each channel also has **its own application** in the Xperience administration, where editors can [manage content](documentation/business-users/headless-content) intended for headless distribution. The content is stored in items based on headless [content types](documentation/developers-and-admins/development/content-types). These headless items can also reuse content from [Content hub](documentation/business-users/content-hub) that is shared between all types of channels.
To start using the headless API:
  1. [Create](documentation/developers-and-admins/configuration/headless-channel-management#create-headless-channels) one or more headless channels.
  ...
  4. [Configure](documentation/developers-and-admins/configuration/headless-channel-management#configure-the-headless-api) the headless API.
...
[![GraphQL API endpoint path](docsassets/documentation/headless-channel-management/graphql_endpoint_path.png)](https://docs.kentico.com/docsassets/documentation/headless-channel-management/graphql_endpoint_path.png)
...
The endpoint slug (‘ _/graphql_ ’ by default) can be [configured](documentation/developers-and-admins/configuration/headless-channel-management#configure-the-headless-api).
...
To create a new API key:
  ...
  6. Select the **[Access type](documentation/developers-and-admins/configuration/headless-channel-management#access-types-of-api-keys)** of the key.
  ...
  8. **Generate** the key.  
[![New API key](docsassets/documentation/headless-channel-management/new_api_key.png)](https://docs.kentico.com/docsassets/documentation/headless-channel-management/new_api_key.png)
...
[![API key generated for a headless channel](docsassets/documentation/headless-channel-management/api_key_censored.png)](https://docs.kentico.com/docsassets/documentation/headless-channel-management/api_key_censored.png)
...
[![Api key detail](docsassets/documentation/headless-channel-management/api_key_detail.png)](https://docs.kentico.com/docsassets/documentation/headless-channel-management/api_key_detail.png)
     * **Disable** (**Enable** (
     * **Delete** (  
[![Listing of API keys](docsassets/documentation/headless-channel-management/api_keys_listing.png)](https://docs.kentico.com/docsassets/documentation/headless-channel-management/api_keys_listing.png)
