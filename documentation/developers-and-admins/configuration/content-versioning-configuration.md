---
source: https://docs.kentico.com/documentation/developers-and-admins/configuration/content-versioning-configuration
...
Storing too many versions can be detrimental to the system’s performance. The optimal number of versions depends on your project and environment. We don’t recommend storing more versions than you need. 
  5. **Save** the settings.
[![Save configuration](/docsassets/documentation/content-versioning-configuration/settings_save.png)](/docsassets/documentation/content-versioning-configuration/settings_save.png)
