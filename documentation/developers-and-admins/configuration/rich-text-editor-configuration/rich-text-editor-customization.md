---
source: https://docs.kentico.com/documentation/developers-and-admins/configuration/rich-text-editor-configuration/rich-text-editor-customization
...
The sections below provide examples of scenarios that use this customization pattern:
  * [Replace the default editor configuration](#replace-the-default-editor-configuration)
  * [Add custom CSS to the rich text editor](#add-custom-css-to-the-rich-text-editor)
