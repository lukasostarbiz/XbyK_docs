# Administration - Forms authentication
  * [ Copy page link ](documentation/developers-and-admins/configuration/users/administration-registration-and-authentication/administration-forms-authentication#) | [Get HelpService ID](documentation/developers-and-admins/configuration/users/administration-registration-and-authentication/administration-forms-authentication#)
Core MVC 5


[✖](documentation/developers-and-admins/configuration/users/administration-registration-and-authentication/administration-forms-authentication# "Close page link panel") [Copy to clipboard](documentation/developers-and-admins/configuration/users/administration-registration-and-authentication/administration-forms-authentication#)
...
The system provides the following configuration options. The default values are described in each section.
  * [Authentication options](documentation/developers-and-admins/configuration/users/administration-registration-and-authentication/administration-forms-authentication#authentication-options)
    * [Mode](documentation/developers-and-admins/configuration/users/administration-registration-and-authentication/administration-forms-authentication#mode)
    * [ExpireTimespan](documentation/developers-and-admins/configuration/users/administration-registration-and-authentication/administration-forms-authentication#expiretimespan)
    * [MultiFactorAuthenticationOptions](documentation/developers-and-admins/configuration/users/administration-registration-and-authentication/administration-forms-authentication#multifactorauthenticationoptions)
    * [CookieEventsOptions](documentation/developers-and-admins/configuration/users/administration-registration-and-authentication/administration-forms-authentication#cookieeventsoptions)
  * [Password options](documentation/developers-and-admins/configuration/users/administration-registration-and-authentication/administration-forms-authentication#password-options)
    * [Forbidden passwords](documentation/developers-and-admins/configuration/users/administration-registration-and-authentication/administration-forms-authentication#forbidden-passwords)
    * [Configuration example](documentation/developers-and-admins/configuration/users/administration-registration-and-authentication/administration-forms-authentication#configuration-example)
  * [Lockout options](documentation/developers-and-admins/configuration/users/administration-registration-and-authentication/administration-forms-authentication#lockout-options)
  * [Email options](documentation/developers-and-admins/configuration/users/administration-registration-and-authentication/administration-forms-authentication#email-options)
    * [LinkExpiration](documentation/developers-and-admins/configuration/users/administration-registration-and-authentication/administration-forms-authentication#linkexpiration)
  * [Customize user management notifications](documentation/developers-and-admins/configuration/users/administration-registration-and-authentication/administration-forms-authentication#customize-user-management-notifications)
  * [Rate limiting for user management endpoints](documentation/developers-and-admins/configuration/users/administration-registration-and-authentication/administration-forms-authentication#rate-limiting-for-user-management-endpoints)
...
You can also adjust the email message sent when a user’s multi-factor authentication secret key is reset. See the [Customize user management notifications](documentation/developers-and-admins/configuration/users/administration-registration-and-authentication/administration-forms-authentication#customize-user-management-notifications) section.
### CookieEventsOptions
...
ForbiddenPasswords |  |  See [Forbidden passwords](documentation/developers-and-admins/configuration/users/administration-registration-and-authentication/administration-forms-authentication#forbidden-passwords).  
### Forbidden passwords
...
Listing forbidden passwords manually may not be practical in most cases. We recommend implementing a generator class that puts together combinations of relevant keywords, special characters and numbers. The [configuration example](documentation/developers-and-admins/configuration/users/administration-registration-and-authentication/administration-forms-authentication#configuration-example) below shows a basic forbidden password generator.
