---
source: https://docs.kentico.com/documentation/developers-and-admins/configuration/system-overview
...
[![System overview in the Xperience administration](/docsassets/documentation/system-overview/System_Overview.png)](/docsassets/documentation/system-overview/System_Overview.png)
System information  
---  
...
You can restart the application by selecting the buttons in the **System information** section:
  ...
  * **Restart all web farm servers** – sends a restart request to all available applications in [multi-instance environments](/documentation/developers-and-admins/configuration/auto-scaling-support).
