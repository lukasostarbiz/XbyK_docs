# Reference - Configuration keys
  * [ Copy page link ](documentation/developers-and-admins/configuration/reference-configuration-keys#) | [Get HelpService ID](documentation/developers-and-admins/configuration/reference-configuration-keys#)
Core MVC 5


[✖](documentation/developers-and-admins/configuration/reference-configuration-keys# "Close page link panel") [Copy to clipboard](documentation/developers-and-admins/configuration/reference-configuration-keys#)
...
The following configuration categories are available:
  * [General settings](documentation/developers-and-admins/configuration/reference-configuration-keys#general-settings)
  * [Continuous Integration and Deployment settings](documentation/developers-and-admins/configuration/reference-configuration-keys#continuous-integration-and-deployment-settings)
  * [Contact management settings](documentation/developers-and-admins/configuration/reference-configuration-keys#contact-management-settings)
  * [Headless API settings](documentation/developers-and-admins/configuration/reference-configuration-keys#headless-api-settings)
  * [Connection string](documentation/developers-and-admins/configuration/reference-configuration-keys#connection-string)
  * [Other settings](documentation/developers-and-admins/configuration/reference-configuration-keys#other-settings)
...
```
|  true  
[> Back to list of configuration key categories](documentation/developers-and-admins/configuration/reference-configuration-keys#ReferenceConfigurationkeys-KeysTop)
...
```
|  10  
CMSCreateContactActionsLogWorker |  If enabled, all [web farm servers](documentation/developers-and-admins/configuration/auto-scaling-support) recalculate contact groups. If you wish to improve performance, you can set this key to _false_ for one or more of your web farm servers, and the recalculation will be disabled for them. **Note** : If you set the key value to _false_ for all of your web farm servers, the recalculation will be disabled completely. JSON Copy ```
