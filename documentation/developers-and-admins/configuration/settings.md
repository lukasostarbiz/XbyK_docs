# Settings
  * [ Copy page link ](documentation/developers-and-admins/configuration/settings#) | [Get HelpService ID](documentation/developers-and-admins/configuration/settings#)
Core MVC 5


[✖](documentation/developers-and-admins/configuration/settings# "Close page link panel") [Copy to clipboard](documentation/developers-and-admins/configuration/settings#)
...
[![Working in the Settings application](docsassets/documentation/settings/Settings.png)](https://docs.kentico.com/docsassets/documentation/settings/Settings.png)
