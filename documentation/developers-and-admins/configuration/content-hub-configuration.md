# Content hub configuration
  * [ Copy page link ](documentation/developers-and-admins/configuration/content-hub-configuration#) | [Get HelpService ID](documentation/developers-and-admins/configuration/content-hub-configuration#)
Core MVC 5


[✖](documentation/developers-and-admins/configuration/content-hub-configuration# "Close page link panel") [Copy to clipboard](documentation/developers-and-admins/configuration/content-hub-configuration#)
...
This page covers content hub configuration options you can use to customize your project:
  * [Enable content hub folders](documentation/developers-and-admins/configuration/content-hub-configuration#enable-content-hub-folders)
  * [Customize maximum file upload size and chunk size](documentation/developers-and-admins/configuration/content-hub-configuration#customize-maximum-file-upload-size-and-chunk-size)
  * [Customize supported file types](documentation/developers-and-admins/configuration/content-hub-configuration#customize-supported-file-types)
...
[![Viewing the content hub with folders](docsassets/documentation/content-hub-configuration/Content_hub_folders.png)](https://docs.kentico.com/docsassets/documentation/content-hub-configuration/Content_hub_folders.png)
...
Support for **svg** images can be enabled after considering the [potential security impacts](documentation/developers-and-admins/configuration/content-hub-configuration#support-for-svg-images).
...
If you want to configure the system to allow the upload of a custom file type into the content hub, you need to:
  1. [Enable the custom extensions](documentation/developers-and-admins/configuration/content-hub-configuration#customize-allowed-extensions) to be uploaded to the content hub.
  2. (_Optional_) If you want to use the custom extension as an image file, you need to configure the system to [recognize the extension as an image file](documentation/developers-and-admins/configuration/content-hub-configuration#specify-image-file-types).
