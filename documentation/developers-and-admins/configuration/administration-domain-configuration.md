# Administration domain configuration
  * [ Copy page link ](documentation/developers-and-admins/configuration/administration-domain-configuration#) | [Get HelpService ID](documentation/developers-and-admins/configuration/administration-domain-configuration#)
Core MVC 5


[✖](documentation/developers-and-admins/configuration/administration-domain-configuration# "Close page link panel") [Copy to clipboard](documentation/developers-and-admins/configuration/administration-domain-configuration#)
...
[Set up a domain redirect](documentation/developers-and-admins/configuration/administration-domain-configuration#set-up-an-administration-domain-redirect) to ensure that all users consistently access the administration on the dedicated domain.
