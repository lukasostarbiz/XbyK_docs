# Product catalog
  * [ Copy page link ](documentation/developers-and-admins/digital-commerce-setup/model-product-catalog#) | [Get HelpService ID](documentation/developers-and-admins/digital-commerce-setup/model-product-catalog#)
Core MVC 5


[✖](documentation/developers-and-admins/digital-commerce-setup/model-product-catalog# "Close page link panel") [Copy to clipboard](documentation/developers-and-admins/digital-commerce-setup/model-product-catalog#)
...
Note that the parent product doesn’t need to store an [SKU](documentation/developers-and-admins/digital-commerce-setup/model-product-catalog#sku-field), since you cannot buy a shirt without specifying the variant. On the other hand, the variant product doesn’t need to store product fields, since the shirts are identical except for their size.
...
The SKU field can be included in the _Product fields_ reusable field schema. However, when implementing [product variants](documentation/developers-and-admins/digital-commerce-setup/model-product-catalog#product-variants), you may want to have a distinct SKU for each product variant, but only need _Product fields_ for the parent product.
## Product stock
