# Shipping and payment methods
  * [ Copy page link ](documentation/developers-and-admins/digital-commerce-setup/shipping-and-payment-methods#) | [Get HelpService ID](documentation/developers-and-admins/digital-commerce-setup/shipping-and-payment-methods#)
Core MVC 5


[✖](documentation/developers-and-admins/digital-commerce-setup/shipping-and-payment-methods# "Close page link panel") [Copy to clipboard](documentation/developers-and-admins/digital-commerce-setup/shipping-and-payment-methods#)
...
To configure shipping and payment methods, you need to:
  1. [Configure shipping methods](documentation/developers-and-admins/digital-commerce-setup/shipping-and-payment-methods#configure-shipping-methods).
  2. [Configure payment methods](documentation/developers-and-admins/digital-commerce-setup/shipping-and-payment-methods#configure-payment-methods).
  3. [Display shipping and payment methods in the checkout process](documentation/developers-and-admins/digital-commerce-setup/shipping-and-payment-methods#display-shipping-and-payment-methods).
  4. [Implement business logic for shipping and payment methods](documentation/developers-and-admins/digital-commerce-setup/shipping-and-payment-methods#implement-shipping-and-payment-methods).
...
You can view all shipping methods in the **Shipping methods** listing and [display](documentation/developers-and-admins/digital-commerce-setup/shipping-and-payment-methods#display-shipping-and-payment-methods) them on your storefront.
...
You can view all payment methods in the **Payment methods** listing and [display](documentation/developers-and-admins/digital-commerce-setup/shipping-and-payment-methods#display-shipping-and-payment-methods) them on your storefront.
...
The system objects for [shipping](documentation/developers-and-admins/digital-commerce-setup/shipping-and-payment-methods#configure-shipping-methods) and [payment](documentation/developers-and-admins/digital-commerce-setup/shipping-and-payment-methods#configure-payment-methods) methods can be [extended](documentation/developers-and-admins/customization/object-types/extend-system-object-types) to store internal business logic and configuration data, such as countries where a certain shipping method is available, processing timeframes, or integration settings with third-party providers.
...
After you create the objects representing [shipping](documentation/developers-and-admins/digital-commerce-setup/shipping-and-payment-methods#configure-shipping-methods) and [payment](documentation/developers-and-admins/digital-commerce-setup/shipping-and-payment-methods#configure-payment-methods) methods, you need to implement the business logic. This may include:
