---
source: https://docs.kentico.com/documentation/developers-and-admins/digital-marketing-setup/email-templates
...
[![Email template containing individual email fields](/docsassets/documentation/email-templates/Email_Structure.png)](/docsassets/documentation/email-templates/Email_Structure.png)
## Email content types
...
Pages and reusable content |  Returns a collection of the selected content items and pages. Use iteration or indexing to get individual items. Access item fields via the `Data` macro. See: [Linked pages and content items](#linked-pages-and-content-items) |  `{% emailfield[0].Data.itemfield %}`  
...
See: [Taxonomy fields](#taxonomy-fields) |  `{% field.Tags[0].Title %}`  
...
[Image variants](/documentation/business-users/content-hub/content-item-assets#image-variants) are currently not supported for emails. See: [Content item assets (files)](#content-item-assets-files) |  `{% emailfield[0].Data.assetfield.Url %}`  
