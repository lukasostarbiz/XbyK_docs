# Headless tracking
  * [ Copy page link ](documentation/developers-and-admins/digital-marketing-setup/headless-tracking#) | [Get HelpService ID](documentation/developers-and-admins/digital-marketing-setup/headless-tracking#)
Core MVC 5


[✖](documentation/developers-and-admins/digital-marketing-setup/headless-tracking# "Close page link panel") [Copy to clipboard](documentation/developers-and-admins/digital-marketing-setup/headless-tracking#)
...
The following steps outline the typical process for setting up headless tracking in an external application:
  * [Ensure authentication and CORS for your requests](documentation/developers-and-admins/digital-marketing-setup/headless-tracking#authentication-and-cors)
  * [Display one or more tracking consents from Xperience to your application’s users](documentation/developers-and-admins/digital-marketing-setup/headless-tracking#get-the-text-of-consents-from-xperience)
  * [Allow users to accept or revoke the consents](documentation/developers-and-admins/digital-marketing-setup/headless-tracking#add-or-revoke-a-consent-agreement)
  * For users who have given a consent agreement to be tracked: 
    * [Create contacts in Xperience to represent individual users](documentation/developers-and-admins/digital-marketing-setup/headless-tracking#create-contacts)
    * [Log activities for the contacts](documentation/developers-and-admins/digital-marketing-setup/headless-tracking#log-activities)
      * Use the _Data input_ [activity](documentation/developers-and-admins/digital-marketing-setup/headless-tracking#log-activities) to send or update information about contacts
...
The GUID is a required parameter whenever you need to [manage the contact’s consent agreements](documentation/developers-and-admins/digital-marketing-setup/headless-tracking#add-or-revoke-a-consent-agreement) or [log activities](documentation/developers-and-admins/digital-marketing-setup/headless-tracking#log-activities).
## Add or revoke a consent agreement
To add or revoke a [consent agreement](documentation/developers-and-admins/digital-marketing-setup/headless-tracking#get-the-text-of-consents-from-xperience) for a [contact](documentation/developers-and-admins/digital-marketing-setup/headless-tracking#create-contacts), send the following request:
  * **HTTP method** : POST
...
To check whether a [contact](documentation/developers-and-admins/digital-marketing-setup/headless-tracking#create-contacts) currently has a valid agreement for a [consent](documentation/developers-and-admins/digital-marketing-setup/headless-tracking#get-the-text-of-consents-from-xperience), send the following request:
  * **HTTP method** : GET
  * **Endpoint** : /Kentico.Tracking/contacts/{contact_guid}/consents/{consent_name}
  * **URI example** : https://domain.com/Kentico.Tracking/contacts/06b035b8-6658-4a1b-b1de-5994e4975fb1/consents/TrackingConsent
...
Log activities by sending the following requests:
  ...
  * **Request body** : 
    * `channel` – the GUID identifier of the [headless channel](documentation/developers-and-admins/configuration/headless-channel-management) under which the activity will be logged.
      ...
      * The identifier must match the parent channel of the API key used to [authenticate](documentation/developers-and-admins/digital-marketing-setup/headless-tracking#authentication-and-cors) the logging request.
    * `contact` – the GUID of the contact who performed the activity (see [Create contacts](documentation/developers-and-admins/digital-marketing-setup/headless-tracking#create-contacts)).
