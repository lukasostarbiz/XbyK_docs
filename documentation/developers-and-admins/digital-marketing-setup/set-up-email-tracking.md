# Set up email tracking
  * [ Copy page link ](documentation/developers-and-admins/digital-marketing-setup/set-up-email-tracking#) | [Get HelpService ID](documentation/developers-and-admins/digital-marketing-setup/set-up-email-tracking#)
Core MVC 5


[✖](documentation/developers-and-admins/digital-marketing-setup/set-up-email-tracking# "Close page link panel") [Copy to clipboard](documentation/developers-and-admins/digital-marketing-setup/set-up-email-tracking#)
...
Additional statistics are provided for [regular emails](documentation/business-users/digital-marketing/emails/send-regular-emails-to-subscribers) sent to subscribed recipients:
  * **Delivered emails** – calculated by tracking [email bounces](https://en.wikipedia.org/wiki/Bounce_message) (undelivered emails) and subtracting the bounce count from the total number of sent emails. Bounced email tracking requires [additional configuration](documentation/developers-and-admins/digital-marketing-setup/set-up-email-tracking#configure-bounced-email-tracking).
...
Keep the following limitations in mind when starting with email tracking:
  ...
  * You cannot retroactively track emails that have already been sent before [enabling the tracking feature](documentation/developers-and-admins/digital-marketing-setup/set-up-email-tracking#enable-the-email-tracking-feature).
...
To set up bounced email tracking, start by [enabling the email tracking feature](documentation/developers-and-admins/digital-marketing-setup/set-up-email-tracking#enable-the-email-tracking-feature). Additional steps depend on the [email clients](documentation/developers-and-admins/configuration/email-configuration) configured for your application or specific email channels – [SendGrid integration](documentation/developers-and-admins/digital-marketing-setup/set-up-email-tracking#sendgrid) or an [SMTP server](documentation/developers-and-admins/digital-marketing-setup/set-up-email-tracking#smtp-server).
### SendGrid
...
[![Email sending and bounced tracking with Return-Path header support](docsassets/documentation/set-up-email-tracking/Bounced_Emails_SMTP_Return-Path.png)](https://docs.kentico.com/docsassets/documentation/set-up-email-tracking/Bounced_Emails_SMTP_Return-Path.png)
**Email sending and bounce tracking with a forced sender address**
**[![Email sending and bounce tracking with a forced sender address](docsassets/documentation/set-up-email-tracking/Bounced_Emails_SMTP_No_Return-Path.png)](https://docs.kentico.com/docsassets/documentation/set-up-email-tracking/Bounced_Emails_SMTP_No_Return-Path.png)**
...
[![Information about email bounces in the profile of contacts](docsassets/documentation/set-up-email-tracking/Contact_Profile_Email_Bounces.png)](https://docs.kentico.com/docsassets/documentation/set-up-email-tracking/Contact_Profile_Email_Bounces.png)