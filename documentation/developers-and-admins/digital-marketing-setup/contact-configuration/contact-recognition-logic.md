# Contact recognition logic
  * [ Copy page link ](documentation/developers-and-admins/digital-marketing-setup/contact-configuration/contact-recognition-logic#) | [Get HelpService ID](documentation/developers-and-admins/digital-marketing-setup/contact-configuration/contact-recognition-logic#)
Core MVC 5


[✖](documentation/developers-and-admins/digital-marketing-setup/contact-configuration/contact-recognition-logic# "Close page link panel") [Copy to clipboard](documentation/developers-and-admins/digital-marketing-setup/contact-configuration/contact-recognition-logic#)
