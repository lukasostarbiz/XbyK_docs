# Map custom member fields to contacts
  * [ Copy page link ](documentation/developers-and-admins/digital-marketing-setup/contact-configuration/map-custom-member-fields-to-contacts#) | [Get HelpService ID](documentation/developers-and-admins/digital-marketing-setup/contact-configuration/map-custom-member-fields-to-contacts#)
Core MVC 5


[✖](documentation/developers-and-admins/digital-marketing-setup/contact-configuration/map-custom-member-fields-to-contacts# "Close page link panel") [Copy to clipboard](documentation/developers-and-admins/digital-marketing-setup/contact-configuration/map-custom-member-fields-to-contacts#)
