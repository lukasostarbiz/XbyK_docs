# Manage multiple email channels
  * [ Copy page link ](documentation/developers-and-admins/digital-marketing-setup/email-channel-management/manage-multiple-email-channels#) | [Get HelpService ID](documentation/developers-and-admins/digital-marketing-setup/email-channel-management/manage-multiple-email-channels#)
Core MVC 5


[✖](documentation/developers-and-admins/digital-marketing-setup/email-channel-management/manage-multiple-email-channels# "Close page link panel") [Copy to clipboard](documentation/developers-and-admins/digital-marketing-setup/email-channel-management/manage-multiple-email-channels#)
