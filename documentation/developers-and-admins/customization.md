# Customization
  * [ Copy page link ](documentation/developers-and-admins/customization#) | [Get HelpService ID](documentation/developers-and-admins/customization#)
Core MVC 5


[✖](documentation/developers-and-admins/customization# "Close page link panel") [Copy to clipboard](documentation/developers-and-admins/customization#)
...
#### [Guidelines for stable customization](documentation/developers-and-admins/customization/stable-customization-guidelines)
...
#### [Integrate custom code](documentation/developers-and-admins/customization/integrate-custom-code)
Learn best practices for adding customizations (classes, class libraries) to Xperience projects.
#### [Run code on application startup](documentation/developers-and-admins/customization/run-code-on-application-startup)
...
Object types control the behavior of database entities managed by the system. Learn how to define custom object types and how to configure them to leverage various system features, such as [CI/CD](documentation/developers-and-admins/ci-cd).
#### [Email customization](documentation/developers-and-admins/customization/email-customization)
