# Email customization
  * [ Copy page link ](documentation/developers-and-admins/customization/email-customization#) | [Get HelpService ID](documentation/developers-and-admins/customization/email-customization#)
Core MVC 5


[✖](documentation/developers-and-admins/customization/email-customization# "Close page link panel") [Copy to clipboard](documentation/developers-and-admins/customization/email-customization#)
...
If the default email functionality does not meet your project’s requirements, you can perform the following types of customization:
  * [Integrate a custom client for sending emails](documentation/developers-and-admins/customization/email-customization#custom-email-client)
  * [Implement completely custom email sending functionality](documentation/developers-and-admins/customization/email-customization#custom-email-sending-functionality)
  * [Extend the default email functionality](documentation/developers-and-admins/customization/email-customization#extend-the-default-email-functionality)
...
See [Custom email clients and channels](documentation/developers-and-admins/customization/email-customization#custom-email-clients-and-channels) if you wish to use different custom email services for individual channels.
...
The default Xperience email sending functionality allows you to add your own custom actions into the process. For example, you can duplicate sent emails and log them to an external location for auditing purposes.
  1. Follow the customization steps described in the [Custom email sending functionality](documentation/developers-and-admins/customization/email-customization#custom-email-sending-functionality) section.
