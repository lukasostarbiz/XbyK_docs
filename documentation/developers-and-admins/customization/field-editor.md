# Field editor
  * [ Copy page link ](documentation/developers-and-admins/customization/field-editor#) | [Get HelpService ID](documentation/developers-and-admins/customization/field-editor#)
Core MVC 5


[✖](documentation/developers-and-admins/customization/field-editor# "Close page link panel") [Copy to clipboard](documentation/developers-and-admins/customization/field-editor#)
...
A field’s main attributes are its:
  ...
  * assigned value editor – the input interface used to edit the field. Dictated by the [UI form component](documentation/developers-and-admins/customization/field-editor#ui-form-components) selected to manage the field (a drop-down list, check box, etc.).
...
[![Field editor interface](docsassets/documentation/field-editor/FieldEditor.png)](https://docs.kentico.com/docsassets/documentation/field-editor/FieldEditor.png)
You can use the field editor to:
  * [Create new fields](documentation/developers-and-admins/customization/field-editor#create-new-fields)
  * [Move fields](documentation/developers-and-admins/customization/field-editor#move-fields)
  * [Delete fields](documentation/developers-and-admins/customization/field-editor#delete-fields)
...
The settings in this section provide a way to configure the parameters defined for the selected [UI form component](documentation/developers-and-admins/customization/field-editor#ui-form-components). The available options depend on the parameters defined for the given form component. See the tooltips of individual parameters for more information.  
Validation  
