# Listing UI page template
  * [ Copy page link ](documentation/developers-and-admins/customization/extend-the-administration-interface/ui-pages/reference-ui-page-templates/listing-ui-page-template#) | [Get HelpService ID](documentation/developers-and-admins/customization/extend-the-administration-interface/ui-pages/reference-ui-page-templates/listing-ui-page-template#)
Core MVC 5


[✖](documentation/developers-and-admins/customization/extend-the-administration-interface/ui-pages/reference-ui-page-templates/listing-ui-page-template# "Close page link panel") [Copy to clipboard](documentation/developers-and-admins/customization/extend-the-administration-interface/ui-pages/reference-ui-page-templates/listing-ui-page-template#)
...
[![Listing page example from the Event log application](docsassets/documentation/listing-ui-page-template/ListingUIPageExample.png)](https://docs.kentico.com/docsassets/documentation/listing-ui-page-template/ListingUIPageExample.png)
...
[![Listing action confirmation dialog](docsassets/documentation/listing-ui-page-template/ListingConfirmationDialog.png)](https://docs.kentico.com/docsassets/documentation/listing-ui-page-template/ListingConfirmationDialog.png)
...
[![Listing action confirmation dialog with a form](docsassets/documentation/listing-ui-page-template/ListingConfirmationDialogWithForm.png)](https://docs.kentico.com/docsassets/documentation/listing-ui-page-template/ListingConfirmationDialogWithForm.png)
...
[![Listing page header subcaption](docsassets/documentation/listing-ui-page-template/listingSubcaption.png)](https://docs.kentico.com/docsassets/documentation/listing-ui-page-template/listingSubcaption.png)
...
[![Mass actions example](docsassets/documentation/listing-ui-page-template/mass_actions.png)](https://docs.kentico.com/docsassets/documentation/listing-ui-page-template/mass_actions.png)
...
Add mass actions using the following methods on `PageConfiguration.MassActions`:
  ...
  * `AddCommandWithConfirmation` – adds a command with execution approved via a [confirmation prompt](documentation/developers-and-admins/customization/extend-the-administration-interface/ui-pages/reference-ui-page-templates/listing-ui-page-template#raise-a-confirmation-prompt).
  * `AddActionWithCustomComponent` – adds an action that is [handled by a custom React component](documentation/developers-and-admins/customization/extend-the-administration-interface/ui-pages/reference-ui-page-templates/listing-ui-page-template#add-actions-handled-by-a-react-component).
...
For advanced action scenarios, you can use a custom React component to handle:
  * [Item and header actions](documentation/developers-and-admins/customization/extend-the-administration-interface/ui-pages/reference-ui-page-templates/listing-ui-page-template#add-header-and-item-actions) (`PageConfiguration.TableActions`, and `PageConfiguration.HeaderActions`)
  * [Mass actions](documentation/developers-and-admins/customization/extend-the-administration-interface/ui-pages/reference-ui-page-templates/listing-ui-page-template#add-mass-actions) (`PageConfiguration.MassActions`)
...
The method takes identical parameters as [AddColumn](documentation/developers-and-admins/customization/extend-the-administration-interface/ui-pages/reference-ui-page-templates/listing-ui-page-template#format-displayed-data), with the following additions:
...
[![Callout example](docsassets/documentation/listing-ui-page-template/ListingPageCallout.png)](https://docs.kentico.com/docsassets/documentation/listing-ui-page-template/ListingPageCallout.png)
...
### Create the filter model
  ...
  3. Decorate the filter properties with the `FilterCondition` attribute (available in the `Kentico.Xperience.Admin.Base.Filters` namespace). The attribute has the following parameters:
     * `BuilderType` – a type implementing `IWhereConditionBuilder`, which generates the where condition applied to the listing for the given property. See [Create filter condition builders](documentation/developers-and-admins/customization/extend-the-administration-interface/ui-pages/reference-ui-page-templates/listing-ui-page-template#create-filter-condition-builders) below for more information.
...
To add a filter to your own custom listing pages, assign an instance of your [filter model](documentation/developers-and-admins/customization/extend-the-administration-interface/ui-pages/reference-ui-page-templates/listing-ui-page-template#create-the-filter-model) class to the UI page’s `PageConfiguration.FilterFormModel` property.
C#
...
SubcaptionComponent |  ISubcaptionComponent |  A component rendered next to the listing page caption. See [Add header subcaption](documentation/developers-and-admins/customization/extend-the-administration-interface/ui-pages/reference-ui-page-templates/listing-ui-page-template#add-header-subcaption).  
Callouts |  List<CalloutConfiguration> |  Configures an optional message box element that can be displayed above the listing. See [Add callouts](documentation/developers-and-admins/customization/extend-the-administration-interface/ui-pages/reference-ui-page-templates/listing-ui-page-template#add-callouts).  
ColumnConfigurations |  IList<ColumnConfiguration> |  See [Format displayed data](documentation/developers-and-admins/customization/extend-the-administration-interface/ui-pages/reference-ui-page-templates/listing-ui-page-template#format-displayed-data).  
FilterFormModel |  object |  An instance of the model class that defines the filter UI for the listing. See [Add a listing filter](documentation/developers-and-admins/customization/extend-the-administration-interface/ui-pages/reference-ui-page-templates/listing-ui-page-template#add-a-listing-filter).  
HeaderActions |  IList<ActionConfiguration> |  Actions available from the table header. See [Add header and item actions](documentation/developers-and-admins/customization/extend-the-administration-interface/ui-pages/reference-ui-page-templates/listing-ui-page-template#add-header-and-item-actions).  
MassActions |  IList<ActionConfiguration> |  Actions available when selecting more than one item in the listing. See [Add mass actions](documentation/developers-and-admins/customization/extend-the-administration-interface/ui-pages/reference-ui-page-templates/listing-ui-page-template#add-mass-actions).  
MaxVisibleRowActions |  int |  Determines the maximum number of [table actions](documentation/developers-and-admins/customization/extend-the-administration-interface/ui-pages/reference-ui-page-templates/listing-ui-page-template#add-header-and-item-actions) displayed for each item. Additional actions are hidden behind an expandable menu.  
PageSizes |  IEnumerable<int> |  Available page sizes for the listing.  
QueryModifiers |  IList<QueryModifier> |  Collection of modifications to the displayed data. See [Modify loaded data](documentation/developers-and-admins/customization/extend-the-administration-interface/ui-pages/reference-ui-page-templates/listing-ui-page-template#modify-loaded-data).  
RowAction |  ActionConfiguration |  Action that occurs when a user clicks on a row in the listing. Set via the `AddEditRowAction` method. See [Add row actions](documentation/developers-and-admins/customization/extend-the-administration-interface/ui-pages/reference-ui-page-templates/listing-ui-page-template#add-row-actions).  
...
TableActions |  IList<ActionConfiguration> |  Actions available for each item in the listing. See [Add header and item actions](documentation/developers-and-admins/customization/extend-the-administration-interface/ui-pages/reference-ui-page-templates/listing-ui-page-template#add-header-and-item-actions).  
