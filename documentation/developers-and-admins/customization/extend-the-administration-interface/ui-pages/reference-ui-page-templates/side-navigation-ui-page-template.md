# Side navigation UI page template
  * [ Copy page link ](documentation/developers-and-admins/customization/extend-the-administration-interface/ui-pages/reference-ui-page-templates/side-navigation-ui-page-template#) | [Get HelpService ID](documentation/developers-and-admins/customization/extend-the-administration-interface/ui-pages/reference-ui-page-templates/side-navigation-ui-page-template#)
Core MVC 5


[✖](documentation/developers-and-admins/customization/extend-the-administration-interface/ui-pages/reference-ui-page-templates/side-navigation-ui-page-template# "Close page link panel") [Copy to clipboard](documentation/developers-and-admins/customization/extend-the-administration-interface/ui-pages/reference-ui-page-templates/side-navigation-ui-page-template#)
This template enables navigation within a single application via a navigation menu.
[![Navigation menu](docsassets/documentation/side-navigation-ui-page-template/SideNavigation.png)](https://docs.kentico.com/docsassets/documentation/side-navigation-ui-page-template/SideNavigation.png)
The navigation menu:
...
The system provides two base classes that can be used to introduce the navigation element into an application:
  1. [ApplicationPage](documentation/developers-and-admins/customization/extend-the-administration-interface/ui-pages/reference-ui-page-templates/side-navigation-ui-page-template#admin-ui-application)
  2. [SecondaryMenuSectionPage](documentation/developers-and-admins/customization/extend-the-administration-interface/ui-pages/reference-ui-page-templates/side-navigation-ui-page-template#custom-page)
...
If you wish to include pages deeper within the application in the navigation menu (i.e., children of children) as well or include navigation for only a specific subsection of pages, see [Custom page](documentation/developers-and-admins/customization/extend-the-administration-interface/ui-pages/reference-ui-page-templates/side-navigation-ui-page-template#custom-page).
### Custom page
...
[![Side navigation](docsassets/documentation/side-navigation-ui-page-template/SideNavigation.png)](https://docs.kentico.com/docsassets/documentation/side-navigation-ui-page-template/SideNavigation.png)
