# Admin UI customization model overview
  * [ Copy page link ](documentation/developers-and-admins/customization/extend-the-administration-interface/admin-ui-customization-model-overview#) | [Get HelpService ID](documentation/developers-and-admins/customization/extend-the-administration-interface/admin-ui-customization-model-overview#)
Core MVC 5


[✖](documentation/developers-and-admins/customization/extend-the-administration-interface/admin-ui-customization-model-overview# "Close page link panel") [Copy to clipboard](documentation/developers-and-admins/customization/extend-the-administration-interface/admin-ui-customization-model-overview#)
This page covers two topics:
  * an overview of the [extension and customization points](documentation/developers-and-admins/customization/extend-the-administration-interface/admin-ui-customization-model-overview#extensions-and-customization-points) available in the admin UI.
  * [the development process](documentation/developers-and-admins/customization/extend-the-administration-interface/admin-ui-customization-model-overview#admin-ui-development-process) for admin UI extensions.


## Extensions and customization points
You can customize the following parts of the Xperience administration: 
  * [UI pages](documentation/developers-and-admins/customization/extend-the-administration-interface/admin-ui-customization-model-overview#ui-pages)
    * [UI page commands](documentation/developers-and-admins/customization/extend-the-administration-interface/admin-ui-customization-model-overview#ui-page-commands)
    * [UI page extenders](documentation/developers-and-admins/customization/extend-the-administration-interface/admin-ui-customization-model-overview#ui-page-extenders)
  * [UI form component framework](documentation/developers-and-admins/customization/extend-the-administration-interface/admin-ui-customization-model-overview#ui-form-component-framework)
...
A single UI page consists of the following components:
  * **Back-end definition** – a class in the Xperience .NET application. Retrieves the data displayed on the client and defines [command handlers](documentation/developers-and-admins/customization/extend-the-administration-interface/admin-ui-customization-model-overview#ui-page-commands) for user interactions with the page.
...
[![UI pages structure overview](docsassets/documentation/admin-ui-customization-model-overview/UIPagesHighlevel.png)](https://docs.kentico.com/docsassets/documentation/admin-ui-customization-model-overview/UIPagesHighlevel.png)
...
[![Basic UI application page structure](docsassets/documentation/admin-ui-customization-model-overview/Simple_UIApplicationPages.png)](https://docs.kentico.com/docsassets/documentation/admin-ui-customization-model-overview/Simple_UIApplicationPages.png)
...
[![Page command overview](docsassets/documentation/admin-ui-customization-model-overview/UIPageCommandHighlevel.png)](https://docs.kentico.com/docsassets/documentation/admin-ui-customization-model-overview/UIPageCommandHighlevel.png)
In the diagram:
...
#### UI page extenders
Page extenders allow you to modify the back-end definition of existing UI pages without directly editing their source code. You can use extenders to add new [commands](documentation/developers-and-admins/customization/extend-the-administration-interface/admin-ui-customization-model-overview#ui-page-commands) or change the configuration of pages. For example, you can add additional columns to an object listing (e.g., to display additional properties of registered users) or specify new actions (e.g., perform a specific operation with selected objects).
...
[![Page extenders overview](docsassets/documentation/admin-ui-customization-model-overview/PageExtenderHighlevel.png)](https://docs.kentico.com/docsassets/documentation/admin-ui-customization-model-overview/PageExtenderHighlevel.png)
...
This section introduces concepts and best practices related to the development of admin UI customizations. Any customization you choose to implement will, in the majority of cases, fall into one of two categories:
  1. [Use existing client components to extend parts of the UI with back-end code.](documentation/developers-and-admins/customization/extend-the-administration-interface/admin-ui-customization-model-overview#back-end-development)
     * In this case, you’re reusing available React components to build the UI, so only changes to the back end are necessary.
  2. [Write new JavaScript modules with custom React components for the client application together with corresponding back-end code.](documentation/developers-and-admins/customization/extend-the-administration-interface/admin-ui-customization-model-overview#client-application-development)
...
The admin UI doesn’t rely on location conventions to detect customizations – the structure of your custom code is therefore entirely up to you. However, there are certain deployment scenarios that benefit from specific setups. See [Custom code location](documentation/developers-and-admins/customization/extend-the-administration-interface/admin-ui-customization-model-overview#custom-code-location) for more information.
...
The following steps summarize the general process:
  ...
  2. Develop required client components. 
     * You can make use of existing Xperience components provided by the [base system modules](documentation/developers-and-admins/customization/extend-the-administration-interface/admin-ui-customization-model-overview#client-application-javascript-modules).
  3. Use the components when writing the corresponding [back-end code](documentation/developers-and-admins/customization/extend-the-administration-interface/admin-ui-customization-model-overview#back-end-development).
