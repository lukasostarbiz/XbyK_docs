# Administration interface UI tests
  * [ Copy page link ](documentation/developers-and-admins/customization/extend-the-administration-interface/administration-interface-ui-tests#) | [Get HelpService ID](documentation/developers-and-admins/customization/extend-the-administration-interface/administration-interface-ui-tests#)
Core MVC 5


[✖](documentation/developers-and-admins/customization/extend-the-administration-interface/administration-interface-ui-tests# "Close page link panel") [Copy to clipboard](documentation/developers-and-admins/customization/extend-the-administration-interface/administration-interface-ui-tests#)
...
[![Example of the data-testid attribute](docsassets/documentation/administration-interface-ui-tests/UItests_testid.png)](https://docs.kentico.com/docsassets/documentation/administration-interface-ui-tests/UItests_testid.png)
...
We recommend using [Cypress](documentation/developers-and-admins/customization/extend-the-administration-interface/administration-interface-ui-tests#cypress) or [Playwright](documentation/developers-and-admins/customization/extend-the-administration-interface/administration-interface-ui-tests#playwright) to UI test the Xperience administration interface.
### Cypress
