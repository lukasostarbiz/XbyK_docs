---
source: https://docs.kentico.com/documentation/developers-and-admins/customization/object-types/object-type-configuration/reference-objecttypeinfo
...
The `ObjectTypeInfo` class has the following types of properties:
  ...
  * [General](#general)
  * [Object type relationships and bindings](#object-type-relationships-and-bindings)
