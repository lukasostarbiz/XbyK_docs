# Enable CI/CD for object types
  * [ Copy page link ](documentation/developers-and-admins/customization/object-types/object-type-configuration/enable-ci-cd-for-object-types#) | [Get HelpService ID](documentation/developers-and-admins/customization/object-types/object-type-configuration/enable-ci-cd-for-object-types#)
Core MVC 5


[✖](documentation/developers-and-admins/customization/object-types/object-type-configuration/enable-ci-cd-for-object-types# "Close page link panel") [Copy to clipboard](documentation/developers-and-admins/customization/object-types/object-type-configuration/enable-ci-cd-for-object-types#)
...
**Important** : To use CI/CD, the code of your custom object type must be located in a separate assembly. See [Integrate custom code](documentation/developers-and-admins/customization/integrate-custom-code) for more information.
  2. Set the `ContinuousIntegrationSettings` property in the initializer of the `TYPEINFO` member.
     ...
     * (Optional) Set other [ContinuousIntegrationSettings properties](documentation/developers-and-admins/customization/object-types/object-type-configuration/enable-ci-cd-for-object-types#continuousintegrationsettings) according to the requirements of your class’s data.
C#
Copy
```
...
```
  ...
  3. (Optional) Set the `SerializationSettings` property of the `TYPEINFO` member. Use a nested initializer to configure the [SerializationSettings properties](documentation/developers-and-admins/customization/object-types/object-type-configuration/enable-ci-cd-for-object-types#serializationsettings).
  4. Save the changes.
