# Extend system object types
  * [ Copy page link ](documentation/developers-and-admins/customization/object-types/extend-system-object-types#) | [Get HelpService ID](documentation/developers-and-admins/customization/object-types/extend-system-object-types#)
Core MVC 5


[✖](documentation/developers-and-admins/customization/object-types/extend-system-object-types# "Close page link panel") [Copy to clipboard](documentation/developers-and-admins/customization/object-types/extend-system-object-types#)
...
Follow these steps to extend a system object:
  ...
  2. Select the **Classes** tab and select one of the [available classes](documentation/developers-and-admins/customization/object-types/extend-system-object-types#customizable-data-classes).
...
Moreover, to learn how to work with the added columns using the API, see [Access added columns via the API](documentation/developers-and-admins/customization/object-types/extend-system-object-types#Extendsystemobjecttypes-API).
...
See the [Customizable data classes](documentation/developers-and-admins/customization/object-types/extend-system-object-types#customizable-data-classes) section for the limitations of each extendable object.
...
Contact |  An object that represents a [contact](documentation/business-users/digital-marketing/contact-management) in the system. This object can be extended using the process described on this page. If you wish to include custom fields in contact field selectors, you need to add the custom fields to the appropriate [UI form](documentation/developers-and-admins/customization/object-types/extend-system-object-types#Extendsystemobjecttypes-UIForms):
  * **Contact edit**
