---
source: https://docs.kentico.com/documentation/developers-and-admins/configuration
...
**[Workflows](/documentation/developers-and-admins/configuration/workflows)**
...
**[Content sync](/documentation/developers-and-admins/configuration/content-sync-configuration)**
...
**[Rich text editor](/documentation/developers-and-admins/configuration/rich-text-editor-configuration)**
Learn how to configure the editor used to insert rich text content in the administration. Define custom toolbars or [register new plugins](/documentation/developers-and-admins/configuration/rich-text-editor-configuration/rich-text-editor-plugins) for the editor.
**[Event log](/documentation/developers-and-admins/configuration/event-log)**
