# Migrate CI/CD repository.config to v2
  * [ Copy page link ](documentation/developers-and-admins/ci-cd/configure-ci-cd-repositories/config-v2-migration#) | [Get HelpService ID](documentation/developers-and-admins/ci-cd/configure-ci-cd-repositories/config-v2-migration#)
Core MVC 5


[✖](documentation/developers-and-admins/ci-cd/configure-ci-cd-repositories/config-v2-migration# "Close page link panel") [Copy to clipboard](documentation/developers-and-admins/ci-cd/configure-ci-cd-repositories/config-v2-migration#)
...
Follow these steps to migrate your existing _repository.config_ files to v2:
  ...
  2. [Update the RepositoryConfiguration element](documentation/developers-and-admins/ci-cd/configure-ci-cd-repositories/config-v2-migration#update-the-repositoryconfiguration-element)
  3. [Include object types to the repository](documentation/developers-and-admins/ci-cd/configure-ci-cd-repositories/config-v2-migration#include-object-types)
  4. [Include content items to the repository](documentation/developers-and-admins/ci-cd/configure-ci-cd-repositories/config-v2-migration#include-content-items)
     * Not required if you don’t use CI/CD to track and synchronize content item data between instances.
  5. [Update object type filters](documentation/developers-and-admins/ci-cd/configure-ci-cd-repositories/config-v2-migration#update-object-type-filters)
  6. [Configure content item filters](documentation/developers-and-admins/ci-cd/configure-ci-cd-repositories/config-v2-migration#configure-content-item-filters)
     * Not required if you don’t use CI/CD to track and synchronize content item data between instances.
...
To control which content items are tracked and synchronized via CI/CD, you must instead use the dedicated content item filtering elements: [Configure content item filters](documentation/developers-and-admins/ci-cd/configure-ci-cd-repositories/config-v2-migration#configure-content-item-filters).
