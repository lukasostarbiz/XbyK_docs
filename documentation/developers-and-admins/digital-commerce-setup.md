# Digital commerce setup
  * [ Copy page link ](documentation/developers-and-admins/digital-commerce-setup#) | [Get HelpService ID](documentation/developers-and-admins/digital-commerce-setup#)
Core MVC 5


[✖](documentation/developers-and-admins/digital-commerce-setup# "Close page link panel") [Copy to clipboard](documentation/developers-and-admins/digital-commerce-setup#)
...
To use the commerce features of Xperience by Kentico:
  1. [Enable](documentation/developers-and-admins/digital-commerce-setup#enable-digital-commerce) and [configure](documentation/developers-and-admins/digital-commerce-setup#configure-commerce-features) the commerce feature.
...
To configure the shopping cart:
  1. Open your Xperience project in Visual Studio and edit the _Program.cs_ file.
  2. [Configure](https://learn.microsoft.com/en-us/aspnet/core/fundamentals/configuration/options) `ShoppingCartOptions` and set the available properties, such as `Expiration`.
