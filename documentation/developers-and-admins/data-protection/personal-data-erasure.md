# Personal data erasure
  * [ Copy page link ](documentation/developers-and-admins/data-protection/personal-data-erasure#) | [Get HelpService ID](documentation/developers-and-admins/data-protection/personal-data-erasure#)
Core MVC 5


[✖](documentation/developers-and-admins/data-protection/personal-data-erasure# "Close page link panel") [Copy to clipboard](documentation/developers-and-admins/data-protection/personal-data-erasure#)
...
**Prerequisite** : Before you start implementing personal data erasure, you need to prepare functionality that identifies and collects the given data. For detailed information, see [Personal data collection](documentation/developers-and-admins/data-protection/personal-data-collection).
  ...
  3. Create custom classes that perform the required delete actions – _Data erasers_. See the [Create data erasers](documentation/developers-and-admins/data-protection/personal-data-erasure#create-data-erasers) section for details.
  ...
  5. Create and register an erasure dialog model to define the options that users can configure when deleting personal data. See [Define the eraser configuration](documentation/developers-and-admins/data-protection/personal-data-erasure#define-the-eraser-configuration).
...
Data erasers are classes that implement the `IPersonalDataEraser` interface (available in the `CMS.DataProtection` namespace). Every implementation must contain the `Erase` method, which processes the following parameters:
  ...
  * `IDictionary<string, object>` – a dictionary containing keys and values serialized from the erasure configuration dialog. See [Define the eraser configuration](documentation/developers-and-admins/data-protection/personal-data-erasure#define-the-eraser-configuration).
...
The keys can be used to access values from the erasure dialog via the dictionary parameter of the `Erase` method in [data erasers](documentation/developers-and-admins/data-protection/personal-data-erasure#create-data-erasers). All of the default options have values of the `bool` type.
...
For an example, see the [Add the eraser configuration](documentation/developers-and-admins/data-protection/personal-data-erasure#add-the-eraser-configuration) section below.
...
Keep in mind that you always need to adjust your own implementation based on the personal data processing used by your project and the legal requirements that you wish to fulfill.
  * [Set up the custom project and data collectors](documentation/developers-and-admins/data-protection/personal-data-erasure#set-up-the-custom-project-and-data-collectors)
  * [Create the data eraser](documentation/developers-and-admins/data-protection/personal-data-erasure#create-the-data-eraser)
  * [Register the eraser](documentation/developers-and-admins/data-protection/personal-data-erasure#register-the-eraser)
  * [Add the eraser configuration](documentation/developers-and-admins/data-protection/personal-data-erasure#add-the-eraser-configuration)
...
[![Deleting contact personal data in the Data protection application](docsassets/documentation/personal-data-erasure/personal_data_erasing.png)](https://docs.kentico.com/docsassets/documentation/personal-data-erasure/personal_data_erasing.png)
