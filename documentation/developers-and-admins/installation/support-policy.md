# Xperience by Kentico support policy
  * [ Copy page link ](documentation/developers-and-admins/installation/support-policy#) | [Get HelpService ID](documentation/developers-and-admins/installation/support-policy#)
Core MVC 5


[✖](documentation/developers-and-admins/installation/support-policy# "Close page link panel") [Copy to clipboard](documentation/developers-and-admins/installation/support-policy#)
