# Update Xperience by Kentico projects
  * [ Copy page link ](documentation/developers-and-admins/installation/update-xperience-by-kentico-projects#) | [Get HelpService ID](documentation/developers-and-admins/installation/update-xperience-by-kentico-projects#)
Core MVC 5


[✖](documentation/developers-and-admins/installation/update-xperience-by-kentico-projects# "Close page link panel") [Copy to clipboard](documentation/developers-and-admins/installation/update-xperience-by-kentico-projects#)
...
**Before updating**
  ...
  * When updating a development project with [Continuous Integration](documentation/developers-and-admins/ci-cd/continuous-integration) enabled, familiarize yourself with the [Update instructions for CI](documentation/developers-and-admins/installation/update-xperience-by-kentico-projects#update-development-projects-with-continuous-integration).


Start by performing the update on a local development instance of your Xperience project:
  1. [Update the project’s Xperience NuGet packages](documentation/developers-and-admins/installation/update-xperience-by-kentico-projects#update-nuget-packages).
  2. [Update the project’s database and files](documentation/developers-and-admins/installation/update-xperience-by-kentico-projects#update-data-and-files).
...
After you successfully test the update locally, you can apply the update to your Xperience application’s production deployment. The following steps outline the general approach, but the exact process will depend on your deployment flow and hosting environment.
  ...
  2. Deploy the [updated web project](documentation/developers-and-admins/installation/update-xperience-by-kentico-projects#update-nuget-packages) to your production or staging environment.
  3. Perform the [database and file update](documentation/developers-and-admins/installation/update-xperience-by-kentico-projects#update-data-and-files) for your production environment. 
...
In addition to updating individual projects, we also recommend updating the templates used for installing new projects. See [Update project templates](documentation/developers-and-admins/installation/update-xperience-by-kentico-projects#update-project-templates).
...
The application will not start until the NuGet package version matches your database version. Continue by [updating your project’s database and files](documentation/developers-and-admins/installation/update-xperience-by-kentico-projects#update-data-and-files).
### Update data and files
After [updating your project’s NuGet packages](documentation/developers-and-admins/installation/update-xperience-by-kentico-projects#update-nuget-packages), update the database and file system using the .NET command-line interface (CLI). This update always targets the new version of the project’s NuGet packages.
...
Xperience by Kentico applications [deployed to the SaaS environment](documentation/developers-and-admins/deployment/deploy-to-the-saas-environment) need to be updated manually. Use the following process:
  1. Update your project in a local development environment to the desired version. 
     * See [Update NuGet packages](documentation/developers-and-admins/installation/update-xperience-by-kentico-projects#update-nuget-packages) and [Update data and files](documentation/developers-and-admins/installation/update-xperience-by-kentico-projects#update-data-and-files).
...
The following steps show an example of the update process for a local development instance using Continuous Integration (suitable for an automated script, etc.).
  ...
  4. [Update the project’s NuGet packages](documentation/developers-and-admins/installation/update-xperience-by-kentico-projects#update-nuget-packages).
  5. Disable CI.
SQL
**SQL**
Copy
...
```
  ...
  6. [Update project data](documentation/developers-and-admins/installation/update-xperience-by-kentico-projects#update-data-and-files).
CMD
**.NET CLI**
Copy
```
