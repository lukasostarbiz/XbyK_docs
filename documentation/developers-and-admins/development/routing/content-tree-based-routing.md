# Content tree-based routing
  * [ Copy page link ](documentation/developers-and-admins/development/routing/content-tree-based-routing#) | [Get HelpService ID](documentation/developers-and-admins/development/routing/content-tree-based-routing#)
Core MVC 5


[✖](documentation/developers-and-admins/development/routing/content-tree-based-routing# "Close page link panel") [Copy to clipboard](documentation/developers-and-admins/development/routing/content-tree-based-routing#)
...
[![Request handling in the content tree-based routing mode](docsassets/documentation/content-tree-based-routing/Routing_SimplifiedFlow.png)](https://docs.kentico.com/docsassets/documentation/content-tree-based-routing/Routing_SimplifiedFlow.png)
...
[![Automatic URL generation illustrated](docsassets/documentation/content-tree-based-routing/Routing_AutomaticRoutingIntro.png)](https://docs.kentico.com/docsassets/documentation/content-tree-based-routing/Routing_AutomaticRoutingIntro.png)
