# Retrieve page URLs
  * [ Copy page link ](documentation/developers-and-admins/development/content-retrieval/retrieve-page-content/retrieve-page-urls#) | [Get HelpService ID](documentation/developers-and-admins/development/content-retrieval/retrieve-page-content/retrieve-page-urls#)
Core MVC 5


[✖](documentation/developers-and-admins/development/content-retrieval/retrieve-page-content/retrieve-page-urls# "Close page link panel") [Copy to clipboard](documentation/developers-and-admins/development/content-retrieval/retrieve-page-content/retrieve-page-urls#)
...
URLs resolved using the service respect the [URL language behavior](documentation/developers-and-admins/development/content-retrieval/retrieve-page-content/retrieve-page-urls#url-language-behavior) set when retrieving the data – it constructs the resulting URLs in the desired language format.
C#
