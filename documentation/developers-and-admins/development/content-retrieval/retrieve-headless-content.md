# Retrieve headless content
  * [ Copy page link ](documentation/developers-and-admins/development/content-retrieval/retrieve-headless-content#) | [Get HelpService ID](documentation/developers-and-admins/development/content-retrieval/retrieve-headless-content#)
Core MVC 5


[✖](documentation/developers-and-admins/development/content-retrieval/retrieve-headless-content# "Close page link panel") [Copy to clipboard](documentation/developers-and-admins/development/content-retrieval/retrieve-headless-content#)
...
Once your headless channels are configured and the content is ready, you can:
  1. [Explore the GraphQL schema and prepare queries for the desired content](documentation/developers-and-admins/development/content-retrieval/retrieve-headless-content#prepare-graphql-queries).
  2. [Retrieve the content from your consuming applications or services by sending requests to the headless channel API endpoint](documentation/developers-and-admins/development/content-retrieval/retrieve-headless-content#retrieve-headless-channel-content).
...
[![Banana Cake Pop tool for crafting GraphQL queries](docsassets/documentation/retrieve-headless-content/graphql_explorer.png)](https://docs.kentico.com/docsassets/documentation/retrieve-headless-content/graphql_explorer.png)
...
In the _Connection Settings_ of the IDE, make sure of the following:
    ...
    * _Authorization_ is configured correctly with a valid [API key](documentation/developers-and-admins/development/content-retrieval/retrieve-headless-content#authentication).
...
To retrieve a specific item, use one of the following approaches:
  * Query a field storing a collection of items and [filter](documentation/developers-and-admins/development/content-retrieval/retrieve-headless-content#filtering) the specific item using the `where` argument.
...
To choose which version (latest or published) of headless content will be retrieved from Xperience, [authenticate](documentation/developers-and-admins/development/content-retrieval/retrieve-headless-content#authentication) your requests with an API key using the corresponding [access type](documentation/developers-and-admins/configuration/headless-channel-management#access-types-of-api-keys).
When retrieving the latest version of headless items, [linked items](documentation/developers-and-admins/development/content-retrieval/retrieve-headless-content#linked-items) are also retrieved in their latest edited version.
...
#### Linked items
Headless items may contain fields that link to other reusable content items or headless items. All linked content types are represented in the GraphQL schema according to the same rules [described above](documentation/developers-and-admins/development/content-retrieval/retrieve-headless-content#basic-querying), with both single item and collection types. This includes content types that are linked recursively through the fields of other linked types.
...
Retrieved URLs of content item assets in their [latest version](documentation/developers-and-admins/development/content-retrieval/retrieve-headless-content#retrieval-of-latest-or-published-headless-content), both relative and absolute, are valid only for 10 minutes. If you want to access a content item asset after this limit, you need to retrieve the asset again.
#### Taxonomies
...
You can combine filtering with [sorting](documentation/developers-and-admins/development/content-retrieval/retrieve-headless-content#sorting) arguments.
GraphQL
...
You can also filter collections based on [taxonomy fields](documentation/developers-and-admins/development/content-retrieval/retrieve-headless-content#taxonomies) using the following operations:
...
You can combine sorting with [filtering](documentation/developers-and-admins/development/content-retrieval/retrieve-headless-content#filtering) arguments.
GraphQL
...
You can combine pagination with [sorting](documentation/developers-and-admins/development/content-retrieval/retrieve-headless-content#sorting) and [filtering](documentation/developers-and-admins/development/content-retrieval/retrieve-headless-content#filtering) arguments.
GraphQL
...
_https://example.com/graphql/09114e33-7578-4152-af81-62677bcca740_
To learn how to find or configure a headless channel’s API endpoint, see [Headless channel management](documentation/developers-and-admins/configuration/headless-channel-management).
A standard GraphQL POST request has the [Content-Type](https://developer.mozilla.org/en-US/docs/Web/HTTP/Headers/Content-Type) header set to **application/json** , and includes a JSON-encoded body containing a [GraphQL query](documentation/developers-and-admins/development/content-retrieval/retrieve-headless-content#prepare-graphql-queries).
JSON
**JSON request format**
Copy
```
