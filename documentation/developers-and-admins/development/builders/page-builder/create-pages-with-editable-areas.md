# Create pages with editable areas
  * [ Copy page link ](documentation/developers-and-admins/development/builders/page-builder/create-pages-with-editable-areas#) | [Get HelpService ID](documentation/developers-and-admins/development/builders/page-builder/create-pages-with-editable-areas#)
Core MVC 5


[✖](documentation/developers-and-admins/development/builders/page-builder/create-pages-with-editable-areas# "Close page link panel") [Copy to clipboard](documentation/developers-and-admins/development/builders/page-builder/create-pages-with-editable-areas#)
...
[![Page builder structure](docsassets/documentation/create-pages-with-editable-areas/EditableAreas.png)](https://docs.kentico.com/docsassets/documentation/create-pages-with-editable-areas/EditableAreas.png)
## Create a page
