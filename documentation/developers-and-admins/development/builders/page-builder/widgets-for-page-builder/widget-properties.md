# Widget properties
  * [ Copy page link ](documentation/developers-and-admins/development/builders/page-builder/widgets-for-page-builder/widget-properties#) | [Get HelpService ID](documentation/developers-and-admins/development/builders/page-builder/widgets-for-page-builder/widget-properties#)
Core MVC 5


[✖](documentation/developers-and-admins/development/builders/page-builder/widgets-for-page-builder/widget-properties# "Close page link panel") [Copy to clipboard](documentation/developers-and-admins/development/builders/page-builder/widgets-for-page-builder/widget-properties#)
...
Use the following process to develop properties for a widget:
  1. [Create a model class that defines the widget properties](documentation/developers-and-admins/development/builders/page-builder/widgets-for-page-builder/widget-properties#create-property-models).
  2. Allow content editors to modify the widget properties: 
     * [Define the configuration dialog](documentation/developers-and-admins/development/builders/page-builder/widgets-for-page-builder/widget-properties#define-the-configuration-dialog)
...
You can combine the configuration dialog and inline editors in a single widget.
  1. [Handle the properties in the widget’s code](documentation/developers-and-admins/development/builders/page-builder/widgets-for-page-builder/widget-properties#handle-properties-in-widget-code).
  2. (Optional) [Add support for POST actions](documentation/developers-and-admins/development/builders/page-builder/widgets-for-page-builder/widget-properties#access-widget-properties-in-post-actions).
