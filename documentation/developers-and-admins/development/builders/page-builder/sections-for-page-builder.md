# Sections for Page Builder
  * [ Copy page link ](documentation/developers-and-admins/development/builders/page-builder/sections-for-page-builder#) | [Get HelpService ID](documentation/developers-and-admins/development/builders/page-builder/sections-for-page-builder#)
Core MVC 5


[✖](documentation/developers-and-admins/development/builders/page-builder/sections-for-page-builder# "Close page link panel") [Copy to clipboard](documentation/developers-and-admins/development/builders/page-builder/sections-for-page-builder#)
...
On a basic level, Page Builder sections are pieces of HTML output code containing widget zones. You can develop two types of sections:
  * [Basic sections](documentation/developers-and-admins/development/builders/page-builder/sections-for-page-builder#basic-sections) – define their layout in a single partial view.
  * [Sections based on a view component](documentation/developers-and-admins/development/builders/page-builder/sections-for-page-builder#sections-based-on-a-view-component) – define their logic in an ASP.NET Core [view component](https://docs.microsoft.com/en-us/aspnet/core/mvc/views/view-components) . Recommended for more complex sections that require non-trivial interactions with the application’s business layer.
...
Use the following process to develop a section:
  1. Create a partial view with code that defines the required layout. 
     ...
     * We recommend storing section views in the _~/Components/Sections/ <SectionName>_ folder, and using a view name that matches the **identifier** assigned to the section [upon its registration](documentation/developers-and-admins/development/builders/page-builder/sections-for-page-builder#register-sections) prefixed with the underscore (_‘_’_) character.
     * Alternatively, you can use any required view location or name, and then specify it when registering the section.
  2. Register the section into the system. See [Register sections](documentation/developers-and-admins/development/builders/page-builder/sections-for-page-builder#register-sections).
...
```
  ...
  6. Register the section into the system. See [Register sections](documentation/developers-and-admins/development/builders/page-builder/sections-for-page-builder#register-sections).
...
To register [basic sections](documentation/developers-and-admins/development/builders/page-builder/sections-for-page-builder#basic-sections) (without a view component class), we recommend adding the assembly attributes to a dedicated code file. For example, you can create a file named **ComponentRegister.cs** in your project’s _~/Components_ folder and use it to register your Page Builder components. For basic sections, specify the following attribute parameters:
...
For [sections based on a view component](documentation/developers-and-admins/development/builders/page-builder/sections-for-page-builder#sections-based-on-a-view-component), you can add the assembly attribute directly into the view component code file. In this case, specify the following attribute parameters:
  * `Identifier` – the unique identifier of the section. We recommend using a unique prefix in your section identifiers to prevent conflicts when deploying sections to other projects, for example matching your company’s name.
...
[![Transfer of widgets between section types](docsassets/documentation/sections-for-page-builder/named-zones.png)](https://docs.kentico.com/docsassets/documentation/sections-for-page-builder/named-zones.png)
cshtml
