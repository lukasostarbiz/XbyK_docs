# Page Builder
  * [ Copy page link ](documentation/developers-and-admins/development/builders/page-builder#) | [Get HelpService ID](documentation/developers-and-admins/development/builders/page-builder#)
Core MVC 5


[✖](documentation/developers-and-admins/development/builders/page-builder# "Close page link panel") [Copy to clipboard](documentation/developers-and-admins/development/builders/page-builder#)
...
[![Page builder](docsassets/documentation/page-builder/pageBuilder_home.png)](https://docs.kentico.com/docsassets/documentation/page-builder/pageBuilder_home.png)
To start using Page Builder:
  1. [Enable the Page Builder feature](documentation/developers-and-admins/development/builders/page-builder#enable-the-page-builder-feature)
...
[![Page builder structure](docsassets/documentation/page-builder/EditableAreas.png)](https://docs.kentico.com/docsassets/documentation/page-builder/EditableAreas.png)
#### Editable areas
