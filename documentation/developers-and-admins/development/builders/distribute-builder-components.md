# Distribute builder components
  * [ Copy page link ](documentation/developers-and-admins/development/builders/distribute-builder-components#) | [Get HelpService ID](documentation/developers-and-admins/development/builders/distribute-builder-components#)
Core MVC 5


[✖](documentation/developers-and-admins/development/builders/distribute-builder-components# "Close page link panel") [Copy to clipboard](documentation/developers-and-admins/development/builders/distribute-builder-components#)
...
On this page, you can read about best practices related to distributing builder components. See the following sections for information about individual types of components:
  * [Widgets](documentation/developers-and-admins/development/builders/distribute-builder-components#widgets)
  * [Inline property editors](documentation/developers-and-admins/development/builders/distribute-builder-components#inline-property-editors)
  * [Page Builder sections](documentation/developers-and-admins/development/builders/distribute-builder-components#page-builder-sections)
  * [Page templates](documentation/developers-and-admins/development/builders/distribute-builder-components#page-templates)
  * [Form components](documentation/developers-and-admins/development/builders/distribute-builder-components#form-components)
  * [Form Builder sections](documentation/developers-and-admins/development/builders/distribute-builder-components#form-builder-sections)
  * [Personalization condition types with a custom configuration dialog](documentation/developers-and-admins/development/builders/distribute-builder-components#personalization-condition-types-with-a-custom-configuration-dialog)
  * [Single class components](documentation/developers-and-admins/development/builders/distribute-builder-components#single-class-components)
