# Form sections
  * [ Copy page link ](documentation/developers-and-admins/development/builders/form-builder/form-sections#) | [Get HelpService ID](documentation/developers-and-admins/development/builders/form-builder/form-sections#)
Core MVC 5


[✖](documentation/developers-and-admins/development/builders/form-builder/form-sections# "Close page link panel") [Copy to clipboard](documentation/developers-and-admins/development/builders/form-builder/form-sections#)
...
[![Transfer of widgets between section types](docsassets/documentation/form-sections/named-zones.png)](https://docs.kentico.com/docsassets/documentation/form-sections/named-zones.png)
cshtml
...
```
  ...
  4. Prepare the [partial view](documentation/developers-and-admins/development/builders/form-builder/form-sections#implement-form-section-views) that defines the section’s layout.
...
```
  ...
  6. [Register the section](documentation/developers-and-admins/development/builders/form-builder/form-sections#register-form-sections) into the system.
...
For [sections based on a view component](documentation/developers-and-admins/development/builders/form-builder/form-sections#implement-form-section-view-components) , you can add the assembly attribute directly into the view component code file. In this case, specify the following attribute parameters:
