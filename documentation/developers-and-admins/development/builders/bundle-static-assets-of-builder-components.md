# Bundle static assets of builder components
  * [ Copy page link ](documentation/developers-and-admins/development/builders/bundle-static-assets-of-builder-components#) | [Get HelpService ID](documentation/developers-and-admins/development/builders/bundle-static-assets-of-builder-components#)
Core MVC 5


[✖](documentation/developers-and-admins/development/builders/bundle-static-assets-of-builder-components# "Close page link panel") [Copy to clipboard](documentation/developers-and-admins/development/builders/bundle-static-assets-of-builder-components#)
...
See the [Bundles](documentation/developers-and-admins/development/builders/bundle-static-assets-of-builder-components#bundles) section for detailed information about the default bundle names and locations.
     * (Optional) If you do not wish to use the default bundle names and locations, you can [specify a custom location and sources for individual bundles](documentation/developers-and-admins/development/builders/bundle-static-assets-of-builder-components#customize-bundle-locations-and-sources).
...
**Example**
The [Sample bundling and minification process](documentation/developers-and-admins/development/builders/bundle-static-assets-of-builder-components#sample-bundling-and-minification-process) section demonstrates how to configure a simple bundling process using the [Grunt](https://gruntjs.com/) automation library. The process bundles files from the default source directories and places the created bundles into the default locations.
...
Each bundle has a preconfigured default source directory (listed in the [Bundles](documentation/developers-and-admins/development/builders/bundle-static-assets-of-builder-components#bundles) section). If necessary, you can add additional source directories via [provided options classes](documentation/developers-and-admins/development/builders/bundle-static-assets-of-builder-components#add-source-directories-for-a-bundle).
### Bundle caching
...
The following sections describe the default names and locations required for individual bundle types:
  * [Page Builder component bundles](documentation/developers-and-admins/development/builders/bundle-static-assets-of-builder-components#page-builder-bundles)
  * [Form Builder component bundles](documentation/developers-and-admins/development/builders/bundle-static-assets-of-builder-components#form-builder-bundles)
...
You can customize the location where Xperience expects bundles and their contents (to be linked individually, in case the [bundle is not found](documentation/developers-and-admins/development/builders/bundle-static-assets-of-builder-components#handling-missing-bundles)). For this purpose, the system provides the `PageBuilderBundlesOptions` and `FormBuilderBundlesOptions` options classes. 
The options classes expose properties that allow you to configure the corresponding bundle:
  * **PageBuilderBundlesOptions**
    * [PageBuilderAdminScripts](documentation/developers-and-admins/development/builders/bundle-static-assets-of-builder-components#Bundlestaticassetsofbuildercomponents-PBSA)
    * [PageBuilderAdminStyles](documentation/developers-and-admins/development/builders/bundle-static-assets-of-builder-components#Bundlestaticassetsofbuildercomponents-PBCSSA)
    * [PageBuilderPublicScripts](documentation/developers-and-admins/development/builders/bundle-static-assets-of-builder-components#Bundlestaticassetsofbuildercomponents-PBSLS)
    * [PageBuilderPublicStyles](documentation/developers-and-admins/development/builders/bundle-static-assets-of-builder-components#Bundlestaticassetsofbuildercomponents-PBCSSLS)
  * **FormBuilderBundlesOptions**
    * [FormBuilderAdminStyles](documentation/developers-and-admins/development/builders/bundle-static-assets-of-builder-components#Bundlestaticassetsofbuildercomponents-FBCSSA)
    * [FormBuilderPublicScripts](documentation/developers-and-admins/development/builders/bundle-static-assets-of-builder-components#Bundlestaticassetsofbuildercomponents-FBS)
    * [FormBuilderPublicStyles](documentation/developers-and-admins/development/builders/bundle-static-assets-of-builder-components#Bundlestaticassetsofbuildercomponents-FBCSSLS)
...
These properties can be configured using the conventional ASP.NET Core [options pattern](https://docs.microsoft.com/en-us/aspnet/core/fundamentals/configuration/options). See the following sections for details about specific configuration options:
  * [Change the bundle location and name](documentation/developers-and-admins/development/builders/bundle-static-assets-of-builder-components#change-the-bundle-location-and-name)
  * [Add source directories for a bundle](documentation/developers-and-admins/development/builders/bundle-static-assets-of-builder-components#add-source-directories-for-a-bundle)
  * [Link jQuery as part of builder scripts](documentation/developers-and-admins/development/builders/bundle-static-assets-of-builder-components#link-jquery-as-part-of-builder-scripts)
  * [Use a different jQuery version](documentation/developers-and-admins/development/builders/bundle-static-assets-of-builder-components#use-a-different-jquery-version)
...
For example, the following code demonstrates how to set a custom location for the [FormBuilderPublicStyles](documentation/developers-and-admins/development/builders/bundle-static-assets-of-builder-components#Bundlestaticassetsofbuildercomponents-FBCSSLS) bundle within the application’s startup class:
C#
**Program.cs**
Copy
```
...
If the default directories (described in the [page](documentation/developers-and-admins/development/builders/bundle-static-assets-of-builder-components#page-builder-bundles) and [form](documentation/developers-and-admins/development/builders/bundle-static-assets-of-builder-components#form-builder-bundles) builder bundles sections) aren’t sufficient, the options class allows you to add additional source directories for each bundle. The system links all files from the specified directories if a corresponding bundle is not found. See [Handling missing bundles](documentation/developers-and-admins/development/builders/bundle-static-assets-of-builder-components#handling-missing-bundles).
