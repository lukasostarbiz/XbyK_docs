# Data caching
  * [ Copy page link ](documentation/developers-and-admins/development/caching/data-caching#) | [Get HelpService ID](documentation/developers-and-admins/development/caching/data-caching#)
Core MVC 5


[✖](documentation/developers-and-admins/development/caching/data-caching# "Close page link panel") [Copy to clipboard](documentation/developers-and-admins/development/caching/data-caching#)
...
The `IContentRetriever` [API](documentation/developers-and-admins/development/caching/data-caching#caching-content-retrieval-in-web-app-contexts) provides implicit caching for content retrieval operations. This removes the need to manually wrap data retrieval logic in a caching service, which simplifies your code.
...
See the following sections for examples of usage:
  * [Cache content items](documentation/developers-and-admins/development/caching/data-caching#cache-reusable-content-items-and-pages)
  * [Cache general objects](documentation/developers-and-admins/development/caching/data-caching#cache-general-objects)
...
The example caches the retrieved pages and ensures the following [cache behavior](documentation/developers-and-admins/development/caching/data-caching#cachesettings):
  * **Duration:** 5 minutes
...
[![Example article content model](docsassets/documentation/data-caching/CachingArticleModel.jpg)](https://docs.kentico.com/docsassets/documentation/data-caching/CachingArticleModel.jpg)
Then the following snippet shows a sample implementation of the `GetCacheDependency` method that creates dependencies on the retrieved articles as well as their linked items. The example uses `CacheDependencyBuilder` to create dependencies on the retrieved pages and `IWebPageLinkedItemsDependencyAsyncRetriever` to generate dependency cache keys for all linked content items of the page up to the specified depth. See [Cache dependencies](documentation/developers-and-admins/development/caching/cache-dependencies) and [Cache dependencies on linked content items](documentation/developers-and-admins/development/caching/data-caching#cache-dependencies-on-linked-content-items) for details about the respective APIs.
C#
...
See [Set cache dependencies](documentation/developers-and-admins/development/caching/data-caching#set-cache-dependencies) for an example of usage.
...
[ContentRetriever API](documentation/developers-and-admins/development/caching/data-caching#caching-content-retrieval-in-web-app-contexts) automatically detects preview mode and disables caching accordingly when retrieving content, preventing cache bloat without additional configuration.
C#
**Caching and preview**
Copy
```
