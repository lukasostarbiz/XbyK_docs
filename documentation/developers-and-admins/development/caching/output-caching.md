# Output caching
  * [ Copy page link ](documentation/developers-and-admins/development/caching/output-caching#) | [Get HelpService ID](documentation/developers-and-admins/development/caching/output-caching#)
Core MVC 5


[✖](documentation/developers-and-admins/development/caching/output-caching# "Close page link panel") [Copy to clipboard](documentation/developers-and-admins/development/caching/output-caching#)
...
Xperience supports caching for standard page content and the output of [Page Builder](documentation/developers-and-admins/development/builders/page-builder) [widgets](documentation/developers-and-admins/development/builders/page-builder/widgets-for-page-builder).
  * [Caching page output](documentation/developers-and-admins/development/caching/output-caching#cache-page-output)
  * [Caching the output of Page Builder widgets](documentation/developers-and-admins/development/caching/output-caching#cache-the-output-of-page-builder-widgets)
...
Specify cache dependencies by adding the `cache-dependency` Tag Helper within sections encapsulated by the `cache` tag. The helper provides two attributes:
  ...
  * `enabled` – indicates whether the dependencies get injected. Enabled by default. See [Control cache dependency injection](documentation/developers-and-admins/development/caching/output-caching#control-cache-dependency-injection).
...
The following examples demonstrate how you can vary the output cache:
  * [Page template content](documentation/developers-and-admins/development/caching/output-caching#page-template-content)
  * [Selected cookie level](documentation/developers-and-admins/development/caching/output-caching#request-cookie-levels)
...
You have configured caching for your widget. To further customize the caching behavior, you can:
  * [Specify additional cache dependencies for the widget](documentation/developers-and-admins/development/caching/output-caching#add-custom-cache-dependencies)
  * [Configure caching for personalized content](documentation/developers-and-admins/development/caching/output-caching#cache-personalized-widget-output)
...
`VaryByOptionTypes` |  Type[] |  An array of `System.Type` values referencing custom _vary by_ implementations. You can implement custom vary by conditions that suit your particular scenarios. See [Implement custom personalization options](documentation/developers-and-admins/development/caching/output-caching#implement-custom-personalization-options).  
C#
