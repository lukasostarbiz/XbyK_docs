# AIRA
  * [ Copy page link ](documentation/business-users/aira#) | [Get HelpService ID](documentation/business-users/aira#)
Core MVC 5


[✖](documentation/business-users/aira# "Close page link panel") [Copy to clipboard](documentation/business-users/aira#)
...
AIRA is an AI-powered agent integrated into Xperience by Kentico. It helps users automate and streamline marketing and content management tasks through AI-driven features, and provides [in-product guidance](documentation/business-users/aira#aira-in-product-guidance) on best practices.
...
[![Refining a paragraph in the rich text editor](docsassets/documentation/aira/AIRA_RTE_Refinements.png)](https://docs.kentico.com/docsassets/documentation/aira/AIRA_RTE_Refinements.png)
...
Once AIRA features are [configured](documentation/developers-and-admins/configuration/aira-configuration#add-aira-features-to-your-content-types) for your email content types, you can start generating content.
  ...
  3. Select the **AIRA** (  
[![Generating email content](docsassets/documentation/aira/Emails_AIRA_features.png)](https://docs.kentico.com/docsassets/documentation/aira/Emails_AIRA_features.png)
  4. Continue according to the type of the email field: 
     * [Email subject fields](documentation/business-users/aira#email-subject-fields)
     * [Email content fields](documentation/business-users/aira#email-content-fields)
...
[![Generating email subject suggestions](docsassets/documentation/aira/Emails_AIRA_subject.png)](https://docs.kentico.com/docsassets/documentation/aira/Emails_AIRA_subject.png)
...
[![Generate content for emails](docsassets/documentation/aira/Emails_AIRA_content.png)](https://docs.kentico.com/docsassets/documentation/aira/Emails_AIRA_content.png)
...
For _Rich text editor_ fields, you can also adjust the resulting text at any time using [rich text editor refinements](documentation/business-users/aira#rich-text-editor-refinements).