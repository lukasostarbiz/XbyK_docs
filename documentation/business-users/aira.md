...
[![Rich text refinements in Page Builder](/docsassets/documentation/aira/RTE_refinements_builders.png)](/docsassets/documentation/aira/RTE_refinements_builders.png)
  1. Choose one of the refinement options (make text shorter, improve spelling and grammar, etc.).
  2. The text is refined in place. 
     * If you choose the _Apply custom prompt_ option, describe the desired changes in the AIRA chat window. Then copy (


You can apply further refinements by selecting other options. Use _Undo_ (_Redo_ (
