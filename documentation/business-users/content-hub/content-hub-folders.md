# Content hub folders
  * [ Copy page link ](documentation/business-users/content-hub/content-hub-folders#) | [Get HelpService ID](documentation/business-users/content-hub/content-hub-folders#)
Core MVC 5


[✖](documentation/business-users/content-hub/content-hub-folders# "Close page link panel") [Copy to clipboard](documentation/business-users/content-hub/content-hub-folders#)
Content hub allows you to create folders that help organize and efficiently navigate through [content items](documentation/business-users/content-hub/content-items). The following types of folders are available:
  * [Smart folders](documentation/business-users/content-hub/content-hub-folders#smart-folders)
  * [Content folders](documentation/business-users/content-hub/content-hub-folders#content-folders)
...
Smart folders can be used to organize content items in the administration interface, and also to dynamically control [content delivery](documentation/business-users/content-hub/content-hub-folders#enable-content-delivery-for-smart-folders) and filter content. Out-of-the-box, Xperience allows dynamic content delivery via smart folders for website channels (headless and email channels are currently not supported).
### Create smart folders
To create a smart folder:
  1. Select the **Create new smart folder** (_Smart folders_ section in the left-side panel.  
[![Creating a new smart folder](docsassets/documentation/content-hub-folders/CH_create_new_smart_folder.png)](https://docs.kentico.com/docsassets/documentation/content-hub-folders/CH_create_new_smart_folder.png)
  2. Choose whether to **Enable dynamic content delivery** for the smart folder.
     * See [Enable content delivery for smart folders](documentation/business-users/content-hub/content-hub-folders#enable-content-delivery-for-smart-folders) for detailed information.
...
[![Saving a filter as a new smart folder](docsassets/documentation/content-hub-folders/CH_save_filter_as_smart_folder.png)](https://docs.kentico.com/docsassets/documentation/content-hub-folders/CH_save_filter_as_smart_folder.png)
...
When creating new smart folders, you can save time by reusing the filter conditions of an existing folder.
  ...
  2. Select **Clone**.
  3. Choose whether to [Enable dynamic content delivery](documentation/business-users/content-hub/content-hub-folders#enable-content-delivery-for-smart-folders) for the new folder.
...
[![Saving adjusted filter conditions for a smart folder](docsassets/documentation/content-hub-folders/CH_save_changes_smart_folder.png)](https://docs.kentico.com/docsassets/documentation/content-hub-folders/CH_save_changes_smart_folder.png)
...
To enable dynamic content delivery for a smart folder:
  * When [creating new smart folders](documentation/business-users/content-hub/content-hub-folders#create-smart-folders), select the **Enable dynamic content delivery** option at the top of the filter conditions.
...
[![Selecting a smart folder](docsassets/documentation/content-hub-folders/CH_smart_folder_selector.png)](https://docs.kentico.com/docsassets/documentation/content-hub-folders/CH_smart_folder_selector.png)
...
Unlike with [smart folders](documentation/business-users/content-hub/content-hub-folders#smart-folders), content items are placed into content folders manually, and each item can only be located in one content folder.
...
[![Overview of Content folder actions](docsassets/documentation/content-hub-folders/CH_folder_actions.png)](https://docs.kentico.com/docsassets/documentation/content-hub-folders/CH_folder_actions.png)
