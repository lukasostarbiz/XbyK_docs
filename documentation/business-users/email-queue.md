# Email queue
  * [ Copy page link ](documentation/business-users/email-queue#) | [Get HelpService ID](documentation/business-users/email-queue#)
Core MVC 5


[✖](documentation/business-users/email-queue# "Close page link panel") [Copy to clipboard](documentation/business-users/email-queue#)
...
[![Viewing the email queue](docsassets/documentation/email-queue/Email_Queue.png)](https://docs.kentico.com/docsassets/documentation/email-queue/Email_Queue.png)
