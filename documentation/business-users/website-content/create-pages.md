---
source: https://docs.kentico.com/documentation/business-users/website-content/create-pages
...
# Create pages
[Content of your websites](/documentation/business-users/website-content) is stored in pages. You can create new pages from the ground up or [clone](#clone-a-page) existing ones.
## Create a new page
...
[![Create a new page](/docsassets/documentation/create-pages/create_page_new_page.png)](/docsassets/documentation/create-pages/create_page_new_page.png)
  4. Enter page name.
...
[![Clone page](/docsassets/documentation/create-pages/clone_page.png)](/docsassets/documentation/create-pages/clone_page.png)
