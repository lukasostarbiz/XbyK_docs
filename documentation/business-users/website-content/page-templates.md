# Page templates
  * [ Copy page link ](documentation/business-users/website-content/page-templates#) | [Get HelpService ID](documentation/business-users/website-content/page-templates#)
Core MVC 5


[✖](documentation/business-users/website-content/page-templates# "Close page link panel") [Copy to clipboard](documentation/business-users/website-content/page-templates#)
...
Editors can save this page as a _preset page template_ with the Page Builder content created on the page. See [Save pages as preset page templates](documentation/business-users/website-content/page-templates#save-pages-as-preset-page-templates).
...
[![Template configuration dialog location](docsassets/documentation/page-templates/templateconfiguration.png)](https://docs.kentico.com/docsassets/documentation/page-templates/templateconfiguration.png)
  3. Configure any available properties in the dialog.  
[![Template configuration dialog example](docsassets/documentation/page-templates/templateconfigurationdialog.png)](https://docs.kentico.com/docsassets/documentation/page-templates/templateconfigurationdialog.png)
  4. **Apply** the changes.
...
[![Change template button location](docsassets/documentation/page-templates/opentemplateselection.png)](https://docs.kentico.com/docsassets/documentation/page-templates/opentemplateselection.png)
  3. Select one of the available page templates.  
[![Template selection dialog](docsassets/documentation/page-templates/templateselection.png)](https://docs.kentico.com/docsassets/documentation/page-templates/templateselection.png)
...
[![Save as preset template](docsassets/documentation/page-templates/SaveAsTemplate.png)](https://docs.kentico.com/docsassets/documentation/page-templates/SaveAsTemplate.png)
...
[![Save as preset template - dialog](docsassets/documentation/page-templates/SaveAsPresetTemplate-dialog.png)](https://docs.kentico.com/docsassets/documentation/page-templates/SaveAsPresetTemplate-dialog.png)
...
[![List of preset page templates](docsassets/documentation/page-templates/PresetPageTemplates.png)](https://docs.kentico.com/docsassets/documentation/page-templates/PresetPageTemplates.png)
...
Direct editing of preset page templates is not currently supported. In order to change a template, you need to [delete](documentation/business-users/website-content/page-templates#delete-preset-page-templates) it and [save](documentation/business-users/website-content/page-templates#save-pages-as-preset-page-templates) it again.
