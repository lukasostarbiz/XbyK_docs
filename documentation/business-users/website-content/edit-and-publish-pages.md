---
source: https://docs.kentico.com/documentation/business-users/website-content/edit-and-publish-pages
...
[![Edit page button](/docsassets/documentation/edit-and-publish-pages/edit_button.png)](/docsassets/documentation/edit-and-publish-pages/edit_button.png)
     * When a page is _Unpublished_ , select **Create new version** to move the page to the _Draft_ step.  
[![Create new version button](/docsassets/documentation/edit-and-publish-pages/create_new_version_button.png)](/docsassets/documentation/edit-and-publish-pages/create_new_version_button.png)
  4. In the **Content** view mode, edit the fields of the page.
  5. **Save** the changes.


Note that the changes are not visible on the live site until you [publish](#publish-pages) the page.
...
Depending on the configuration of your project, pages may support taxonomies and tags.
  1. [Edit](#edit-content-of-structured-pages) a page that has a field with the tag selector.
  2. **Select tags** that describe the page.
  3. **Save** the changes.


[![Tag selector](/docsassets/documentation/edit-and-publish-pages/tag_selector.png)](/docsassets/documentation/edit-and-publish-pages/tag_selector.png)
...
[![Publish button](/docsassets/documentation/edit-and-publish-pages/publish_button.png)](/docsassets/documentation/edit-and-publish-pages/publish_button.png)
  5. Choose when you want to publish the page: 
     * **Publish now**
     * **Schedule publish** – select a date and time in the future. The system will automatically publish the page at the given time (see [Scheduled publishing](#scheduled-publishing)).
  6. Select **Confirm**. 
...
[![Scheduling the time when a page will be published](/docsassets/documentation/edit-and-publish-pages/pages_schedule_publish.png)](/docsassets/documentation/edit-and-publish-pages/pages_schedule_publish.png)
...
[![Discard button](/docsassets/documentation/edit-and-publish-pages/pages_revert_to_published.png)](/docsassets/documentation/edit-and-publish-pages/pages_revert_to_published.png)
## Unpublish pages
...
If you unpublish a page targeted by redirects, the redirect configuration of this page can affect other pages. See section [Unpublishing or deleting pages targeted by redirects](#unpublishing-or-deleting-pages-targeted-by-redirects) for details.
To unpublish a page (and thus remove it from the live site):
  ...
  2. In the content tree, select the page that you want to unpublish. 
     * You can only unpublish pages that are already [published](#publish-pages) or [scheduled to be published](#scheduled-publishing) in the future.
  3. Expand the **Edit page** menu and select **Unpublish options**.  
[![Unpublish a page](/docsassets/documentation/edit-and-publish-pages/unpublish_button.png)](/docsassets/documentation/edit-and-publish-pages/unpublish_button.png)
...
---|---  
Serve content in fallback language |  The target of the redirect stays the same, and the content in a fallback language is automatically served. This behavior can be disrupted by further actions, see [Redirects to untranslated pages](#redirects-to-untranslated-pages).  
...
[![Rename pages button](/docsassets/documentation/edit-and-publish-pages/rename_pages.png)](/docsassets/documentation/edit-and-publish-pages/rename_pages.png)
...
[![Reordering pages](/docsassets/documentation/edit-and-publish-pages/content-tree-reorder-pages.png)](/docsassets/documentation/edit-and-publish-pages/content-tree-reorder-pages.png)
