# Translate pages
  * [ Copy page link ](documentation/business-users/website-content/translate-pages#) | [Get HelpService ID](documentation/business-users/website-content/translate-pages#)
Core MVC 5


[✖](documentation/business-users/website-content/translate-pages# "Close page link panel") [Copy to clipboard](documentation/business-users/website-content/translate-pages#)
...
[![Language switcher in header bar](docsassets/documentation/translate-pages/header_bar_language_switcher.png)](https://docs.kentico.com/docsassets/documentation/translate-pages/header_bar_language_switcher.png)
...
Untranslated pages are visually marked by the _Not translated_ (
  5. Enter the translated page name. You can now choose one of the following options:
     ...
     * **Translate using AIRA** see [Translate using AIRA](documentation/business-users/website-content/translate-pages#translate-using-aira) for more information.  
[![Page translation](docsassets/documentation/translate-pages/translate_page.png)](https://docs.kentico.com/docsassets/documentation/translate-pages/translate_page.png)
  6. Select **Continue**.
