# Headless content
  * [ Copy page link ](documentation/business-users/headless-content#) | [Get HelpService ID](documentation/business-users/headless-content#)
Core MVC 5


[✖](documentation/business-users/headless-content# "Close page link panel") [Copy to clipboard](documentation/business-users/headless-content#)
...
[![Headless items](docsassets/documentation/headless-content/headless_items_overview.png)](https://docs.kentico.com/docsassets/documentation/headless-content/headless_items_overview.png)
## Create headless items
To create a new headless item:
  1. Open a headless channel application.
  2. Select **New headless item**.  
[![New headless item](docsassets/documentation/headless-content/new_headless_item.png)](https://docs.kentico.com/docsassets/documentation/headless-content/new_headless_item.png)
  3. Enter the headless item name.
  4. Select a content type from the list of available content types.  
[![New headless item - select content type](docsassets/documentation/headless-content/new_headless_item_select_type.png)](https://docs.kentico.com/docsassets/documentation/headless-content/new_headless_item_select_type.png)
  5. Select **Continue**.
...
Cloning a headless item allows you to create a new item with the same data. You can clone all [language variants](documentation/business-users/headless-content#translate-headless-items) of an item or just a selected one.
To clone a headless item:
  1. Open a headless channel application.
  2. [Find](documentation/business-users/headless-content#find-headless-items) the item you want to clone.
  3. Select the **Clone** ([![Clone action](docsassets/documentation/headless-content/headless_item_clone.png)](https://docs.kentico.com/docsassets/documentation/headless-content/headless_item_clone.png)
...
The new item is created in the _Draft_ step, where you can [edit](documentation/business-users/headless-content#edit-headless-items) it. The item needs to be [published](documentation/business-users/headless-content#publish-headless-items) to be available through the headless API.
## Find headless items
...
[![Headless items filter](docsassets/documentation/headless-content/headless_items_filter.png)](https://docs.kentico.com/docsassets/documentation/headless-content/headless_items_filter.png)
## Edit headless items
To edit a headless item:
  1. Open a headless channel application.
  2. Select the headless item you want to edit. 
     * Use the search bar or filter to [find headless items](documentation/business-users/headless-content#find-headless-items).
...
[![Edit headless item](docsassets/documentation/headless-content/headless_item_edit_button.png)](https://docs.kentico.com/docsassets/documentation/headless-content/headless_item_edit_button.png)
     * When a headless item is _Unpublished_ , select **Create new version** to move the headless item to the _Draft_ step.  
[![Create a new version of the headless item](docsassets/documentation/headless-content/headless_item_create_new_version_button.png)](https://docs.kentico.com/docsassets/documentation/headless-content/headless_item_create_new_version_button.png)
...
[![Reverting a headless item to its published status](docsassets/documentation/headless-content/headless_item_revert_to_published.png)](https://docs.kentico.com/docsassets/documentation/headless-content/headless_item_revert_to_published.png)
...
[![Language switcher in header bar](docsassets/documentation/headless-content/headless_header_bar_language_switcher.png)](https://docs.kentico.com/docsassets/documentation/headless-content/headless_header_bar_language_switcher.png)
...
[![Translating headless item](docsassets/documentation/headless-content/headless_item_copy_from_existing.png)](https://docs.kentico.com/docsassets/documentation/headless-content/headless_item_copy_from_existing.png)
  6. Select **Continue**.
  7. Enter the translated values of the headless item’s fields.
  8. **Save** the translated content item.


You have now successfully translated the headless item. Note that the new language variant is now only a  _Draft_ until you [publish](documentation/business-users/headless-content#publish-headless-items) it.
...
To unpublish a headless item:
  ...
  2. Select a headless item you want to unpublish. 
     * You can only unpublish headless items that are already _Published_. See how to [publish headless items](documentation/business-users/headless-content#publish-headless-items).
     * Use the search bar or filter to [find headless items](documentation/business-users/headless-content#find-headless-items).
  3. **Unpublish** the headless item.
  4. Expand the **Edit item** menu and select **Unpublish**.  
[![Unpublishing a headless item](docsassets/documentation/headless-content/headless_item_unpublish.png)](https://docs.kentico.com/docsassets/documentation/headless-content/headless_item_unpublish.png)
...
[![Delete headless items](docsassets/documentation/headless-content/headless_item_delete.png)](https://docs.kentico.com/docsassets/documentation/headless-content/headless_item_delete.png)
...
[![Lifecycle transitions of headless items](docsassets/documentation/headless-content/final_workflow.png)](https://docs.kentico.com/docsassets/documentation/headless-content/final_workflow.png)