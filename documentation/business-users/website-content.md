# Website content
  * [ Copy page link ](documentation/business-users/website-content#) | [Get HelpService ID](documentation/business-users/website-content#)
Core MVC 5


[✖](documentation/business-users/website-content# "Close page link panel") [Copy to clipboard](documentation/business-users/website-content#)
...
[![A website channel application](docsassets/documentation/website-content/website_channel_application.png)](https://docs.kentico.com/docsassets/documentation/website-content/website_channel_application.png)
## Page lifecycle
...
[![Page lifecycle transitions](docsassets/documentation/website-content/final_workflow.png)](https://docs.kentico.com/docsassets/documentation/website-content/final_workflow.png)
## View modes
...
[![View modes](docsassets/documentation/website-content/view_modes.png)](https://docs.kentico.com/docsassets/documentation/website-content/view_modes.png)
### Preview
...
You can use the preview mode to see what your changes will look like once published. If you need to share the preview with somebody who doesn’t have access to the administration, you can create a [shareable preview URL](documentation/business-users/website-content#shareable-preview-urls).
...
[![Open preview in new tab](docsassets/documentation/website-content/website_open_preview_new_tab.png)](https://docs.kentico.com/docsassets/documentation/website-content/website_open_preview_new_tab.png)
### Content
...
Shareable preview shows the same content you see when using the [preview mode](documentation/business-users/website-content#preview). However, the links on the page open the live site rather than displaying the preview of the content. An exception are links to [assets](documentation/business-users/content-hub/content-item-assets) that open the preview with the latest saved content.
If you generate a shareable URL for a page in the _Draft_ status or a custom workflow step, the URL can be accessed until:
  ...
  * the sharing is [stopped](documentation/business-users/website-content#stop-sharing-the-preview-of-a-page)
...
[![Get shareable preview URL](docsassets/documentation/website-content/shareable_preview_shortcut.png)](https://docs.kentico.com/docsassets/documentation/website-content/shareable_preview_shortcut.png)
