# Customer journeys
  * [ Copy page link ](documentation/business-users/digital-marketing/customer-journeys#) | [Get HelpService ID](documentation/business-users/digital-marketing/customer-journeys#) | This page is part of a module: [ Customer journeys ](modules/customer-journeys)
Core MVC 5


[✖](documentation/business-users/digital-marketing/customer-journeys# "Close page link panel") [Copy to clipboard](documentation/business-users/digital-marketing/customer-journeys#)
...
[![Edit customer journey display name](docsassets/documentation/customer-journeys/CJ_Display_name.png)](https://docs.kentico.com/docsassets/documentation/customer-journeys/CJ_Display_name.png)
  4. In the **Journey Builder** view mode, select **New stage** to create a stage: 
    1. Fill in the following properties: 
       ...
       * **Conditions** – determines the conditions that contacts must meet to advance to this stage. See [conditions](documentation/business-users/digital-marketing/customer-journeys#conditions) to learn more.  
...
When you edit an existing customer journey, it automatically begins [recalculating](documentation/business-users/digital-marketing/customer-journeys#customer-journey-results) once you save the changes.
### Conditions
...
Additionally, you can find the following information in the list of stages below the graph:
  ...
  * **Stage KPI** – the number and percentage of the contacts who reached the stage compared to the set [KPI](documentation/business-users/digital-marketing/customer-journeys#create-a-customer-journey)
...
All newly [created](documentation/business-users/digital-marketing/customer-journeys#create-a-customer-journey) journeys will now have the **Scheduled recalculation** property selected by default as long as the _Scheduled customer journey recalculation_ scheduled task is enabled.
...
Upon recalculation, contacts which no longer meet the [conditions](documentation/business-users/digital-marketing/customer-journeys#conditions) are removed from the corresponding stages. Recalculating the customer journey keeps the data up to date, reflecting only those contacts who currently match the inclusion criteria.
