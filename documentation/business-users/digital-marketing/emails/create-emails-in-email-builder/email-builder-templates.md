---
source: https://docs.kentico.com/documentation/business-users/digital-marketing/emails/create-emails-in-email-builder/email-builder-templates
...
---
  ...
  * [Create emails in Email Builder](/documentation/business-users/digital-marketing/emails/create-emails-in-email-builder)
...
After creating an email from an Email Builder template editors can save their email as a _preset email template_ along with the Email Builder content created in their email. See [Save emails as preset email templates](#save-emails-as-preset-email-templates).
...
[![Template configuration dialog location](/docsassets/documentation/email-builder-templates/templateconfiguration.png)](/docsassets/documentation/email-builder-templates/templateconfiguration.png)
  3. Configure any available properties in the dialog.  
[![Template configuration dialog example](/docsassets/documentation/email-builder-templates/templateconfigurationdialog.png)](/docsassets/documentation/email-builder-templates/templateconfigurationdialog.png)
  4. **Apply** the changes.
...
[![Change template button location](/docsassets/documentation/email-builder-templates/templateselection.png)](/docsassets/documentation/email-builder-templates/templateselection.png)
  3. Select one of the available email templates.  
[![Template selection dialog](/docsassets/documentation/email-builder-templates/templateselectiondialog.png)](/docsassets/documentation/email-builder-templates/templateselectiondialog.png)
...
[![Save as preset template](/docsassets/documentation/email-builder-templates/saveastemplate.png)](/docsassets/documentation/email-builder-templates/saveastemplate.png)
...
[![Save as preset template - dialog](/docsassets/documentation/email-builder-templates/saveastemplatedialog.png)](/docsassets/documentation/email-builder-templates/saveastemplatedialog.png)
...
[![List of preset email templates](/docsassets/documentation/email-builder-templates/presetemailtemplates.png)](/docsassets/documentation/email-builder-templates/presetemailtemplates.png)
...
Direct editing of preset email templates is not currently supported. In order to change a template, you need to [delete](#delete-preset-email-templates) it and [save](#save-emails-as-preset-email-templates) it again.
