---
source: https://docs.kentico.com/documentation/business-users/digital-marketing/emails/send-regular-emails-to-subscribers
...
Xperience by Kentico allows you to create and send regular emails to groups of subscribed recipients.
  1. [Set up a subscription process to build recipient lists](#set-up-a-subscription-process)
  2. [Create and send emails](#send-regular-emails)
...
## Set up a subscription process
  1. [Prepare subscription pages](#prepare-subscription-pages)
  2. [Create recipient lists](#create-recipient-lists)
  3. [Add a subscription form](#add-a-subscription-form)
  4. (Optional) [Create contact groups for recipient filtering](#create-contact-groups-for-recipient-filtering)
...
To add a recipient list:
  ...
  4. Select the **Thank you page** and **Goodbye page** in the **Approval** and **Unsubscribe settings** sections (see [Prepare subscription pages](#prepare-subscription-pages)).
...
[![Viewing a recipient list](/docsassets/documentation/send-regular-emails-to-subscribers/Recipient_list.png)](/docsassets/documentation/send-regular-emails-to-subscribers/Recipient_list.png)
...
To allow people to join your recipient lists, you need to prepare a subscription form with an autoresponder email:
  ...
  2. Edit the email in the **Content** view mode, and add a double opt-in link: 
    ...
    4. **Select a recipient list** – choose the [recipient list](#create-recipient-lists) where you want to add contacts after they subscribe.
    5. Select **Insert**.  
[![Adding a Double opt-in link to a form autoresponder email](/docsassets/documentation/send-regular-emails-to-subscribers/Double_opt_in_link.png)](/docsassets/documentation/send-regular-emails-to-subscribers/Double_opt_in_link.png)
...
Visitors can now use the form to subscribe to emails. The subscription process consists of the following steps:
  ...
  4. The contact representing the visitor is added to the selected [recipient list](#create-recipient-lists).
...
When [sending regular emails](#send-regular-emails), you can filter the recipients from your selected recipient list using [contact groups](/documentation/business-users/digital-marketing/contact-groups). This allows you to target specific audience segments without creating and maintaining separate recipient lists.
  ...
  2. Set the **Send only to recipients from contact groups** and/or **Exclude recipients from contact groups** properties before you send your [regular emails](#create-regular-emails).
...
If you use a shared recipient list for different types of email communication, any recipients who [unsubscribe](#unsubscription) will stop receiving all emails that you send via the given recipient list. This may or may not be desired behavior. Depending on your mailing requirements, you need to maintain and use an appropriate number of recipient lists.
## Send regular emails
Once you have established a [subscription process](#set-up-a-subscription-process) on your website, you can start sending emails to contacts in your recipient lists.
...
Email templates for regular emails typically need to contain an unsubscribe link. For macro-based templates, place an `{%unsubscribeurl%}` placeholder into the template’s **Source code**.
  ...
  * The placeholder resolves into an unsubscribe URL based on the unsubscribe settings of the [recipient list](#create-recipient-lists) to which the resulting emails are sent.
...
If you already have one or more existing emails, you can save time by **Cloning** (
  ...
  5. In the **Send to** property, choose the [recipient list](#create-recipient-lists) to which you want to send the email.
...
[![Configuring regular email properties](/docsassets/documentation/send-regular-emails-to-subscribers/Email_Properties.png)](/docsassets/documentation/send-regular-emails-to-subscribers/Email_Properties.png)
  7. Select **Save**.
...
[![Preparing the content of a regular email](/docsassets/documentation/send-regular-emails-to-subscribers/Email_Send.png)](/docsassets/documentation/send-regular-emails-to-subscribers/Email_Send.png)
...
[![Rescheduling the sendout of a regular email](/docsassets/documentation/send-regular-emails-to-subscribers/Email_Reschedule.png)](/docsassets/documentation/send-regular-emails-to-subscribers/Email_Reschedule.png)
...
[![Information about email bounces in the profile of a contact](/docsassets/documentation/send-regular-emails-to-subscribers/Contact_Profile_Email_Bounces.png)](/docsassets/documentation/send-regular-emails-to-subscribers/Contact_Profile_Email_Bounces.png)
### Unsubscription
