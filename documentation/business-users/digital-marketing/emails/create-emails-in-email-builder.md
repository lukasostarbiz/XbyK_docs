# Create emails in Email Builder
  * [ Copy page link ](documentation/business-users/digital-marketing/emails/create-emails-in-email-builder#) | [Get HelpService ID](documentation/business-users/digital-marketing/emails/create-emails-in-email-builder#) | This page is part of a module: [ Work with emails ](modules/work-with-emails)
Core MVC 5


[✖](documentation/business-users/digital-marketing/emails/create-emails-in-email-builder# "Close page link panel") [Copy to clipboard](documentation/business-users/digital-marketing/emails/create-emails-in-email-builder#)
...
[![Adding content in Email Builder](docsassets/documentation/create-emails-in-email-builder/EB_overview.png)](https://docs.kentico.com/docsassets/documentation/create-emails-in-email-builder/EB_overview.png)
See [Emails](documentation/business-users/digital-marketing/emails) to learn how to work with emails in general. Information, such as the description of the [Email lifecycle](documentation/business-users/digital-marketing/emails#email-lifecycle) and instructions for [Sending draft emails](documentation/business-users/digital-marketing/emails#send-draft-emails) or [Cloning emails](documentation/business-users/digital-marketing/emails#clone-emails), applies even when using Email Builder.
...
[![Email Builder component structure](docsassets/documentation/create-emails-in-email-builder/EB_component_structure.png)](https://docs.kentico.com/docsassets/documentation/create-emails-in-email-builder/EB_component_structure.png)
  ...
  * **Sections** – sections set a layout for email content, typically with one or more columns. You can add or remove sections, but each editable area in the template must always contain at least one section. Sections contain one or more widget zones. See [Adjust the email layout using sections](documentation/business-users/digital-marketing/emails/create-emails-in-email-builder#adjust-the-email-layout-using-sections) to learn how to work with sections. 
  ...
  * **Widgets** – reusable components that represent individual pieces of email content, such as text, images, CTA links, etc. See [Add content using widgets](documentation/business-users/digital-marketing/emails/create-emails-in-email-builder#add-content-using-widgets) to learn how to work with widgets.
...
[![Section management UI elements](docsassets/documentation/create-emails-in-email-builder/EB_sections.png)](https://docs.kentico.com/docsassets/documentation/create-emails-in-email-builder/EB_sections.png)
...
Widgets allow you to add individual pieces of email content, such as text, images, CTA links, etc. Manage widgets by interacting with the purple UI elements in Email Builder:
  ...
  * **Personalize widgets** – select the [Personalize widgets](documentation/business-users/digital-marketing/emails/create-emails-in-email-builder#personalize-widgets) to learn more.
...
[![Widget management UI elements](docsassets/documentation/create-emails-in-email-builder/EB_widgets.png)](https://docs.kentico.com/docsassets/documentation/create-emails-in-email-builder/EB_widgets.png)
...
[![Personalizing an Email Builder widget](docsassets/documentation/create-emails-in-email-builder/EB_widget_personalize.png)](https://docs.kentico.com/docsassets/documentation/create-emails-in-email-builder/EB_widget_personalize.png)
...
[![Switching between widget variants](docsassets/documentation/create-emails-in-email-builder/EB_widget_variants.png)](https://docs.kentico.com/docsassets/documentation/create-emails-in-email-builder/EB_widget_variants.png)
