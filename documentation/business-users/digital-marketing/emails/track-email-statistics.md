# Track email statistics
  * [ Copy page link ](documentation/business-users/digital-marketing/emails/track-email-statistics#) | [Get HelpService ID](documentation/business-users/digital-marketing/emails/track-email-statistics#)
Core MVC 5


[✖](documentation/business-users/digital-marketing/emails/track-email-statistics# "Close page link panel") [Copy to clipboard](documentation/business-users/digital-marketing/emails/track-email-statistics#)
...
Depending on your recipient demographics and the percentage of users with Apple Mail clients, Apple MPP may significantly impact the reliability of the open rate statistics. To mitigate this, we strongly recommend evaluating your emails based on [clicked links](documentation/business-users/digital-marketing/emails/track-email-statistics#clicked-links).
### Clicked links
...
Separate click data for individual links is not available in the anonymous email statistics. However, you can also track link clicks as [email activities](documentation/business-users/digital-marketing/emails/track-email-statistics#contact-activities-for-emails), which contain information about individual recipients and links.
...
The list of emails provides an overview where you can compare the effectiveness of your emails according the [open](documentation/business-users/digital-marketing/emails/track-email-statistics#email-opens) and [click](documentation/business-users/digital-marketing/emails/track-email-statistics#clicked-links) rate.
...
[![Viewing the statistics of an email](docsassets/documentation/track-email-statistics/Emails_Statistics.png)](https://docs.kentico.com/docsassets/documentation/track-email-statistics/Emails_Statistics.png)
**Statistic delay**
...
[![Viewing contact activities for an email](docsassets/documentation/track-email-statistics/Emails_activities.png)](https://docs.kentico.com/docsassets/documentation/track-email-statistics/Emails_activities.png)
