---
source: https://docs.kentico.com/documentation/business-users/digital-marketing/emails
...
## Create emails
  ...
  3. Fill in the email properties:
     ...
     * **Email purpose** – select the email’s purpose (see [Email purposes](#email-purposes)). To learn more about creating regular emails, see [Send regular emails to subscribers](/documentation/business-users/digital-marketing/emails/send-regular-emails-to-subscribers).
...
[![Editing email content](/docsassets/documentation/emails/Email_Content.png)](/docsassets/documentation/emails/Email_Content.png)
...
[![Email workflow status and actions](/docsassets/documentation/emails/Email_Workflow.png)](/docsassets/documentation/emails/Email_Workflow.png)
Emails with the **Form autoresponder** , **Confirmation** , **Automation** or **Order status change** [purpose](#email-purposes) can have one of the following statuses:
...
When editing an email in an email channel application, you can switch between view modes in the options panel on the right:
  * **Preview** – allows you to see 3 different views (_desktop_ , _mobile_ , _inbox_) of the email content as it will appear to recipients, including the fixed content from the email template. Any [personalized dynamic text](#personalize-emails-with-dynamic-text) in the email appears as it would for a fake recipient named _John Doe_.
...
Add dynamic text by entering or copying placeholders into the appropriate location within email fields:
  * For most email [purposes](#email-purposes), the following placeholders are available: 
...
[![Email content with a dynamic text placeholder in the Preview text](/docsassets/documentation/emails/Emails_Dynamic_Text_Placeholder.png)](/docsassets/documentation/emails/Emails_Dynamic_Text_Placeholder.png)
...
[![Email content with dynamic text in a rich text field](/docsassets/documentation/emails/Emails_Dynamic_Text_RTE.png)](/docsassets/documentation/emails/Emails_Dynamic_Text_RTE.png)
...
When replacing dynamic text values for individual recipients, the system loads the information based on the email’s [purpose](#email-purposes):
...
[![The action drop-down when editing an email](/docsassets/documentation/emails/Emails_Send_Draft.png)](/docsassets/documentation/emails/Emails_Send_Draft.png)
...
Draft emails differ from normally sent emails in the following ways:
  ...
  * Because the recipients are not linked to contacts in the system, any [personalized dynamic text](#personalize-emails-with-dynamic-text) in the email appears as it would for a fake recipient named _John Doe_.
