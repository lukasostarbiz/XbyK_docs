# Rich text editor
  * [ Copy page link ](documentation/business-users/rich-text-editor#) | [Get HelpService ID](documentation/business-users/rich-text-editor#)
Core MVC 5


[✖](documentation/business-users/rich-text-editor# "Close page link panel") [Copy to clipboard](documentation/business-users/rich-text-editor#)
...
[![Rich text editor](docsassets/documentation/rich-text-editor/rich_text_editor.png)](https://docs.kentico.com/docsassets/documentation/rich-text-editor/rich_text_editor.png)
## Format text
...
[![Rich text editor toolbar](docsassets/documentation/rich-text-editor/rich_text_editor_toolbar.png)](https://docs.kentico.com/docsassets/documentation/rich-text-editor/rich_text_editor_toolbar.png)
  1. **Bold** (_Ctrl + B_)
  2. **Italic** (_Ctrl + I_)
